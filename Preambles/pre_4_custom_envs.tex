...
\newenvironment{aufgabe}[2][]
{
  ...
  \ifblank{#1}{
    % if no title is given (#1 blank)
    \begin{tcolorbox}[title=\faPencilSquareO{} Aufgabe~\thecc]
  }{
    % if a title is given (#1 not blank)
    \begin{tcolorbox}[title=\faPencilSquareO{} Aufgabe~\thecc~#1]
      }
      \mdfsetup{
  ...
  \newenvironment{myantwort}
  {
    ...
    \begin{tcolorbox}[enhanced jigsaw,
      ...
      opacityback=.5, % Opacity of the background
      coltitle=white,
  ...
  \newenvironment{myabgabe}
    {
      ...
      breakable, 
      lines before break=9,
      title=\faArrowUp{} Aufgabe (Abgabe)~\thecc,
      attach boxed title to top text left={yshift=-3mm,yshifttext=-3mm}]
        } %%
        {
      \end{tcolorbox}      
