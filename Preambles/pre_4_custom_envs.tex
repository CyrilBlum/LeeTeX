...
{%
  ...
  \begin{tcolorboxTemplate}[
    title=\faEdit{} Aufgabe~\mynumber.\theExerciseCounter~#1,
...
\begin{Answer}[ref=\theExerciseCounter]
  \begin{tcolorboxTemplate}[
    ...
    opacityback=1,
    title=\faCheckSquareO{} Lösungsvorschlag zu Aufgabe \mynumber.\theExerciseCounter]
}%%
{%
  \end{tcolorboxTemplate}
\end{Answer}
...
{%
  ...
  \begin{tcolorboxTemplate}[
    title=\faArrowUp{} Aufgabe (Abgabe)~\mynumber.\theSubmissionCounter~#1,
    colback=Purple!10,
    colframe=Purple,
    colbacktitle=Purple]
}%%
...
{%
  ...
  \begin{tcolorboxTemplate}[
    title=\faTrophy{} Aufgabe (Challenge)~\mynumber.\theChallengeCounter~#1,
    colback=Gold!10,
