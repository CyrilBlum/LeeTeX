...
{%
  ...
  \begin{tcolorboxTemplate}[
    title=\faEdit{} Aufgabe~\thechapter.\theExerciseCounter~#1,
...
\begin{Answer}[ref=\theExerciseCounter]
  \begin{tcolorboxTemplate}[
    ...
    opacityback=1,
    title=\faCheckSquareO{} Lösungsvorschlag zu Aufgabe \thechapter.\theExerciseCounter]
}%%
{%
  \end{tcolorboxTemplate}
\end{Answer}
...
{%
  ...
  \begin{tcolorboxTemplate}[
    title=\faArrowUp{} Aufgabe (Abgabe)~\thechapter.\theSubmissionCounter~#1,
    colback=Purple!10,
    colframe=Purple,
    colbacktitle=Purple]
}%%
...
{%
  ...
  \begin{tcolorboxTemplate}[
    title=\faTrophy{} Aufgabe (Challenge)~\thechapter.\theChallengeCounter~#1,
    colback=Gold!10,
