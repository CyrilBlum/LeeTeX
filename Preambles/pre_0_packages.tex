...
\nottoggle{beamer} {
    ...
    \usepackage[a4paper,bindingoffset=0mm,left=22mm,right=22mm,top=25mm,bottom=25mm,footskip=14mm]{geometry}
...
% for multiline cells in tables, using command \makecell
\usepackage{makecell}
