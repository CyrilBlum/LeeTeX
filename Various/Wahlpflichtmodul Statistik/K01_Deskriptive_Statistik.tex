    ...
    \only<4->{
        \begin{table}[H]
            ...
            \begin{tabular}{|l|c|c|c|l|}
                \hline
                \textbf{Niveau}      & \textbf{Ordnung} & \textbf{Abstände} & \textbf{Nullpunkt} & \textbf{Beispiele}                    \\ \hline\hline
                Nominal               & \xmark           & \xmark            & \xmark             & Wohnort, Musikgenre                    \\ \hline
                Ordinal               & \cmark           & \xmark            & \xmark             & Schulnoten, Zufriedenheit (1--5)       \\ \hline
                Intervall             & \cmark           & \cmark            & \xmark             & Temperatur in °C                       \\ \hline
                Verhältnis (Ratio) & \cmark           & \cmark            & \cmark             & Länge, Gewicht, Zeit, Temp. in Kelvin \\ \hline
            \end{tabular}
        \end{table}
    }
\end{frame}
...
\begin{frame}{Skalenniveaus: Statistische Verfahren}
    \begin{table}[H]
        ...
        \begin{tabular}{|l|l|l|l|}
            \hline
            \textbf{Niveau} & \textbf{Zentrale Lage} & \textbf{Streuung} & \textbf{Visualisierung}   \\ \hline\hline
            ...
            Verhältnis    & Mittelwert, Median      & SD, IQR            & Histogramm, Boxplot, Scatter \\ \hline
        \end{tabular}
    \end{table}
...
\begin{frame}{Entscheidungshilfe: Welche Kennzahl?}
    \begin{table}[H]
        ...
        \begin{tabular}{|l|l|l|}
            \hline
            \textbf{Situation}               & \textbf{Zentrale Lage} & \textbf{Streuung} \\ \hline\hline
            Symmetrisch, keine Ausreisser     & Mittelwert              & SD                 \\ \hline
            Schief oder Ausreisser            & Median                  & IQR                \\ \hline
            Ordinale Daten                    & Median                  & IQR                \\ \hline
            Nominale Daten                    & Modus                   & ---                \\ \hline
        \end{tabular}
    \end{table}
