...
\begin{frame}{Übungen im Skript: Diagramme lesen}
    \begin{itemize}
        \item \aufgabebox{Irreführende Achsen erkennen}
    \end{itemize}
\end{frame}
...
\begin{frame}{Übungen im Skript: CODAP und Zusammenhänge}
    \begin{itemize}
        \item \aufgabebox{CODAP: Lage und Streuung}
        \item \aufgabebox{CODAP: Zusammenhang und Interpretation}
    \end{itemize}
\end{frame}

\begin{frame}{Übungen im Skript: Aufgabenpaket und Challenge}
    \begin{itemize}
        \item \aufgabebox{Teil A: Kennzahlen interpretieren}
        \item \aufgabebox{Teil B: Histogramm, Boxplot, Scatterplot}
        \item \challengebox{Challenge: Kontingenztabelle (optional)}
    \end{itemize}
\end{frame}
...
\begin{frame}{Übungen im Skript: Mini-Checkliste}
    \begin{itemize}
        \item \aufgabebox{Statistik in Texten und Grafiken kritisch prüfen}
    \end{itemize}
\end{frame}
