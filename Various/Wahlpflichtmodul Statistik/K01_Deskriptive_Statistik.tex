...
\begin{frame}{Übungen im Skript: Skalenniveaus}
    \begin{itemize}
        \item \aufgabebox{Aufgabe 1: Skalenniveaus zuordnen}
    \end{itemize}
\end{frame}
...
\begin{frame}{Übungen im Skript: Lage und Streuung}
    \begin{itemize}
        \item \aufgabebox{Aufgabe 2: Median vs. Mittelwert mit Ausreisser}
    \end{itemize}
\end{frame}
...
\begin{frame}{Übungen im Skript: Diagramme lesen}
    \begin{itemize}
        \item \aufgabebox{Aufgabe 3: Irreführende Achsen erkennen}
    \end{itemize}
\end{frame}

\begin{frame}{Zusammenhänge: Korrelation}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.95\textwidth]{Various/Wahlpflichtmodul Statistik/Figures/plots_correlation_examples.pdf}
    \end{figure}
    \begin{itemize}
        \item \textbf{Positiv}: X steigt $\Rightarrow$ Y steigt
        \item \textbf{Negativ}: X steigt $\Rightarrow$ Y sinkt
        \item \textbf{Keine}: Kein systematischer Zusammenhang
    \end{itemize}
\end{frame}
...
\begin{frame}{Kontingenztabelle: Kategoriale Daten}
    ...
    \vspace{0.5em}
    \begin{itemize}
        \item \textbf{Zulässig}: \"In dieser Stichprobe hören mehr Einzellerner Musik\"
        \item \textbf{Nicht zulässig}: \"Musik verursacht besseres Lernen\" (Kausalität!)
    \end{itemize}
\end{frame}

\begin{frame}{Übungen im Skript: CODAP und Zusammenhänge}
    \begin{itemize}
        \item \aufgabebox{Aufgabe 4: Lage und Streuung in CODAP}
        \item \aufgabebox{Aufgabe 5: Zusammenhang und Interpretation}
    \end{itemize}
\end{frame}

\begin{frame}{Doppellektion (90 Minuten): Ablauf}
    \begin{itemize}
        \item 0--10 min: Einstieg mit Leitfrage
        \item 10--20 min: Skalenniveaus zuordnen
        \item 20--35 min: Lagekennzahlen in CODAP
        \item 35--45 min: Streuung (IQR, Boxplot, Ausreisser)
        \item 45--60 min: Histogramm und Verteilungsform
        \item 60--75 min: Scatterplot und Interpretation
        \item 75--85 min: Grafik-Kritik
        \item 85--90 min: Abschlussfrage
    \end{itemize}
\end{frame}

\begin{frame}{Übungen im Skript: Doppellektion und Aufgabenpaket}
    \begin{itemize}
        \item \aufgabebox{Aufgabe 6: Phasen einer Statistik-Lektion reflektieren}
        \item \aufgabebox{Aufgabe 7: Kennzahlen interpretieren}
        \item \aufgabebox{Aufgabe 8: Histogramm, Boxplot, Scatterplot}
        \item \challengebox{Challenge 1: Kontingenztabelle (optional)}
    \end{itemize}
\end{frame}
...
\begin{frame}{Übungen im Skript: Transfer und Reflexion}
    \begin{itemize}
        \item \aufgabebox{Aufgabe 9: Statistik in Medien kritisch prüfen}
    \end{itemize}
\end{frame}
