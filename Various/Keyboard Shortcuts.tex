...
Cursor \textcolor{red!30}{\faICursor}\tikzmark{from2}bewegen\tikzmark{to2}\textcolor{red}{\faICursor} &\makecell{\keys{\ctrl+\arrowkeyright}\\\keys{\ctrl+\arrowkeyleft}} & \makecell{\keys{\Alt+\arrowkeyright}\\ \keys{\Alt+\arrowkeyleft}}\\\midrule
...
\makecell[l]{\faICursor Zum Anfang /\\Ende der Zeile gehen\faICursor} & \makecell{\keys{\ctrl+\arrowkeyleft}\\\keys{\ctrl+\arrowkeyright}}& \makecell{\keys{\cmd+\arrowkeyleft}\\\keys{\cmd+\arrowkeyright}}\\\midrule
