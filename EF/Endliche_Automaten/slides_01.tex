...
\begin{itemize}[<+->]
	...
	\item $L_4 = \Sigma$
	\item $L_5 = \setcm{a^p}{p\;\text{ist eine Primzahl}}$
...
\end{mydefinition}
Man sagt auch, dass $A$ die Sprache $L$ \textbf{erkennt}. Wenn für eine Sprache $L$ ein Algorithmus existiert, der $L$ erkennt.
\end{frame}
