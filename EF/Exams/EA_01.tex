...
\begin{figure}[H]
\centering
\begin{tikzpicture}[->,>=stealth',shorten >=4pt,node distance=4.2cm,semithick]
  \tikzstyle{every state}=[fill=blue!10,draw=black,text=black,minimum size=1.4cm]
...
\begin{parts}
  ...
  \vspace{5cm}
  \part[3] Beschreibe die von dem endlichen Automaten EA3 akzeptierte Sprache sehr genau.
\end{parts}
\droptotalpoints
\clearpage
