...
\begin{questions}
	...
	\droptotalpoints
	\clearpage
	\question{\textbf{Endlichen Automaten zeichnen 2}} Gegeben ist die Sprache \begin{align*} L_2 := \setcm{x1y}{x,y\in\lrc{0,1}^*, \abs{y}\geq 1}.
	\end{align*}
	\begin{parts}
	...
	\begin{parts}
		...
		\begin{solution}
			...
			\begin{align*}
				a^iz = a^i\#a^i\in L_4 \quad\text{aber}\quad a^jz = a^j\#a^i\notin L_4
			\end{align*}
			gilt. Denn wegen $i<j$ und somit insbesondere $i\neq j$ und deshalb $a^i\neq a^j$. Damit war unsere ursprüngliche Annahme falsch und es existiert kein
