...
class Solver {
    public:
        Solver(sf::Vector2f constraint_center, float constraint_radius,
               sf::Vector2f a_gravity, unsigned int n_sub_steps,
               float frame_dt);

        Particle &add_particle(sf::Vector2f y0, sf::Vector2f v0,
