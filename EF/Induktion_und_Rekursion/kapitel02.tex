...
\begin{myremark}[Metapher der Leiter]
...
\begin{myexercise}[Bernoullische Ungleichung]\label{myexercise:0206}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.20\textwidth]{EF/Induktion_und_Rekursion/Figures/Bernoulli.jpg}
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=1.0\textwidth]{EF/Induktion_und_Rekursion/Figures/4Dollar.jpg}
		\caption{4-Dollarmünze \enquote{Stella}}
		\label{subfig:4Dollar}
	\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=1.0\textwidth]{EF/Induktion_und_Rekursion/Figures/5Dollar.jpg}
