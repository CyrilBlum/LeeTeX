...
In der Theorie der algorithmischen Informationstheorie, ist die Kolmogorov-Komplexität eines Objekts, wie zum Beispiel einem gegebenen Text, die Länge eines kürzesten Computerprogramms (in einer festgelegten Programmiersprache), welches dieses Objekt als Ausgabe (Output) produziert.
\par
...
\begin{myexercise}
	...
	Welches dieser beiden Bilder hat vermutlich eine höhere Komplexität im Sinne von Kolmogorov? Begründe deine Antwort.
\begin{myanswer}
	Das Bild mit dem zufälligen Rauschen (\cref{fig:fig2}) hat eine deutlich höhere Kolmogorov-Komplexität als das Bild mit den Kreisen (\cref{fig:fig1}).
