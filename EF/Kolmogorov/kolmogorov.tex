...
Zunächst möchten wir das kleine und etwas mühsames Detail der sogenannten \textit{Selbstbegrenzung} adressieren und die damit verbundene Problematik in diesem Abschnitt aus dem Weg räumen. Betrachten wir dazu nochmals das folgende (standard) \texttt{C++}-Programm aus \cref{myexample:generateA}:
