...
\begin{mytheorem}[$K(w)$ ist nicht für jedes binäre Wort berechenbar]\label{mytheorem:Knotcomputable}
	...
	\begin{myproof}
		Für jede natürliche Zahl $n>0$ sei $G_n$ die Menge aller binären Wörter mit der Länge exakt $n$. Gemäss \cref{mytheorem:nichtkomprimierbar} existiert in $G_n$ mindestens ein nichtkomprimierbares Wort, also eine Wort $w$ mit $K(w)\geq n$. Unter allen diesen nichtkomprimierbaren Wörtern, sei $\alpha$ definiert als das erste solche Wort in der kanonischen Ordnung über dem binären Alphabet. Es gilt also insbesondere $K(\alpha)\geq n$.
		\par
