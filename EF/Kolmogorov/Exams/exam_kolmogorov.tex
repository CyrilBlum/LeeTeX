...
\begin{questions}
	...
	\begin{figure}[htbp]
		...
		\begin{minipage}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=\textwidth]{EF/Kolmogorov/Exams/kreise.png}
			\caption{Kreise}
			\label{fig:fig1}
		\end{minipage}
	...
	\begin{lstlisting}[language=Pascal,caption=$A_n$]
begin
    x := n;
    y := 0;
    for i := 1 to x do
...
\end{lstlisting}
	...
	\begin{lstlisting}[language=Pascal,caption=$B_n$]
begin
    for i := 1 to n do
        write(0);
    for i := 1 to n do
...
\end{lstlisting}
	...
	\begin{lstlisting}[language=Pascal,caption=$C_n$,label=listing:Cn]
begin
    for i := 1 to n do
        write(0);
    for i := 1 to n^2 do
...
\end{lstlisting}
	...
	\begin{solution}
		...
		\begin{lstlisting}[language=Pascal,caption=$W_n$]
begin
    k := n;
    k := 2*k^4;
    k := 2^(2^k);
...
\end{lstlisting}
		...
		\begin{align*}
			K(w_w) \leq \ceil{\log_2(n+1)} + c \leq \blue{\log_2(n)} + c'
		\end{align*}
