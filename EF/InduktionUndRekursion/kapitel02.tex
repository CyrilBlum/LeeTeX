...
Diese Formel wollen wir nun mithilfe des Prinzips der vollständigen Induktion überprüfen. Dazu definieren wir, wie bereits in \cref{myexample:InduktionEven}, die Behauptung in geeigneter Form. Für jedes $n\in\N$ definieren wir also die Aussage $\mathcal{A}(n)$ als:
\begin{align*}
	 & \mathcal{A}(n) :\iff                                                                                     \\
...
\begin{mysummary}{Beweis durch vollständige Induktion}\label{mysummary:Induktion}
	...
	Für jedes $n\in\N$ sei $\mathcal{A}(n)$ eine Aussage. Wir wollen beweisen, dass $\mathcal{A}(n)$ für jedes $n\in\N$ richtig ist. Der Beweis kann mithilfe des Prinzips der vollständigen Induktion erbracht werden, indem wie folgt vorgegangen wird:
	\begin{aenum}
...
\begin{myexercise}\label{myexercise:0210}
	...
	\begin{aenum}
		...
		\item Beweisen Sie mithilfe von \cref{mytheorem:starkeInduktion} zur starken Induktion, dass jede Strecke der Länge $n\in\N$ mit $n\geq 42$ mit Tims Klötzen gebaut werden kann.
	\end{aenum}
\end{myexercise}
...
\begin{myexercise}{kommutative Verknüpfung}\label{myexercise:0295}
	...
	\end{align*}
	für $x,y,z\in X$ erfüllen. Beweisen Sie mithilfe von \cref{mytheorem:starkeInduktion} zur starken Induktion die Richtigkeit des \enquote{verallgemeinerten} Distributivgesetztes:
	\begin{align*}
...
\begin{myanswer}[myexercise:0267]
	\begin{aenum}
...
\begin{myanswer}[myexercise:0297]
	\begin{aenum}
	...
	\end{aenum}
\end{myanswer}
\begin{myanswer}[myexercise:0293]
...
\begin{myanswer}[myexercise:0292]
...
\clearpage
\begin{myanswer}[myexercise:0207]
...
\begin{myanswer}[myexercise:0268]
...
\end{myanswer}
\clearpage
\begin{myanswer}[myexercise:0210]
	\begin{aenum}
...
\end{myanswer}
\clearpage
\begin{myanswer}[myexercise:0295]
