...
\begin{myanswer}[myexercise:0604]
	...
	\lstinputlisting[language=Python]{EF/InduktionUndRekursion/n_queen_problem.py}

	\textbf{Lösung in C++}
	\lstinputlisting[language=C++]{EF/InduktionUndRekursion/src/main.cpp}
	\lstinputlisting[language=C++]{EF/InduktionUndRekursion/src/n_queen_problem.h}
	\lstinputlisting[language=C++]{EF/InduktionUndRekursion/src/n_queen_problem.cpp}
\end{myanswer}
