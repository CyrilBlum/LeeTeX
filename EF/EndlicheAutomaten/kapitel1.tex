...
\begin{mychallenge}\label{mychallenge:0207}
	Es sei $x$ ein Wort der Länge $n\N$, welches aus lauter verschiedenen Buchstaben besteht (also aus $n$ verschiedenen Buchstaben). Wie viele verschiedene Teilwörter hat $x$?
\end{mychallenge}
...
\begin{myexercise}\label{myexercise:kp01}
	...
	\begin{aenum}
		...
		\item das Teilwort $00$ nicht enthalten.
	\end{aenum}
\end{myexercise}

\begin{myexercise}\label{myexercise:kp02}
	\begin{aenum}
		\item Es sei $L := \lrc{a, ab, ba}$. Bestimmen Sie die Sprache $L^2$.
