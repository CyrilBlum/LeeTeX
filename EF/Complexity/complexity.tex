...
\begin{frame}{Beispiel einer exakten Analyse (Fortsetzung)}
    ...
    \begin{align*}
        ...
        \onslide<3->{&= c_1(1) + c_2(1) + c_3(n+1) + c_4(n) + c_5(1) \\
        }
...
\begin{align*}
	...
	&= c_1(1) + c_2(1) + c_3(n+1) + c_4\left(w_5(n) + n\right) + c_5w_5(n) + c_6w_5(n) + c_7(1) \\
	&= c_1 + c_2 + c_3(n+1) + c_4\left(\frac{n(n-1)}{2}+n\right) + (c_5+c_6)\left(\frac{n(n-1)}{2}\right) + c_7
\end{align*}
}
\end{frame}
...
{\footnotesize
\begin{align*}
T_{\text{worst}}(n) &= \underbrace{\left(\frac{c_4 + c_5 + c_6}{2}\right)}_{=:\textcolor{Red}{a}} n^2 + \underbrace{\left(c_3 + \frac{c_4 - c_5 - c_6}{2}\right)}_{=:\textcolor{RoyalBlue}{b}}n + \underbrace{(c_1 + c_2 + c_3 + c_7)}_{=:\textcolor{ForestGreen}{c}} = \\
