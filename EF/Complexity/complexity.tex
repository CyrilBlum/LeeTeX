...
\begin{frame}{Beispiel einer exakten Analyse (Fortsetzung)}
    ...
    \begin{align*}
        ...
        \onslide<5->{&= \textcolor{RoyalBlue}{a}n + \textcolor{ForestGreen}{b}}, \qquad \textcolor{RoyalBlue}{a} > 0.
    \end{align*}
    }
    \only<6->{
    \begin{myremark}
...
\begin{align*}
	...
	&= c_1 + c_2 + c_3n + c_4\left(w_5(n) + n-1\right) + c_5w_5(n) + c_6w_5(n) + c_7 = \\
...
&= \textcolor{Red}{a}n^2 + \textcolor{RoyalBlue}{b}n + \textcolor{ForestGreen}{c}, \qquad \textcolor{Red}{a} > 0.
\end{align*}}
\end{frame}
...
&= \textcolor{Red}{\tilde{a}}n^2 + \textcolor{RoyalBlue}{\tilde{b}} + \textcolor{ForestGreen}{\tilde{c}}, \qquad \textcolor{Red}{\tilde{a}} > 0.
\end{align*}
}
\end{myanswer}
\end{frame}
...
\begin{frame}{Algorithmus präsentieren}
	\begin{enumerate}
		...
		\item Wählt einen Algorithmus aus dieser Sammlung (oder auch einen eigenen) aus:\\
