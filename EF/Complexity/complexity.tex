...
\begin{frame}{Bestimmung der Laufzeit \faStar\faStar\faStar[regular]\faStar[regular]\faStar[regular]}
	\begin{myexercise}
    \lstinputlisting[basicstyle=\scriptsize\ttfamily,language=Python,caption=\texttt{bubble\_sort\_simple.py},label=listing:bubble_sort_simple]{EF/Complexity/Code/bubble_sort_simple.py}
	\end{myexercise}
\end{frame}
