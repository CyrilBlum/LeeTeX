...
% set date
\newcommand{\mydate}{28. Januar 2026}
...
\begin{questions}
	...
	\end{parts}
        ...
        \question Analysiere die Laufzeit des folgenden Algorithmus:
        \begin{lstlisting}[language=Python]
        ...
        \end{lstlisting}
        \begin{parts}
            \part[3] Bestimme die Laufzeit des Algorithmus. Erkläre deine Überlegungen ausführlich.
            \begin{solution}
            ...
            \part[2] Gib die Laufzeit des Algorithmus an:
            \begin{checkboxes}
                \choice $\Theta(n)$
                \choice $\Theta(n^2)$
