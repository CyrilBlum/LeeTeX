...
% set date
\newcommand{\mydate}{29. Januar 2026}
...
die $n$-te harmonische Zahl. Es kann gezeicht werden\foote{Beispielsweis unter Verwendung des Integralkriteriums}, dass $H_n \in \Theta\lr{\log(n)}$.
\end{questions}
