...
\begin{questions}
	...
	\question[2] Erkläre genau, wie man fast jeden Algorithmus modifizieren kann, sodass er eine gute best-case Laufzeit hat. Erkläre die Modifikation am konkreten Beispiel von \texttt{insertion\_sort}. Natürlich musst du hier nicht den \texttt{insertion\_sort} Algorithmus hinschreiben.
	\begin{solution}
		...
		Konkret bei \texttt{insertion\_sort}: $A$ ist der \texttt{insertion\_sort} Algorithmus. $B$ permutiert die gegebene Liste zufällig und prüft, ob die Elemente nun bereits sortiert sind. Sollte dies der Fall sein, wird die permutierte Liste ausgegeben (best-case). Ansonsten ruft $B$ einfach $A$, also \texttt{insertion\_sort} auf.
	\end{solution}
