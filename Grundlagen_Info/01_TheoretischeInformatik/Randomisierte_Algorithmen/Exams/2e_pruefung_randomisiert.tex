...
\clearpage
\question[2]
Gegeben ist eine Python Funktion \lstinline|sieb(n)|, welche für eine gegebene natürliche Zahl $n$ eine Liste aller Primzahlen $\leq n$ ausgeben (printen) soll. Die in \cref{lst:sieb} gezeigte Funktion ist nicht korrekt. Verbessern Sie die Funktion, sodass sie die gewünschte Tätigkeit ausführt.
