\chapter{DL\,06 – k-Nearest Neighbors (optional)}
...
\textbf{Normalisierung} (vgl.\ DL\,02) ist daher bei KNN besonders wichtig.
\end{mycaution}
...
KNN kann auch für \textbf{Prediction} eingesetzt werden:
