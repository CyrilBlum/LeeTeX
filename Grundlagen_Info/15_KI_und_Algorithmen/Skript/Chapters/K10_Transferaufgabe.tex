\chapter{DL\,10 – Transferaufgabe: Eigenes Datenprojekt (optional)}

\begin{myremark}
Diese Doppellektion ist \textbf{optional} und bildet den Abschluss des Skripts.
Sie setzt DL\,01--04 (und idealerweise DL\,09) voraus.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Handelt es sich um Classification oder Prediction?
    \end{itemize}
