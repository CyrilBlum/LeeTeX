\chapter{DL\,09 – Modellvergleich und Reflexion}
...
\midrule
Entscheidungsbaum & Classification & sehr gut interpretierbar; keine Normalisierung nötig & Overfitting-anfällig ohne Beschränkung \\
\midrule
Random Forest & Classification & robust, oft gute Genauigkeit, Feature Importance & weniger gut erklärbar; langsamer \\
\midrule
SVM & Classification & effektiv bei klar trennbaren Klassen, Kernel-Trick & Parameterwahl anspruchsvoll; langsam bei grossen Daten \\
\midrule
KNN & Classification / Prediction & einfach, intuitiv, kein Training & sensitiv auf Skalierung; langsam bei Vorhersage \\
\midrule
...
4.\ Lineare Regression (Prediction, gut interpretierbar).
\end{myanswer}
\end{myexercise}
...
\begin{todolist}
    ...
    \item Ich kann die Grundidee von \textbf{Entscheidungsbaum}, \textbf{Random Forest},
          \textbf{SVM}, \textbf{KNN}, \textbf{Regression} und \textbf{Neuronalen Netzen} beschreiben.
