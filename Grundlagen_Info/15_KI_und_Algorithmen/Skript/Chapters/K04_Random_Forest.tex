\chapter{DL\,04 – Random Forest}

\begin{myremark}
Der \textbf{Random Forest} baut auf dem Entscheidungsbaum auf (DL\,03) und macht ihn
durch \enquote{Ensembling} deutlich robuster. Diese DL setzt Kenntnisse aus DL\,03 voraus.
\end{myremark}
