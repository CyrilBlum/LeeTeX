\chapter{DL\,08 – Neuronale Netze (optional)}

\begin{myremark}
Diese Doppellektion ist \textbf{optional} und anspruchsvoller als die übrigen.
Sie setzt DL\,01--02 voraus. Mathematische Details (Backpropagation) werden
...
\begin{itemize}
    ...
    \item Vergleichen Sie die Testgenauigkeit mit dem Random Forest aus DL\,04.
