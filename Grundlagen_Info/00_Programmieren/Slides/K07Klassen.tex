...
\begin{frame}[fragile]{Klassen in Python}
	...
	\end{figure}
	\begin{itemize}
		\item Eigenschaften / Attribute: \lstinline|name|, \lstinline|farbe|, \lstinline|alter|, etc.
		\item Methoden: \lstinline|bellen()|, \lstinline|sitzen()|, etc.
	\end{itemize}
	\textbf{Wird in Games ständig verwendet, um Objekte zu ``spawnen''!}
\end{frame}
...
\begin{frame}{Klassen in Python}
	\begin{itemize}[<+->]
		...
		\item Objekte sind Instanzen von Klassen.
		\item Klassen können auch Vererbung unterstützen.
	\end{itemize}
	\begin{center}
...
\begin{frame}[fragile]{Listen als Klassen}
	...
	\end{figure}
\end{frame}
\begin{frame}[fragile]{Was ist eine Klasse?}
	\begin{itemize}[<+->]
...
\begin{frame}[fragile]{Klassen: Definition}
	\begin{mydefinition}
...
\end{frame}
\setbeamertemplate{logo}{\includegraphics[width=2cm]{Logos/LeeLogo}}


\begin{frame}[fragile]{Aufgaben}{Programmier-Skript}
	\begin{itemize}
		\item \readbox{Definition 7.1, Beispiele 7.1-7.2}
		\item \aufgabebox{7.1, 7.2}
	\end{itemize}
\end{frame}
