\begin{frame}
    \centering
    \begin{figure}[H]
        \includegraphics[keepaspectratio, width=0.7\paperwidth, height=\paperheight]{Logos/FreeFlower.pdf.pdf}
    \end{figure}
...
Rückgängig (\enquote{undo}) &\keys{\ctrl + Z}& \keys{\cmd + Z}\\\midrule
Vorwärts (\enquote{redo}) &\keys{\ctrl +\shift + Z}& \keys{\cmd + \shift + Z}\\\midrule
...
\end{lstlisting}
\begin{itemize}
    \item Zeile 1: sind \lstinline|resultat| und \lstinline|zahl| gute Variablennamen?
    \item Zeile 2: weshalb \lstinline|resultat=0|?
\end{itemize}
\end{frame}
...
\end{lstlisting}
\begin{itemize}
    \item Zeilen 1-3: Weshalb \lstinline|import turtle as t| und \lstinline|makeTurtle()|?
    \item Zeile 4: Weshalb \lstinline|def|?
    \item Zeile 5: Weshalb \lstinline|input("Welche Zahl")|?
\end{itemize}
\end{frame}
