...
\begin{frame}[fragile]{Reminder: Farben kodieren}
	\begin{figure}[H]
		...
		\begin{subfigure}{.49\textwidth}
			\includegraphics[width=\textwidth]{Grundlagen_Info/13_ZahlendarstellungenUndKodierungen/Figures/rgb-farbmischung-1.jpg}
		\end{subfigure}
		\begin{subfigure}{.49\textwidth}
			\includegraphics[width=\textwidth]{Grundlagen_Info/13_ZahlendarstellungenUndKodierungen/Figures/rgb-farbmischung-2.png}
		\end{subfigure}
	\end{figure}
...
\begin{frame}{Aufträge}
	\begin{enumerate}
		...
		\item Zeichnen Sie eine horizontal dreigeteilte Flagge (wie etwa die von Frankreich \emoji{flag-france} oder Italien \emoji{flag-italy}).
