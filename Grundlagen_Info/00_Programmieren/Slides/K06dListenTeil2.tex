...
\subtitle{Dynamische Datenstrukturen}
...
\begin{frame}[fragile]{Beispiel}
	\begin{lstlisting}[numbers=left,escapechar=|]
		...
		print(zahlen) # |\only<1>{\textcolor{blue}{Was wird gedruckt?}}||\only<2->{\textcolor{blue}{[3, 1, 7, -2, 6, -12, 5, 6, 9, 22]}}|
		
		zahlen.pop()
		zahlen.pop()
		print(zahlen) # |\only<1-2>{\textcolor{blue}{Was wird gedruckt?}}||\only<3->{\textcolor{blue}{[3, 1, 7, -2, 6, -12, 5, 6]}}|
	\end{lstlisting}
\end{frame}
...
\begin{frame}[fragile]{Auftrag}{Skript}
	\begin{itemize}
		\item \aufgabebox{Aufgaben 6.15-6.17}
		\item Lernkontrolle auf Moodle
	\end{itemize}
\end{frame}
