...
\begin{frame}[fragile]{\lstinline|return|: Analogie \emoji{cook}}
	...
	\begin{itemize}
	    ...
	    \textbf{Tipps:}
	    	    \begin{itemize}
	    	    	...
	    	    	\item Vergleiche (\lstinline|if ...|) jedes Glied der Liste (beginnend mit jenem mit Index 1) mit dem Glied davor
	    	    	\item Falls zwei Glieder in der falschen Reihenfolge gefunden werden, wird \lstinline|False| retourniert.
	    	    	\item Falls man am Ende der Liste ist, wird \lstinline|True| retourniert.
	    	    \end{itemize}
