...
\begin{frame}[fragile]{Negation von Aussagen}
    \begin{table}
        \begin{tabular}{p{5cm}|p{5cm}}
            ...
            \visible<+->{\enquote{Das Mädchen heisst Elin}}& \visible<+->{\enquote{Das Mädchen heisst nicht Elin}}\\\midrule
            \visible<+->{\enquote{Niemand in dieser Klasse ist volljährig}}& \visible<+->{\enquote{Mindestens eine Person in dieser Klasse ist volljährig}}\\\midrule
...
\begin{frame}[fragile]{Mehrere Bedingungen zusammenfassen}{Negation mehrerer Bedingungen}
