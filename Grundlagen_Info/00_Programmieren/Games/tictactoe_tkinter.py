...
def draw_grid(canvas):
    for i in range(1, GRID_SIZE):
        # Vertical lines
        canvas.create_line(i*CELL_SIZE, 0, i*CELL_SIZE, GRID_SIZE*CELL_SIZE, width=5, fill="gray")
        # Horizontal lines
        canvas.create_line(0, i*CELL_SIZE, GRID_SIZE*CELL_SIZE, i*CELL_SIZE, width=5, fill="gray")
