...
Sie kenne bereits die Funktionen \pythoninline{print} sowie \pythoninline{t.forward} und haben diese auch schon mehrmals selbst verwendet. In diesem Kapitel werden Sie lernen, wie Sie eigene Funktionen in Python definieren und schliesslich sinnvoll verwenden können. Funktionen helfen enorm dabei, Programme leserlicher, kürzer, effizienter und wartbarer zu machen. Funktionen sind deshalb aus modernen Programmen kaum wegzudenken sind.
...
Wir könnten den Code leserlicher machen, indem wir zunächst eine Funktion \pythoninline{quadrat()} definieren, welche lediglich ein Quadrat zeichnet. Danach definieren wir eine weitere Funktion \pythoninline{quadrat_blume}, welche die Funktion \pythoninline{quadrat} insgesamt 10 Mal aufrufen wird:
