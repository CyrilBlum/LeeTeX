...
t.done()
  \end{lstlisting}
	...
	Für die Übersichtlichkeit des Codes sind folgende Aspekte zu beachten:
	\begin{itemize}
		\item Innere Schleifen sollten, wenn immer möglich, vermieden und durch Definitionen ersetzt werden.
		\item Der Name einer Funktion sollte selbsterklärend und beschreibend sein. Im Idealfall lässt der Name der Funktion schon viel über ihren Effekt erahnen.  %TODO Beispiel
	\end{itemize}
\end{myoverview}
...
\begin{myoverview}[Nomenklatur bei Python-Funktionen]\label{myoverview:NomenklaturFunktion}
	...
	\begin{description}
		...
		\item[Körper der Funktion]: \lstinline|return x * y|\\
...
\begin{myexercise}\label{ex:quadrat-return}
	Geben sei eine ganze Zahl \texttt{n}. Schreiben Sie eine Funktion \lstinline|square(n)|, welche das Quadrat von \lstinline|n| berechnet und mit \lstinline|return| zurückgibt.
