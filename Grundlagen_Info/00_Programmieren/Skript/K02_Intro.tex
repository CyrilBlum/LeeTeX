\chapter{Einführung in Python und erste Schleifen}\label{ch:K02Intro}
...
\section{Schleifen}
Schleifen\index{Schleife} (Englisch: \textit{loops}\index{loop}) ermöglichen uns, Prozesse zu wiederholen.
...
\lstinputlisting[language=Python,caption=\texttt{treppe.py},label=listing:treppe]{Grundlagen_Info/00_Programmieren/Skript/Code/K02_Intro/treppe.py}
