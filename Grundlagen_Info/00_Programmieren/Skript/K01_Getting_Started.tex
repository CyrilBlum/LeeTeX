...
Führen Sie danach folgende Befehle einzeln aus (jeweils durch das Drücken der \keys{\return}-Taste), um VSCodium, Python und die Turtle zu installieren.

Installieren des \gls{IDE} VSCodium:
\begin{lstlisting}[language=bash, numbers=none]
...
Sie können jetzt mit der \keys{\faWindows}-Taste das Programm-Menu öffnen und nach \textit{VSCodium} suchen, welches nun installiert sein sollte.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{Grundlagen_Info/00_Programmieren/Skript/Figures/Trust_Authors.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{Grundlagen_Info/00_Programmieren/Skript/Figures/Python_Language_Support_Extension.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{Grundlagen_Info/00_Programmieren/Skript/Figures/createHelloWorld.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{Grundlagen_Info/00_Programmieren/Skript/Figures/runHelloWorld.png}
