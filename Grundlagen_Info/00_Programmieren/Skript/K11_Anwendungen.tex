...
\begin{mysubmission}\label{ex:bmr-simple}
	...
	\end{enumerate}
	\begin{myanswer}
		\lstinputlisting[language=Python]{Grundlagen_Info/00_Programmieren/Skript/Code/K05_Logical_Expressions/grundumsatz.py}
	\end{myanswer}
\end{mysubmission}
...
\begin{mysubmission}\label{ex:bmr}
	...
	\begin{myanswer}
		\lstinputlisting{Grundlagen_Info/00_Programmieren/Skript/Code/K06_Datenstrukturen/bmr_functions/bmr.py}
	\end{myanswer}
\end{mysubmission}
...
\begin{mysubmission}\label{ex:leistungsumsatz}
	...
	\begin{myanswer}
		\lstinputlisting{Grundlagen_Info/00_Programmieren/Skript/Code/K06_Datenstrukturen/bmr_functions/leistungsumsatz.py}
	\end{myanswer}
...
\begin{mysubmission}
	...
	\begin{myanswer}
		...
		\lstinputlisting{Grundlagen_Info/00_Programmieren/Skript/Code/K06_Datenstrukturen/bmr_functions/total.py}
	\end{myanswer}
\end{mysubmission}
