\chapter{Funktionen}\label{ch:K05_Functions}
...
\lstinputlisting[language=Python,caption=\texttt{squares\_noparams.py},label=listing:squares_noparams]{Grundlagen_Info/00_Programmieren/Skript/Code/K05_Functions/squares_noparams.py}
...
\lstinputlisting[language=Python,caption=\texttt{farb\_vieleck.py},label=listing:farb_vieleck]{Grundlagen_Info/00_Programmieren/Skript/Code/K05_Functions/farb_vieleck.py}
\begin{figure}[H]
	\centering
...
\begin{myexercise}
	Schreiben Sie eine Funktion \lstinline|ist_quadrat(x)|, die überprüft, ob $x$ eine Quadratzahl ist (also ob es eine ganze Zahl $a$ gibt, so dass $x = a \cdot a$).
...
\begin{myexercise}\label{ex:local-global}
	...
	\lstinputlisting[language=Python,caption=\texttt{houses.py},label=listing:houses]{Grundlagen_Info/00_Programmieren/Skript/Code/K05_Functions/houses.py}
...
\begin{minipage}{.65\textwidth}
	\lstinputlisting[language=Python,caption=\texttt{spirale\_kreis.py}]{Grundlagen_Info/00_Programmieren/Skript/Code/K05_Functions/spirale_kreis.py}
\end{minipage}
...
\begin{myexercise}[Formel 1 \emoji{chequered-flag}]\label{ex:f1}
	...
	\begin{myanswer}
		\lstinputlisting[language=Python,caption=\texttt{f1\_avg\_speed.py}]{Grundlagen_Info/00_Programmieren/Skript/Code/K05_Functions/f1_avg_speed.py}
	\end{myanswer}
\end{myexercise}
...
\begin{myexercise}[Boxenstopp \emoji{fuelpump}]
	...
	\begin{myanswer}
		\lstinputlisting[language=Python,caption=\texttt{f1\_pitstops.py}]{Grundlagen_Info/00_Programmieren/Skript/Code/K05_Functions/f1_pitstops.py}
	\end{myanswer}
\end{myexercise}
	...
	\begin{myanswer}[myexercise:kaufpreis_haus]
		\begin{enumerate}
			...
			\item
			      ...
			      \lstinputlisting[language=Python,caption=\texttt{max\_kaufpreis.py},label=listing:max_kaufpreis]{Grundlagen_Info/00_Programmieren/Skript/Code/K05_Functions/max_kaufpreis.py}
