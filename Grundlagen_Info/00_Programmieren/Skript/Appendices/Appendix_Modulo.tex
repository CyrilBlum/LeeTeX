...
Auf dem Planeten \textit{Vulcan} dauert ein Tag nur 5 Stunden. Deshalb verwenden die \textit{Vulcanians} Uhren der unten abgebildeten Form. Diese Uhren verfügen lediglich über einen Stundenzeiger.
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
