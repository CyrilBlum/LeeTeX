...
\newcommand{\smallField}[1]{\refstepcounter{FormCounter}\raisebox{-0.28\normalbaselineskip}{\TextField[name=\theFormCounter, width=#1,print,borderwidth=0, backgroundcolor={0.9 0.9 0.9}]{}}}
...
\def\bigrectangle{(-2,-2) rectangle (4,2)}

\colorlet{circle edge}{black}
\colorlet{circle area}{green!40}
\colorlet{rectangle edge}{green!80}
\colorlet{rectangle area}{green!20}

\tikzset{filled/.style={fill=circle area, draw=circle edge, thick},
    outline/.style={draw=circle edge, thick}}

\tikzset{filled/.style={fill=rectangle area, draw=rectangle edge, thick},
    outline/.style={draw=rectangle edge, thick}}