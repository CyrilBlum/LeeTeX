...
\begin{myexercise}\label{ex:bmr}
	Schreiben Sie eine weitere Funktionen, um den \gls{BMR} anhand der \textbf{Mifflin-St-Jeor-Gleichung} und der \textbf{Katch-McArdle-Formel} zurückzugeben und berechnen Sie den Durchschnitt aller drei Formeln.
	\begin{enumerate}
