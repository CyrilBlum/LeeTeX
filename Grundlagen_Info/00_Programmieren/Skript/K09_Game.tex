...
Setzen Sie einen passenden Fenstertitel (\lstinline|pg.display.set_caption("Mein Game")|). 

Laden Sie ein Fenster-Icon (png oder jpg). Hierzu müssen Sie ein Bild nach Ihrer Wahl in Ihrem Projektordner ablegen und den relativen Pfad angeben:
...
Wenn Ihr Ordner beispielsweise \texttt{Informatik/} heisst und das Bild gespeichert ist unter \texttt{Informatik/Game/icon.png}, dann verwenden Sie \lstinline|pg.image.load("Game/icon.png")|.
...
Die Farbe muss in der Hauptschleife, aber vor \lstinline|pg.display.flip()|, gesetzt werden.
\begin{myanswer}
