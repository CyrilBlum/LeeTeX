...
Hierzu müssen Sie ein Bild in Ihrem Projektordner ablegen und den relativen Pfad angeben. Wenn Ihr Ordner beispielsweise \texttt{Informatik/} heisst und das Bild gespeichert ist unter \texttt{Informatik/Game/icon.png}, dann verwenden Sie \lstinline|pg.image.load("Game/icon.png")|.
