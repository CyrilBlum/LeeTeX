...
\subsection{Thema}
Im Folgenden wählen Sie in Zweier-Gruppen (in Ausnahmefällen auch 3 möglich) ein Game-Thema aus und entwickeln ein kleines 2D-Game mit \texttt{pygame-ce}. Mögliche Themen sind beispielsweise:
\begin{itemize}
