...
\begin{center}
    \url{https://cyrilblum.github.io/FreeFlower/vscode-python-setup.html}
\end{center}
...
Die kleine Ziffer \texttt{1} ist die Zeilennummer (diese wird vom Code-Editor automatisch gesetzt). Wir führen nun das Programm aus (\enquote{lassen das Programm laufen}), indem wir (oben rechts) auf den \faPlay-Knopf klicken. Bei uns sieht die Situation aus wie in \cref{fig:runHelloWorld}.
\begin{figure}[H]
    \centering
