%%% TODO %%%: ich schlage vor, diesen kompletten Text neu zu schreiben, sobald sich dieses Skript nicht mehr im alpha-Stadium befindet.
...
Dieses Dokument hat zum Ziel, einen Semesterplan für die Einführung in das Programmieren auf Gymnasialstufe\footnote{Schweizer Bildungssystem, Sekundarstufe II, Altersstufe ca. 15--18 Jahre, Grundlagenfach Informatik} mittels der Programmiersprache \textit{Python} zur Verfügung zu stellen. Das Semesterprogramm setzt weder besonderen Programmier- noch Informatikkenntnisse voraus. Das Semesterprogramm erstreckt sich über ca. 10 Lektionen und sollte den SuS ermöglichen, einfache mathematische und grafische Programme in Python zu schreiben.

Da relativ wenig Zeit für das Grundlagenfach Informatik zur Verfügung steht, liegt der Fokus dieses Semesterprogramms auf grundlegenden Python-Kenntnissen. Als Fortsetzung und Vertiefung der neu gewonnen Kenntnisse empfiehlt sich eine Einführung in die Robotik im Grundlagenfach, beziehungsweise eine Vertiefung der Programmierung im Ergänzungsfach, beispielsweise mit Themen wie Rekursion oder objektorientierter Programmierung.
...
\begin{myoverview}[Überblick der Themen]
	\leavevmode
	\begin{enumerate}
		\item \textbf{Allgemeine Motivation und Einführung ins Programmieren}
		      \begin{itemize}
			      ...
			      \item Einfache Schleifen mit \lstinline|for _ in range(...)|
		      \end{itemize}
