...
\begin{myexercise}\label{Wurzelspirale}
	Schreiben Sie ein Programm, das die Funktion \lstinline|flaeche_dreieck(h, b)| aus \cref{ex:dreieck-return} verwendet, um den Flächeninhalt der folgenden Wurzelspirale zu berechnen.
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.3\linewidth]{Grundlagen_Info/00_Programmieren/Skript/Figures/Spiral_of_Theodorus.pdf}
	\end{figure}
	\begin{myanswer}
		\lstinputlisting[language=Python,caption=\texttt{wurzelspirale.py},label=listing:wurzelspirale]{Grundlagen_Info/00_Programmieren/Skript/Code/K04_Functions/wurzelspirale.py}
	\end{myanswer}
...
\begin{myexercise}
	...
	\begin{myanswer}
		\lstinputlisting[language=Python,caption=\texttt{notenschnitt.py},label=listing:notenschnitt]{Grundlagen_Info/00_Programmieren/Skript/Code/K04_Functions/notenschnitt.py}
	\end{myanswer}
...
\begin{myexercise}[Formel 1 \emoji{chequered-flag}]\label{ex:f1}
	...
	\begin{myanswer}
		\lstinputlisting[language=Python,caption=\texttt{f1\_avg\_speed.py},label=listing:f1_avg_speed]{Grundlagen_Info/00_Programmieren/Skript/Code/K04_Functions/f1_avg_speed.py}
	\end{myanswer}
\end{myexercise}
