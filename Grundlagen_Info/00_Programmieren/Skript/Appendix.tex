...
\end{align*}
Danach erhalten wir die zweithinterste Ziffer $x'_1$ durch $x^{(1)}\;\%\; b$ und so weiter. In \cref{listing:baseAtoBaseB} ist eine Python-Funktion gegeben, welche die Umrechnung von Basis $a$ in Basis $b$ berechnet.

\clearpage
\lstinputlisting[language=Python,caption=\texttt{base\_a\_to\_base\_b.py},label=listing:baseAtoBaseB]{Grundlagen_Info/00_Programmieren/Skript/Code/K04_Functions/base_a_to_base_b.py}
