...
\begin{lstlisting}
    ...
    a + 5 # berechnet die Summe 10 + 5, Inhalt von a wird nicht geändert
    print(a) # a hat immernoch den Wert 10

    a += 7 # erhöhe den aktuellen Wert von a um 7, Inhalt von a wird geändert
...
\begin{mysubmission}
	Geben Sie die Kubikzahlen von $1, 2, 3, \ldots, 10$ aus. Die Kubikzahl einer Zahl \texttt{x} ist gleich der Zahl hoch 3, also $\text{\texttt{x}}^3$. Die Kubikzahl von 1 ist demnach $1^3 = 1$, die Kubikzahl von 2 ist $2^3 = 8$, etc.
