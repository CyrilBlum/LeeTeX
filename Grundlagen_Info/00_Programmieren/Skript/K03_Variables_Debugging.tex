...
\begin{myexercise}\label{ex:austausch-fix}
	...
	\begin{myanswer}
		...
		\begin{lstlisting}
            ...
            temp = x # Verwende Hilfsvariable, um anfänglichen Wert von x zu speichern:
            x = y
            y = temp
        \end{lstlisting}
	\end{myanswer}
...
\begin{myexample}
Offensichtlich ist eine natürliche Zahl $n$ genau dann gerade, wenn $n \% 2 = 0$ gilt, also $n$ beim Teilen durch 2 den Rest 0 hat.
\end{myexample}
...
\begin{lstlisting}
a = "Hello, World!"
print(a)  # printet den Text "Hallo, World!" im Terminal 
...
\begin{myattention}[Typumwandlung]
	myattention
\end{myattention}
