...
\begin{lstlisting}[numbers=none]
    ...
    \end{lstlisting}
wird veranlasst, dass der Variablenname \pythoninline{a} zu einer Referenz (einem Verweis) auf den Speicherort eines Objekts vom Typ \enquote{ganze Zahl} mit dem Wert \pythoninline{436} wird.
\end{mydefinition}
...
\begin{table}[H]
	...
	\begin{tabular}{c|l}
		...
		\pythoninline{x += y}                         & speichere \pythoninline{x + y} in \pythoninline{x}  \\\midrule
		\pythoninline{x -= y}                         & speichere \pythoninline{x - y} in \pythoninline{x}  \\\midrule
		\pythoninline{x *= y}                         & speichere \pythoninline{x * y} in \pythoninline{x}  \\\midrule
		\pythoninline{x /= y}                         & speichere \pythoninline{x / y} in \pythoninline{x}  \\\midrule
		\pythoninline{x //= y}                        & speichere \pythoninline{x // y} in \pythoninline{x} \\\midrule
		\pythoninline{x \%= y}                        & speichere \pythoninline{x \% y} in \pythoninline{x}
	\end{tabular}
...
\begin{myremark}[Input erwartet immer einen String]\label{myremark:input_takes_string}
	Bitte beachten Sie, dass die \lstinline{Input}-Funktion in Python den Tastaturinput immer als String auffasst. Falls Ihr Input als Zahl angesehen werden soll, dann müssen Sie den Input \pythoninline{x} mit \pythoninline{int(x)} beziehungsweise \pythoninline{float(x)} konvertieren:
	\begin{lstlisting}
...
\begin{mychallenge}\label{mychallenge:fibonacci_spirale}
	...
	Verwenden Sie dazu eine \pythoninline{for}-Schleife sowie drei Variablen.
