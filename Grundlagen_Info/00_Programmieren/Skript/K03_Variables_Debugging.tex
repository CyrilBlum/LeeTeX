...
\begin{mychallenge}\label{mychallenge:tausch_mit_2_variablen}
	In den Variablen \lstinline|x| und \lstinline|y| seien wieder zwei ganze Zahlen gespeichert. Schreiben Sie ein Programm, welches die Werte von \lstinline|x| und \lstinline|y| tauscht, ohne eine weitere \enquote{Hilfsvariable} wie in \cref{ex:austausch-fix} zu verwenden.
