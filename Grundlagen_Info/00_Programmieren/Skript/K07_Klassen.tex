...
Im Grunde genommen kennen wir Klassen in Python bereits: so erstellen wir beispielsweise jedes Mal eine Instanz der Klasse \lstinline|list|, wenn wir eine Variable des Typs Liste erstellen (s. \cref{fig:listen-in-python}).
\begin{figure}[H]
	\begin{tikzpicture}[font=\sffamily]
	% Styles
	\tikzset{
