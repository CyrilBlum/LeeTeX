...
Der Begriff \enquote{Kompression} stammt --- wie viele andere Begriffe --- ursprünglich aus dem Latenischen (\textit{compressio} $=$ das Zusammendrücken, das Zusammenpressung, die Umarmung). Mit Kompression ist also häufig die \enquote{Verkleinerung}, bzw. das \enquote{Zusammendrücken} von Daten gemeint, meist aus einem der folgenden Gründen:
