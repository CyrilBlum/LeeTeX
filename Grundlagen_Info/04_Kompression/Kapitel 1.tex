...
\begin{enumerate}
	\item \textbf{Speicherplatz sparen}: Speichermedien wie Festplatten verursachen Kosten. Mit Kompression kann der Speicherbedarf minimiert werden --- ähnlich wie beim Packen eines Reisekoffers (siehe \cref{fig:speicherplatz-opt}).
		  \begin{figure}[H]
			  \centering
			  \raisebox{-0.5\height}{\includegraphics[width=.45\textwidth]{Grundlagen_Info/04_Kompression/Figures/messy_suitcase.jpg}}
			  \raisebox{-0.5\height}{$\rightarrow$}
			  \raisebox{-0.5\height}{\includegraphics[width=.45\textwidth]{Grundlagen_Info/00_Programmieren/Figures/prog-packing-cubes}}
			  \caption{Speicherplatz optimieren}
			  \label{fig:speicherplatz-opt}
		  \end{figure}
	\item \textbf{Wartezeit verkürzen}: Computer kommunizieren in Netzwerken, innerhalb welchen oftmals grosse Datenmengen übertragen werden müssen. Die Verbindungen zwischen den Geräten haben jedoch nur eine begrenzte Kapazität und werden daher häufig als \tib{Flaschenhälse} bezeichnet.
		  \begin{figure}[H]
			  \centering
			  \resizebox{!}{.5\height}{%
				  \begin{tikzpicture}
...
\begin{figure}
	...
	\begin{subfigure}{.45\linewidth}
		\begin{tikzpicture}[boximg]
			\node[anchor=south west] (img) {\includegraphics[width=\linewidth]{{Grundlagen_Info/04_Kompression/Figures/LeeLogo 300 dpi.jpg}}};
	...
	\begin{subfigure}{\linewidth}
		\begin{tikzpicture}[boximg]
			\node (img1) {\includegraphics[width=0.9\linewidth]{Grundlagen_Info/04_Kompression/Figures/LeeLogo 300 dpi zoom}};
...
\begin{table}[H]
	...
	\begin{tabular}{c|c|c|c|c}
		\textbf{Buchstabe}        & \textbf{\textcolor{red}{A}} & \textbf{\textcolor{blue}{B}} & \textbf{\textcolor{green}{C}} & \textbf{\textcolor{orange}{D}} \\\midrule\midrule
...
\end{table}
\begin{itemize}
	\item \enquote{Naive} Kodierung (40 Zeichen):\\ \texttt{\textcolor{red}{00} \textcolor{red}{00} \textcolor{green}{10} \textcolor{red}{00} \textcolor{blue}{01} \textcolor{red}{00} \textcolor{red}{00} \textcolor{red}{00} \textcolor{green}{10} \textcolor{blue}{01} \textcolor{red}{00} \textcolor{green}{10} \textcolor{red}{00} \textcolor{red}{00} \textcolor{green}{10} \textcolor{red}{00} \textcolor{orange}{11} \textcolor{red}{00} \textcolor{red}{00} \textcolor{orange}{11}}
	\item \enquote{Effiziente} Kodierung (32 Zeichen, -20\% Ersparnis):\\ \texttt{\textcolor{red}{0} \textcolor{red}{0} \textcolor{green}{10} \textcolor{red}{0} \textcolor{blue}{110} \textcolor{red}{0} \textcolor{red}{0} \textcolor{red}{0} \textcolor{green}{10} \textcolor{blue}{110} \textcolor{red}{0} \textcolor{green}{10} \textcolor{red}{0} \textcolor{red}{0} \textcolor{green}{10} \textcolor{red}{0} \textcolor{orange}{111} \textcolor{red}{0} \textcolor{red}{0} \textcolor{orange}{111}}\\

\end{itemize}

Die \enquote{effiziente} Kodierung verwendet in diesem Fall 20\% weniger Speicherplatz als die \enquote{naive} Kodierung.

Beide Kodierungen sind \textbf{präfixfrei}: Kein Codewort ist Anfangsstück (Präfix) eines anderen Codeworts. Dies ist notwendig, damit es keine Verwechslungsgefahr beim Interpretieren des Codes gibt.
	...
	\begin{myanswer}
		\begin{figure}[H]
			...
			\begin{tikzpicture}
				...
				\node[n]{\textcolor{RoyalBlue}{A,B,C,D,E,F}\\ 100\%}[edge from parent]
				child {node[n] {\textcolor{RoyalBlue}{A,B}\\ 50\%}
						child {node[n] {\textcolor{RoyalBlue}{A}\\49\%\\\textcolor{red}{00}}
								edge from parent[] node[left,r]{0};
							}
	...
	\item Jeder Buchstabe wird als Graph mit einem Knoten (=Baum mit einem Blatt) betrachtet. Die Häufigkeit jedes Buchstabens wird neben dem Blatt notiert. Wir wollen nun die Buchstaben zu Teilbäumen verbinden, bis wir einen einzigen Baum haben.
	      \begin{figure}[H]
		      ...
		      \begin{tikzpicture}[background rectangle/.style={fill=black!3,rounded corners}, show background rectangle]
			      ...
			      \node[circle,draw, label={[align=center]below:\textcolor{RoyalBlue}{A}\\49\%}, ](a){};
...
\begin{figure}[H]
	...
	\begin{subfigure}{.45\textwidth}
		\begin{tikzpicture}[-,>=stealth',
			...
			\node[n, left of=c](a){\textcolor{RoyalBlue}{A}\\49\%};
		\end{tikzpicture}
		\caption{Schritt 1}
	\end{subfigure}\hfill
	\begin{subfigure}{.45\textwidth}
	...
	\begin{subfigure}{.49\textwidth}
		\begin{tikzpicture}[-,>=stealth',
			...
			\node[n, left=5mm of f](a){\textcolor{RoyalBlue}{A}\\49\%};
		\end{tikzpicture}
		\caption{Schritt 4}
	\end{subfigure}
	\hfill
	\begin{subfigure}{.49\textwidth}
		\begin{tikzpicture}[-,>=stealth',
			...
			child{node(a)[n]{\textcolor{RoyalBlue}{A}\\49\%}
					edge from parent node[left,r]{} ;
				}
	...
	\begin{subfigure}{.49\textwidth}
		\begin{tikzpicture}[-,>=stealth',
			...
			\node(acebd)[n]{\textcolor{RoyalBlue}{A,C,F,E,B,D}\\ 100\%}[edge from parent]
			child{node(a)[n]{\textcolor{RoyalBlue}{A}\\49\%\\\textcolor{red}{0}}
					edge from parent node[left,r]{0} ;
				}
			child{node(cfebd)[n]{\textcolor{RoyalBlue}{C,F,E,B,D}\\ 51\%}
