...
\begin{frame}[label=jv]{Jules Verne \emoji{scroll}}
	\begin{figure}[H]
	        \centering
	        \includegraphics[width=\linewidth]{Grundlagen_Info/03_Kryptologie/Figures/julesverne2.png}
	\end{figure}
	\begin{itemize}[<+->]
	    \item \emoji{check-mark-button} Vorteil: nicht mehr monoalphabetische, sondern polyalphabetische Verschlüsselung
	    \item \emoji{check-mark-button} Ein \enquote{E} kann nun beispielsweise um 1 (F), 2 (G), 3 (H), 4 (I) oder 5 (J) Positionen verschoben sein.
...
\begin{itemize}
    \item \enquote{\texttt{NXLI}} kommt zweimal im Geheimtext vor
...
\only<1>{
Angenommen, wir haben folgenden Text, verschlüsselt mit dem Wort \enquote{BALMER}:
\begin{figure}[H]
        \centering
...
\begin{frame}[label=keyFixed]{Angriff auf Vigenère: Bekannte Schlüssellänge}
	...
	\begin{figure}[H]
	        \centering
	        \includegraphics[width=\linewidth]{Grundlagen_Info/03_Kryptologie/Figures/vigenereKeyFixed1.png}
	\end{figure}
	}
	...
	\begin{figure}[H]
	        \centering
	        \includegraphics[width=\linewidth]{Grundlagen_Info/03_Kryptologie/Figures/vigenereKeyFixed2.png}
	\end{figure}
	}
	\only<3>{\textbf{Häufigkeitsanalyse} pro Gruppe (rot, grün, blau):\\
	\begin{figure}[H]
	        \centering
	        \raisebox{-0.5\height}{\includegraphics[width=.45\textwidth]{Grundlagen_Info/03_Kryptologie/Figures/friedmann1-geheimtext.png}}
	        \raisebox{-0.5\height}{$\rightarrow$}
	        \raisebox{-0.5\height}{\includegraphics[width=.45\textwidth]{Grundlagen_Info/03_Kryptologie/Figures/friedmann1-klartext.png}}
	\end{figure}}
\end{frame}
