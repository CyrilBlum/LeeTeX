...
\begin{frame}[fragile, label=hauefigkeit]{Häufigkeitsverteilung}
	\begin{multicols}{2}
		    \begin{figure}[H]
			\centering
			\includegraphics[width=\linewidth]{Grundlagen_Info/03_Kryptologie/Figures/freq.png}
		\end{figure}
		\columnbreak
		\[h_\square (T)\]
    ...
    \begin{figure}[H]
    	\centering
    	\includegraphics[width=.7\textwidth]{Grundlagen_Info/03_Kryptologie/Figures/letterfreq_end_dec0}
    \end{figure}
\end{frame}
...
\textbf{Problem}: Alle \textbf{monoalphabetischen} Kryptosysteme lassen sich mit einfacher Häufigkeitsanalyse knacken
    \begin{figure}[H]
        \centering
        \includegraphics[width=.5\linewidth]{Grundlagen_Info/03_Kryptologie/Figures/freq.png}
        \includegraphics[width=.35\linewidth]{Grundlagen_Info/03_Kryptologie/Figures/bigramme.png}
    \end{figure}
...
\end{verbatim}
Wir fahren nun mit Trigrammen weiter: \enquote{Die}?}
    \defverbatim{\verbFour}{
    \small\begin{verbatim}
MUMMUXJUQYMHQOUSUTUQNGWTJQVHUMXQUXQJSUVYPPUM
NENNEDREI-N-I-E-E-EI----RI--ENDIEDIR-E----EN
\end{verbatim}
\enquote{D-EI}=\enquote{Drei}?}
...
\begin{frame}{Mono- und Polyalphabetische Kryptosysteme}
	\begin{itemize}[<+->]
		\item \textbf{Monoalphabetisch}: Jeder Buchstabe wird immer durch denselben Buchstaben ersetzt, unabhängig von seiner Position im Klartext. \textbf{Nachteil}: Einfache Entschlüsselung durch Häufigkeitsanalyse
...
%	\begin{center}
%		\enquote{Ein Kryptosystem ist \textbf{sicher}, wenn das Kryptosystem [= der Algorithmus] öffentlich bekannt ist und es trotzdem ohne die Kenntnis des verwendeten Schlüssels nicht möglich ist, aus einem Geheimtext den ursprünglichen Klartext abzuleiten.}
%	\end{center}    
%\end{frame}