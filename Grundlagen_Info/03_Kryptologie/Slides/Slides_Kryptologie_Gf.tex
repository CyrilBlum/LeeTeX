...
\begin{frame}{Limitierung von Geheimschriften}
    ...
    \emph{Security through Obscurity} (Sicherheit durch Verschleierung) bezeichnet die Praxis, die Sicherheit eines Systems dadurch zu gewährleisten, dass die Funktionsweise des Systems geheim gehalten wird. \hfill\par
    \vspace{\baselineskip}
...
\begin{frame}{Von Geheimschriften zu Kryptosystemen}
    \begin{myidea}[Kryptosystem]
        Wir wollen von Geheimschriften zu sogenannten \textbf{Kryptosystemen} übergehen, die so konstruiert sind, dass sie auch dann sicher sind, wenn die grundlegende Funktionsweise des Systems öffentlich bekannt ist. \hfill\par
        \vspace{\baselineskip}
