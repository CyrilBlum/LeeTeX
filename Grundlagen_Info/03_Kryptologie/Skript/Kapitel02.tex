...
der Gegner das Kommunikationsprotokoll kennt und die zwei zufällig generierten Schlüssel das Einzige sind, was ihm unbekannt ist. Wenn der Gegner (Eve) alle drei Kryptotexte ($k_A, k_B, k_{AB}$) gewinnen kann, kann er durch die folgenden Berechnungen den Klartext $t$ herausfinden:
\begin{align*}
	& k_A \oplus k_B \oplus k_{AB}  =                            \\
	& (t \oplus s_A) \oplus (k_{AB} \oplus s_A) \oplus k_{AB} = \\
	& t \oplus (s_A \oplus s_A) \oplus (k_{AB} \oplus k_{AB}) =      \\
	& t \oplus 0 \oplus 0 = t.
\end{align*}
