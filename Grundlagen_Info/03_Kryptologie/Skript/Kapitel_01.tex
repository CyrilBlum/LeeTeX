...
\begin{itemize}
	\item Einerseits reicht es, alle 26 (0 bis 25) möglichen Verschiebungen auszuprobieren. 
	Ein moderner Computer hat dies in einigen Millisekunden erledigt. 
	Natürlich muss ein Angreifer (beziehungsweise sein Computer) auch die Möglichkeit haben, den Klartext zu erkennen, wenn er ihn sieht, z.\,B. durch die Erkennung von sinnvollen Wortteilen (e.g. Abgleich mit einem deutschen Wörterbuch).
