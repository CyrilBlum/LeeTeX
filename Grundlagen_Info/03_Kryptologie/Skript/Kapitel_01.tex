...
In \cref{myremark:monoalph-subst-anzahl-schluessel} haben Sie sehen, dass es eine sehr grosse Anzahl solcher Zuordnungen gibt.
Obschon die Schlüsselmenge bei der allgemeinen monoalphabetischen Substitution viel grösser ist als bei Caesar, kann dieser Verschlüsselungsalgorithmus ebenfalls (wie Ceasar) sehr einfach mit Hilfe einer Häufigkeitsanalyse geknackt werden. Das genauere Vorgehen wird in \cref{myexample:monoalph-subst-freq} illustriert.
