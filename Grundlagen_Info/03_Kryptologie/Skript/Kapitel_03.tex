 ...
 \begin{figure}[H]
	...
	\newcommand{\lockbox}[3]{%
		\begin{tikzpicture}[x=1cm,y=1cm]
			% \draw[gray,line width=.7pt] (0,0.2) rectangle (2.85,1.42);
	...
	\newcommand{\messagearrow}[3]{%
		\begin{tikzpicture}[x=1cm,y=1cm]
			\node[font=\small] at (0,.32) {#1};
			\draw[->,line width=.65pt] (#2,0) -- (#3,0);
		\end{tikzpicture}
	}
	...
	\begin{tabular}{c@{\hspace{.3cm}}c@{\hspace{.3cm}}c}
		...
		\end{minipage}
		&
		\messagearrow{Erster Krypto-Text: \texttt{110000}}{-1.75}{1.75}
		&
		\begin{minipage}{4.3cm}
			\centering
			\phantom{\lockbox{o}{o}{}}
		...
		\end{minipage}
		&
		\messagearrow{Zweiter Krypto-Text: \texttt{011010}}{1.75}{-1.75}
		&
		\begin{minipage}{4.3cm}
			\centering
			\lockbox{c}{c}{%
		...
		\end{minipage}
		&
		\messagearrow{Dritter Krypto-Text: \texttt{000001}}{-1.75}{1.75}
		&
		\begin{minipage}{4.3cm}
			\centering
			\phantom{\lockbox{o}{o}{}}
		...
		&
		\begin{tikzpicture}[x=1cm,y=1cm]
			\node[font=\small] at (0,0) {Empfänger erhält den Klartext};
		\end{tikzpicture}
		&
		\begin{minipage}{4.3cm}
			\centering
