...
\author{Autoren: Patrick Hnilicka, Michael Anderegg, Cyril Blum, Thomas Graf\\
\mycourse, \myclass}
\date{\mydate}
\maketitle
...
\end{figure}
\begin{parts}
\part[2] Zeichnen Sie die Karte als Graphen, wobei jeder der \einheitPl{} ein Knoten sein soll und zwischen zwei Knoten jeweils eine Kante besteht, sofern zwei \einheitPl{} von \ort{} aneinandergrenzen. Als Namen der Knoten können Sie eine Abkürzung wählen (also z.B. \enquote{\bspnummer} für \bspname).
\begin{solution}
\begin{figure}[H]
\centering
\tikzStadt
...
\question
        ...
        \begin{parts}
            ...
            \begin{solutionorgrid}[\stretch{2}]
                ...
                \begin{center}
                    \includegraphics[width = 0.5\textwidth]{Grundlagen_Info/Exam_Questions/Figures/lsg2-2024-1.jpg}
                \end{center}
                \centering
                \begin{tabular}{|c|c|c|}
                \hline
        ...
        \begin{solutionorgrid}[\stretch{1}]
            \begin{center}
                \includegraphics[width = 0.5\textwidth]{Grundlagen_Info/Exam_Questions/Figures/lsg3-2024-3.jpg}
            \end{center}
            \centering
            \begin{tabular}{|c|c|c|}
            \hline
        ...
        \begin{solutionorgrid}[\stretch{1}]
            \begin{center}
                \includegraphics[width = 0.5\textwidth]{Grundlagen_Info/Exam_Questions/Figures/lsg4b-2024-5.jpg}
            \end{center}
        ...
        \clearpage
        \section{Datenintegrität}
        \question
        
        Gegeben ist die Kodierung unten für die vier Informationen \enquote{Ja}, \enquote{Nein}, \enquote{Vielleicht}, \enquote{Keine Antwort}. (Die Leerzeichen in der Kodierung dienen nur der besseren Übersicht)

        \begin{table}[h!]
            \centering
            \begin{tabular}{c|c}
               Information &   Kodierung  \\ \midrule\midrule
               Ja &  1111 1111\\ \midrule
               Nein &  0000 0000\\  \midrule
               Vielleicht & 1111 1000  \\  \midrule
               Keine Antwort & 1010 1010  \\ 
            \end{tabular}
        \end{table}
        \begin{parts}
        ...
        \begin{solutionorgrid}[\stretch{1}]
            Mehrere Lösungen mit fünf gültigen Wörter möglich. z.B.
                ...
                \begin{center}
                    \includegraphics[width = 0.5\textwidth]{Grundlagen_Info/Exam_Questions/Figures/hyperWuerfelEx24.png}
                \end{center}
