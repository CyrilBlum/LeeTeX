...
\begin{frame}{Maschinelles Lernen}
    \begin{figure}[H]
        \only<1->{\centering\includegraphics[width=0.26\pagewidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/intro_spam.jpg"}}
        \only<2->{\centering\includegraphics[width=0.26\pagewidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/intro_YT.jpg"}}
        \only<3->{\centering\includegraphics[width=0.26\pagewidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/intro_scan.jpg"}}
        % \only<4->{\centering\includegraphics[width=0.3\pagewidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/intro_recommendation.jpg"}}
    \end{figure}
\end{frame}
...
\begin{frame}{Korrelations-Beispiele}
    \begin{figure}[H]
        \centering
        \only<1>{\includegraphics[width=.75\pagewidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/socialmedia_vs_zufriedenheit.pdf"}}
        \only<2>{\includegraphics[width=.75\pagewidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/haarlange_vs_notenschnitt.pdf"}}
        \only<3>{\includegraphics[width=.75\pagewidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/buecher_vs_schuhgroesse.pdf"}}
    \end{figure}
...
\begin{frame}{Korrelations-Beispiel: Abweichung vom Mittelwert}
    \begin{adjustwidth}{-.5cm}{-.5cm}
        \begin{onlyenv}<1>
            \begin{figure}[H]
                \centering
                \includegraphics[width=.9\textwidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/polizei_vs_kriminalitaet_correl"}
            \end{figure}
        \end{onlyenv}
        \begin{onlyenv}<2>
            \begin{figure}[H]
                \centering
                \includegraphics[width=.9\textwidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/polizei_vs_kriminalitaet_correl_mean"}
            \end{figure}
        \end{onlyenv}
        \begin{onlyenv}<3->
            \begin{figure}[H]
                \centering
                \includegraphics[width=.9\textwidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/polizei_vs_kriminalitaet_correl_norm"}
            \end{figure}
        \end{onlyenv}
...
\begin{frame}{Berufserfahrung und Einladungswahrscheinlichkeit}
    \begin{columns}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=\linewidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/berufserfahrung_vs_einladung"}
        \end{figure}
        \column{0.3\textwidth}
...
\begin{frame}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/sales-shaved-heads"}
    \end{figure}
\end{frame}