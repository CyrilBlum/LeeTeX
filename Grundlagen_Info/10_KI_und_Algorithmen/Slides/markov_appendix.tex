...
\begin{frame}{App-Nutzung: Stationäre Verteilung}
    ...
    \begin{enumerate}[<+->]
        \item Aus $\pi_1 = 0.7\pi_1 + 0.3\pi_2$ folgt $0.3\pi_1 = 0.3\pi_2$ $\rightarrow$ $\pi_1 = \pi_2$
...
\begin{frame}{Anwendungen von Markov-Ketten}
    \begin{columns}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\pagewidth]{"Grundlagen_Info/10_KI_und_Algorithmen/Figures/intro_chatGPT"}
        \end{figure}
        \begin{itemize}[<+->]
