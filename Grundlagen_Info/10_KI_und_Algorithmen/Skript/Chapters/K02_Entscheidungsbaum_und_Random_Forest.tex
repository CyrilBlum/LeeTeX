\chapter{Klassifikation I: Entscheidungsbaum und Random Forest}
\label{chap:entscheidungsbaum-randomforest-alt}

\begin{myremark}[Algorithmusart in diesem Kapitel]
Funktionsart: \textbf{Klassifikation}. \\
Umsetzungsart: \textbf{selbstlernend} (teilweise auch regelbasiert interpretierbar).
\end{myremark}
