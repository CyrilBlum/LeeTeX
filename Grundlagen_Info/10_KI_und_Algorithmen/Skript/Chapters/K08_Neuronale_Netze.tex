...
Sie setzt  \cref{chap:einfuehrung} und  \cref{chap:datenvorbereitung} voraus. Mathematische Details (Backpropagation) werden
...
\begin{itemize}
    ...
    \item Vergleichen Sie die Testgenauigkeit mit dem Random Forest aus  \cref{chap:randomforest}.
...
\href{\notebookurl}{\texttt{10\_KI\_und\_Algorithmen/06\_Neuronale\_Netze.ipynb}}
\end{myremark}
