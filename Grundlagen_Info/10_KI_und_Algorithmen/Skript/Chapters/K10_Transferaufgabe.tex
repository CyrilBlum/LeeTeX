...
Sie setzt  \cref{chap:einfuehrung} bis  \cref{chap:randomforest} (und idealerweise  \cref{chap:modellvergleich}) voraus.
...
\begin{myremark}[Hilfreiche Ressourcen für eigene Datensätze]
    Eigene Datensätze können auf folgenden Plattformen gefunden werden:
\begin{itemize}
