...
\begin{myexercise}[Verkehrsmittel]
    Eine Schülerin fährt jeden Morgen entweder mit dem Fahrrad oder mit dem Bus zur Schule. Die Übergangswahrscheinlichkeiten sind:
    \begin{itemize}
        ...
        \item Nach einer Busfahrt nimmt sie am nächsten Tag mit Wahrscheinlichkeit $0.5$ wieder den Bus und mit $0.5$ das Fahrrad.
    \end{itemize}
    Wie sieht die Übergangsmatrix aus? Wie gross ist die Wahrscheinlichkeit, dass die Schülerin nach zwei Tagen mit dem Fahrrad fährt, wenn sie heute mit dem Bus fährt?
    \begin{myanswer}
        ...
        \[
            ...
            \end{pmatrix}
        \]
        Die Wahrscheinlichkeit, dass die Schülerin nach zwei Tagen mit dem Fahrrad fährt, wenn sie heute mit dem Bus fährt, beträgt also $0.7$.
    \end{myanswer}
\end{myexercise}
...
\begin{enumerate}
    ...
    \item Wechseln Sie gemäss der Übergangswahrscheinlichkeiten in den nächsten Zustand (siehe Beispiel untenan).
