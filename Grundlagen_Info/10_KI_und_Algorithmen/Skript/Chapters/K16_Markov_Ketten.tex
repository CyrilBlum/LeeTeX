...
\section{Zufallssimulation einer Markov-Kette in Python}
...
\begin{myexercise}
    Simulieren Sie das Wettermodell 1000 Schritte lang und bestimmen Sie den Anteil der sonnigen Tage. Sie können dazu das Python-Notebook verwenden: \href{\notebookurl}{\texttt{10\_KI\_und\_Algorithmen/01\_Markov\_Ketten.ipynb}}.
\end{myexercise}
