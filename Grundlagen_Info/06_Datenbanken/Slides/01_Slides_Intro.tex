...
\title[Datenbanken] {Datenbanken und SQL}
...
\begin{frame}[fragile]{Was sind \textit{Daten}?}
    \begin{itemize}[<+->]
      \item \textbf{\enquote{Daten}} = Plural von \textit{Datum}
...
\begin{frame}{Wo(zu) braucht es Datenbanken?}
  \begin{columns}
    ...
    \begin{column}{0.6\textwidth}
      \begin{figure}[H]
        \centering
        \includegraphics[height=4cm]{Grundlagen_Info/06_Datenbanken/Figures/db-ex1}
        \includegraphics[height=4cm]{Grundlagen_Info/06_Datenbanken/Figures/db-ex4}
        \includegraphics[width=.85\columnwidth]{Grundlagen_Info/06_Datenbanken/Figures/db-ex2}
        \includegraphics[width=.85\columnwidth]{Grundlagen_Info/06_Datenbanken/Figures/db-ex3}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[fragile]{SQL-Befehle}{\lstinline|SELECT [spalten] FROM [tabellenname]|}
  \ciascheme{.7}
  \begin{lstlisting}
SELECT *
FROM cia;
...
\begin{frame}[fragile]{SQL-Befehle}{\lstinline|SELECT [spalten] FROM [tabellenname] WHERE [conditions]|}
  \ciascheme{.7}
  \begin{lstlisting}
SELECT Name, Region
FROM cia
...
%\end{lstlisting}
%  ... weitere SQL-Befehle in Cheat-Sheet und Skript
%\end{frame}

\begin{frame}[fragile]{Lehrmittel: Cheat Sheet}
	\begin{figure}[H]
		\centering
		\includegraphics[width=.8\textwidth]{Grundlagen_Info/06_Datenbanken/Figures/Cheatsheet}
	\end{figure}

	\begin{itemize}[<+->]
	\item Viel Eigenständigkeit erwartet
	\item Automatische Lösungsvorschläge auf Moodle
	\item Projekt (in wenigen Wochen): \textit{Murder Mystery}
...
\begin{frame}[fragile]{Lehrmittel: Skript}
	...
	\centering
		\begin{column}{.4\linewidth}
			\begin{figure}[H]
				\centering
				\includegraphics[width=\columnwidth]{Grundlagen_Info/06_Datenbanken/Figures/titlepage}
			\end{figure}
		\end{column}
	...
	\begin{itemize}
		\item Arbeit hauptsächlich mit Cheat-Sheets
		\item Feedback ist willkommen!
	\end{itemize}
\end{frame}

\begin{frame}{Auftrag: Eigene Tabellen erstellen \& Abfragen schreiben}{Aufgaben auf Moodle und \textbf{Cheatsheet}}
  \begin{itemize}
    \item \aufgabebox{1.1: Daten erstellen, verändern und löschen}
    \item \aufgabebox{1.2: Daten abfragen}
    \item \aufgabebox{1.3: Lernkontrolle}
    \item \challengebox{Aufgaben 1.1 - 1.20 im Skript (InstaHub)}
  \end{itemize}
\end{frame}