...
\subtitle{\emoji{woman-technologist} Datenbanken und SQL}
...
\begin{frame}[fragile]{Lehrmittel: Cheat Sheet}
	...
	\item Nächstes Mal: \textit{Murder Mystery}
...
\begin{frame}{Auftrag: Eigene Tabellen erstellen \& Abfragen schreiben}
  \textbf{Aufgaben} und \textbf{Cheatsheet} auf Moodle
\end{frame}