...
\tiny\textbf{Ich} (``das Selbst, dessen man sich bewusst ist und mit dem man sich von der Umwelt unterscheidet'') \textbf{ging} (gehen, ``schrittweises Sichfortbewegen auf den Füssen in aufrechter Haltung'') \textbf{nach} (``drückt aus, dass jemand jemandem, einer Sache folgt, nachgeht'') \textbf{draussen} (``ausserhalb eines Raumes, Gebäudes'')...
