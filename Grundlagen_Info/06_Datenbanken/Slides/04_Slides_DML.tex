...
\begin{itemize}
	\item Skript / InstaHub
	\begin{itemize}
		\item \readbox{Beispiel 1.21}
		\item \aufgabebox{Aufgaben 1.45-1.48}
		\item \abgabebox{Aufgabe 1.49}
		\item \aufgabebox{Aufgabe 1.50}
		\item \abgabebox{Aufgabe 1.51}
		\item \aufgabebox{Aufgabe 1.52}
		\item \challengebox{Eigene Tabelle(n) erstellen (auf InstaHub)}	
	\end{itemize}
	\item SQL-Tutorial: Lektion 6
\end{itemize}
\end{frame}
