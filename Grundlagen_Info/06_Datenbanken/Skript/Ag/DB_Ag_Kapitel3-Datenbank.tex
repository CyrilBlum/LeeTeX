...
\begin{myexercise}
  Bearbeiten Sie auf Moodle die \enquote{Übung 1: Einfache SQL Abfragen} und geben Sie am Schluss ab.
\end{myexercise}
...
... & ... & ... 
\end{tabular}
\caption{Beispiel-Tabelle: \enquote{users}}
...
Aus eben diesen Gründen hat jede Person in der Schweiz übrigens eine \href{https://www.bsv.admin.ch/bsv/de/home/sozialversicherungen/ahv/grundlagen-gesetze/ahv-nummer.html}{AHV-Nummer} : \begin{quote}
  \enquote{Die 13-stellige AHV-Nummer ist völlig anonym, zufallsgeneriert und nicht sprechend. Sie wird nur einmal vergeben und bleibt ein Leben lang unverändert, auch wenn der Zivilstand - etwa durch Heirat - ändert.}
\end{quote}
...
... & ...
\end{tabular}
\caption{Tabelle \enquote{\textbf{users}}}
\label{table:users-2}
\end{table}
\end{minipage}
...
\end{tikzpicture}
\caption{Tabelle \enquote{\textbf{photos}}}
\label{table:photos-2}
\end{table}
\end{minipage}

Die Tabelle \enquote{photos} hat nicht nur einen Primärschlüssel \texttt{id}, sondern auch einen Fremdschlüssel \texttt{user\_id} (unterbrochen unterstrichen und hervorgehoben mit dem Symbol \faKey), der auf den Primärschlüssel der Tabelle \enquote{users} verweist. 
...
\begin{table}[H]
  ...
  12  & 42   \\ 
  \end{tabular}
  \caption{Beispiel-Tabelle: \enquote{likes}}
  \label{table:likes}
  \end{table}
...
\begin{myexercise}
  Bearbeiten Sie auf Moodle die \enquote{Übung 2: Tabellen Erstellen und Verknüpfen} und geben Sie am Schluss ab.
\end{myexercise}
...
\begin{myexample}
  ...
  \begin{myexercise}
    Bearbeiten Sie auf Moodle die \enquote{Übung 3: SQL-Abfragen über mehrere Tabellen} und geben Sie am Schluss ab.
  \end{myexercise}
