...
\begin{myexercise}[users als Tabelle formatieren]
  \label{myexercise:tabellenformatExcel}
  % \begin{table}[H]
  %     \centering
  %     \begin{tabular}{r|l}
  ...
  %   \end{table}
    ...
    \begin{figure}[H]
      \centering
      % \includegraphics[width=0.8\textwidth]{Grundlagen_Info/06_Datenbanken/Figures/usersAlsTabelleFormatiert.png}
    \end{figure}
