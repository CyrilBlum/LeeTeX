\begin{frame}
    ...
    % \textbf{Lektion 4}/
    \emoji{face-with-monocle} \emoji{deciduous-tree}: \textbf{Graphen und Bäume (Lektion 2)}
\end{frame}
...
\begin{frame}{Wiederholung letztes Mal: Knoten und Kanten}
    Knoten und Kanten \\[.5cm]
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[keepaspectratio, width=.7\linewidth]{Grundlagen_Info/02_Graphen/Figures/4-graph.png}
        \end{figure}
        \end{minipage}
...
\begin{frame}{Wiederholung letztes Mal: Vollständige Graphen}
    ...
    \begin{itemize}
        ...
        \item Hamilton'sche und Euler'sche Wege
        \item Färben eines Graphen
    \end{itemize}
            \begin{figure}[H]
            \centering
            \includegraphics[keepaspectratio, width=.3\linewidth]{Grundlagen_Info/02_Graphen/Figures/4-graph.png}
        \end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[keepaspectratio, width=.5\paperwidth]{Grundlagen_Info/02_Graphen/Figures/graphen-bin.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[keepaspectratio, width=.4\paperwidth]{Grundlagen_Info/02_Graphen/Figures/graphen-gerichtet.png}
\end{figure}
\textbf{Nachbarschaftsmatrix} (= Tabelle) des Graphen:
