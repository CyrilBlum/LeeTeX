...
\begin{myexercise}[Placemat: Gefälligkeit]
    ...
    \foreach \pageNumber in {1,...,6} {
            \begin{figure}[H]
                \centering
                \includegraphics[page=\pageNumber,width=0.9\textwidth]{Grundlagen_Info/14_KI_und_Prompting/Articles/2026-04-12 NZZ-Magazin KI Prompt Thinking.pdf}
            \end{figure}
        }
...
\begin{myexercise}[– Placemat: Biases]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{Grundlagen_Info/14_KI_und_Prompting/Articles/2024-05-23 NZZ KI Sicherheit.pdf}
    \end{figure}
...
\begin{myexercise}[– Placemat: Datenschutz]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{Grundlagen_Info/14_KI_und_Prompting/Articles/2025-12-03 NZZ KI Datenschutz.pdf}
    \end{figure}
...
\begin{myexercise}[– Placemat: AI Slop]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{Grundlagen_Info/14_KI_und_Prompting/Articles/2024-08-03 NZZ KI vermüllt das Internet.pdf}
    \end{figure}
...
\begin{myexercise}[– Placemat: Stromverbrauch]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{Grundlagen_Info/14_KI_und_Prompting/Articles/2025-12-09 NZZ KI Strom.pdf}
    \end{figure}
\end{myexercise}
...
\begin{myexercise}[– Placemat: Kognitiver Wandel]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{Grundlagen_Info/14_KI_und_Prompting/Articles/2025-07-05 NZZ Hirn aus, KI an.pdf}
    \end{figure}
