...
\begin{center}
    \textit{«Wie verändert KI den Arbeitsmarkt in meinem Interessensbereich?»}
\end{center}
...
\begin{center}
    % TODO: PDF-Dateien einfügen – bitte die entsprechenden NZZ-Artikel einfügen
    \includepdf[pages=-,scale=0.9]{Grundlagen_Info/14_KI_und_Prompting/Skript/Figures/NZZ_Arbeitsmarkt_1.pdf}
\end{center}

\begin{center}
    % TODO: zweiten Artikel einfügen
    \includepdf[pages=-,scale=0.9]{Grundlagen_Info/14_KI_und_Prompting/Skript/Figures/NZZ_Arbeitsmarkt_2.pdf}
\end{center}
