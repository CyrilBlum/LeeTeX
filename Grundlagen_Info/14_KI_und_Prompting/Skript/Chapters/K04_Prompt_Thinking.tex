...
\section{Prinzipien guter Prompts}

\subsection{Spezifisch und präzise sein}
...
\subsection{Beispiele geben (Few-Shot Prompting)}
...
\subsection{Eine Rolle zuweisen (Persona)}
...
\subsection{Schritt für Schritt denken lassen (Chain-of-Thought)}
...
\subsection{Kontext und Einschränkungen angeben}
...
\subsection{Das Modell um Selbstkritik bitten}
...
\section{RICE --- Ein Framework für die Bewertung von Prompts}
\begin{mydefinition}
Das \textbf{RICE}-Framework kann verwendet werden, um einen Prompt zu gestalten. Es steht für:
\begin{itemize}
    \item \textbf{Role}: Welche Rolle soll das Modell einnehmen? (z.\,B. Lehrer, Experte, Freund)
    \item \textbf{Instruction}: Welche Anweisungen soll das Modell befolgen? (z.\,B. Erkläre Schritt für Schritt, Verwende einfache Sprache)
    \item \textbf{Context}: Welchen Kontext soll das Modell berücksichtigen? (z.\,B. Vorwissen, Zielgruppe, Format)
    \item \textbf{Examples}: Welche Beispiele können helfen, die Antwort zu verbessern? (z.\,B. Beispielantworten, Vorlagen)
\end{itemize}
\end{mydefinition}