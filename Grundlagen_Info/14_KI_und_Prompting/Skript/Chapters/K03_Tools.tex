...
\begin{tabular}{p{2.5cm}p{2.5cm}p{3.5cm}p{3.5cm}}
    ...
    \midrule
    Whisper          & OpenAI              & Transkription (Sprache $\rightarrow$ Text), Open Source    & Nur Transkription, kein Sprachgenerator    \\
    \bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    \item Können Sie den Deepfake von der echten Aufnahme unterscheiden?q
