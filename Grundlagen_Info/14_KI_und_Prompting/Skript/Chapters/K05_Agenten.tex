...
\begin{mychallenge}[GitHub Copilot erleben]
...
\subsection*{Arena: OpenClaw / KI-Agenten als Arbeitsersatz}

\begin{myexercise}[Artikel-Arena: Agenten und Jobs]
      Lesen Sie den folgenden NZZ-Artikel über OpenClaw und KI-Agenten als
      Arbeitsersatz.

      \textbf{These 1}: \textit{KI-Agenten sollten repetitive Büroarbeit vollständig
      ...
      \textbf{These 2}: \textit{KI-Trainingsdaten werden oft von schlecht bezahlten
      ...
      \begin{figure}[H]
            \centering
            \includegraphics[width=\textwidth]{Grundlagen_Info/14_KI_und_Prompting/Articles/2026-02-15 NZZaS KI mein Boss.pdf}
      \end{figure}
\end{myexercise}
