...
Der Korrelationskoeffizient wird typischerweise als Zahl $r$ angegeben, welche sich zwischen -1 (perfekte negative Korrelation) und 1 (perfekte positive Korrelation) bewegt. Ein Wert von 0 bedeutet, dass es keinen linearen Zusammenhang zwischen den beiden Variablen gibt (s. \cref{fig:korr-r-bsp}). Dies schliesst jedoch nicht aus, dass es einen anderen, nicht-linearen Zusammenhang gibt.
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{"Grundlagen_Info/10_Aus_Daten_Lernen/Figures/polizei_vs_kriminalitaet_correl"}
		\caption{Ursprüngliche Daten}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{"Grundlagen_Info/10_Aus_Daten_Lernen/Figures/polizei_vs_kriminalitaet_correl_norm"}
	...
	\begin{figure}[H]
		...
		\foreach \i in {7,12,3,18,5,10,1,15,8,14,2,17,6,11,4,16,9,13} {
				\begin{subfigure}[t]{0.22\textwidth}
					\centering
					\includegraphics[width=\linewidth]{"Grundlagen_Info/10_Aus_Daten_Lernen/Figures/correl_ex_\i.pdf"}
					\caption{$r = \_\_\_$}
				\end{subfigure}
			}
	\end{figure}
