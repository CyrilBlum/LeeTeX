...
\noindent
\textbf{Gruppe:} \hrulefill \quad \textbf{Datum:} \hrulefill \quad \textbf{Kapitel:} \hrulefill

\vspace{0.3cm}

\setlength{\tabcolsep}{6pt}
\begin{longtable}{@{}p{4.5cm}p{7.5cm}cc@{}}
	\toprule
	\textbf{Kriterium} & \textbf{Beschreibung} & \textbf{Max.} & \textbf{Pkt.} \\
	\midrule\midrule
	
	\textbf{Buchinhalt: Verständnis} & Kapitel aus Hannah Frys Buch \textbf{verstanden}, \textbf{korrekt wiedergegeben}, \textbf{Kernaussagen} klar & 3 & \\
	\cmidrule(l){2-4}
	& \multicolumn{3}{p{8.5cm}}{\textit{Kommentar:} \vspace{0.8cm}} \\
	\midrule
	
	\textbf{Recherche: Qualität} & \textbf{Eigenständige}, \textbf{aktuelle}, \textbf{relevante} Recherche; über Buch hinausgehend, Bezug zu Kapitel klar & 3 & \\
	\cmidrule(l){2-4}
	& \multicolumn{3}{p{8.5cm}}{\textit{Kommentar:} \vspace{0.8cm}} \\
	\midrule
	
	\textbf{Aufbau \& Struktur} & \textbf{Klare Gliederung}, \textbf{logischer Aufbau}, roter Faden erkennbar & 2 & \\
	\cmidrule(l){2-4}
	& \multicolumn{3}{p{8.5cm}}{\textit{Kommentar:} \vspace{0.8cm}} \\
	\midrule
	
	\textbf{Didaktik} & \textbf{Verständlich} erklärt, \textbf{anschauliche Beispiele}, Komplexität reduziert & 3 & \\
	\cmidrule(l){2-4}
	& \multicolumn{3}{p{8.5cm}}{\textit{Kommentar:} \vspace{0.8cm}} \\
	\midrule
	
	\textbf{Fachsprache} & Fachbegriffe \textbf{korrekt verwendet} und \textbf{erklärt} & 2 & \\
	\cmidrule(l){2-4}
	& \multicolumn{3}{p{8.5cm}}{\textit{Kommentar:} \vspace{0.8cm}} \\
	\midrule
	
	\textbf{Medien \& Visualisierung} & \textbf{Eigenständig erstellt}, \textbf{übersichtlich}, \textbf{unterstützt Inhalt}; Abzug: kopiert (-3) & 3 & \\
	\cmidrule(l){2-4}
	& \multicolumn{3}{p{8.5cm}}{\textit{Kommentar:} \vspace{0.8cm}} \\
	\midrule
	
	% \textbf{Interaktion \& Diskussion} & Klasse \textbf{einbezogen}, \textbf{gute Fragen}, Diskussion \textbf{moderiert} & 2 & \\
	% \cmidrule(l){2-4}
	& \multicolumn{3}{p{8.5cm}}{\textit{Kommentar:} \vspace{0.8cm}} \\
	\midrule
	
	\textbf{Auftreten \& Vortrag} & \textbf{Frei} gesprochen, \textbf{sicher}, \textbf{engagiert}, angemessenes Tempo & 2 & \\
	\cmidrule(l){2-4}
	& \multicolumn{3}{p{8.5cm}}{\textit{Kommentar:} \vspace{0.8cm}} \\
	\midrule
	
	\textbf{Zeitmanagement} & \textbf{20–30 Minuten}, \textbf{gleichmässige Redeverteilung}; Abzug: zu kurz/lang (-2) & 0 & \\
	\cmidrule(l){2-4}
	& \multicolumn{3}{p{8.5cm}}{\textit{Kommentar:} \vspace{0.8cm}} \\
	\midrule\midrule
	
	\multicolumn{3}{r}{\textbf{Gesamtpunktzahl (max. 20):}} & \textbf{\hrulefill} \\
	\bottomrule
\end{longtable}
...
\begin{longtable}{@{}lp{14cm}@{}}
	...
	\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt]
		\item[\faFilePdf{}] \textit{Luc liest nicht, er lernt lieber mit KI} (6. Mai 2024) \newline
		$\rightarrow$ ChatGPT im Bildungswesen, Algorithmen, Manipulation durch KI
		\item[\faFilePdf{}] \textit{Der Prompt schult das kreative Schreiben} (26. Januar 2026) \newline
		$\rightarrow$ KI-Algorithmen, Prompt-Engineering, Macht der Sprache
		\item[\faFilePdf{}] \textit{Die entscheidende Frage für 2026 lautet: Welche KI wollen wir?} (12. Januar 2026) \newline
		$\rightarrow$ Ethische Folgen von Algorithmen, Regulierung, Machtkonzentration
