...
\lstinputlisting[language=Python,caption=\texttt{protokoll.py},label=listing:protokoll]{Grundlagen_Info/01_Kodierungen/Randomisierte_Algorithmen/Skript/Code/protokoll.py}
