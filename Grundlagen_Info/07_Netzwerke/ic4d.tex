\lstset{style=Python}
\title{Problemformulierung: Netzwerke (Chat-Kommunikation über Relay-Server)}
...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.22\linewidth}|p{0.22\linewidth}|p{0.22\linewidth}|p{0.22\linewidth}}
        \textbf{Learning Task (Komplexe Lernaufgabe)} & \textbf{Unterstützende Informationen} & \textbf{Just-in-time Informationen} & \textbf{Part-task Practice (Teilübungen)} \\
        \midrule
        ...
        \begin{itemize}
            \item Visualisierung der Client-Server-Architektur (z. B. Whiteboard-Skizze)
