...
\newcommand{\thesubject}{\textbf{Problemformulierung: Netzwerke} \\Chat-Kommunikation über einen Relay-Server}
...
\chapter{Problemformulierung und Lernaufgaben}
\section{Problemformulierung, Kontext und Relevanz}
...
\subsection{Learning Task 1: Lokale Verbindung via \textit{localhost}}
...
\begin{myexercise}[title=Chatten auf demselben Rechner]
...
\subsection{Learning Task 2: Chat-Kommunikation über ein lokales Netzwerk}
...
\begin{myexercise}[title=Chatten im lokalen Netzwerk]
...
\subsection{Learning Task 3: Chat-Kommunikation über das Internet, mittels Relay-Server}
...
\begin{myexercise}[title=Chatten über einen öffentlichen Relay-Server]
