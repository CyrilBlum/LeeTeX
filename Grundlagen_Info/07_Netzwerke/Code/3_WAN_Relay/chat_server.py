...
rate_limit = 10.0  # Max messages per client per rate_interval
rate_interval = 10.0  # Time interval in seconds for rate limiting
...
def accept_clients():
    while True:
        ...
        print(f"Accepted new client: {client_address}")
        threading.Thread(
