...
\begin{frame}
    Auftrag
    \begin{itemize}
        \item \aufgabebox{1.12}: Eigene IPv4-Adresse herausfinden
        \item \challengebox{1.13}: \commandbox*|ping| im echten Netzwerk testen
        \item \aufgabebox{1.16 - 1.18}: Notation \gls{IP}v4 und \gls{IP}v6
...
\begin{frame}[fragile]{\faHandshake{} TCP: 3-way handshake}{Auftrag}
    \begin{itemize}
        \item Skript: \aufgabebox{1.30-1.33 (TCP, Servers / Clients)}
        \item \challengebox{1.34 (Email-Server)}
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Web- und \gls{DNS}-server}{Aufträge (Skript)}
    \textbf{Webserver}
    \begin{itemize}
        \item \aufgabebox{Filius (Web-Server): 1.35}
        \item \challengebox{Filius (``Echter'' Web-Server): 1.36}
        \item \challengebox{1.37 (HTML)}
    \end{itemize}
    \textbf{DNS}
    \begin{itemize}
        \item \aufgabebox{Aufgaben 1.38-1.40}
    \end{itemize}

    Weitere Aufgaben
    \begin{itemize}
        \item \aufgabebox{1.41-1.42}
        \item \challengebox{1.43-1.44}
    \end{itemize}
\end{frame}