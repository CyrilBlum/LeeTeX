...
\begin{frame}
    Auftrag
    \begin{itemize}
        \item \aufgabebox{1.11}: Eigene IPv4-Adresse herausfinden
        \item \challengebox{1.12}: \commandbox*|ping| im echten Netzwerk testen
        \item \aufgabebox{1.15 - 1.17}: Notation \gls{IP}v4 und \gls{IP}v6
        \item \challengebox{1.13, 1.14}: Python, \acrshort{ARP}-Scan
...
\begin{frame}[fragile]{\faHandshake{} TCP: 3-way handshake}{Auftrag}
    \begin{itemize}
        \item Skript: \aufgabebox{1.28-1.31}
    \end{itemize}
\end{frame}
