...
\begin{frame}[fragile]{\faMapMarker{} IP-Adresse}{Vermittlungsschicht}
    ...
    \begin{itemize}[<+->]
        ...
        \item Lokale vs. globale IP-Adresse
              \begin{itemize}
                  \item \textbf{Lokale IP}: nur im lokalen Netzwerk gültig (z.B. 192.168.x.x, 10.x.x.x)
                  \item \textbf{Globale IP}: weltweit eindeutig (z.B. 8.8.8.8)
              \end{itemize}
    \end{itemize}
\end{frame}
