...
\begin{frame}{Netzwerk-Spiel (ca. 5')}
    ...
    \begin{itemize}[<+->]
        \item Zuerst: Notieren Sie sich eine einzigartige IP-Adresse für Ihren Computer, startend mit \texttt{192.168.0.xyz} (z.B. \texttt{192.168.0.3}), wobei  $\texttt{xyz} \in [0,255]$
