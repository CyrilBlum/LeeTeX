...
\begin{myexercise}[Wireshark-Netzwerkanalyse]
    ...
    \begin{itemize}
        \item DNS korrekt (2)
        \item TCP Verbindungsaufbau + Zuverlässigkeit (2)
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{Grundlagen_Info/07_Netzwerke/Figures/screenshotWireshark.png}
    ...
    \begin{myanswer}
        ...
        \begin{itemize}
            \item \textbf{DNS:} Löst den Domainnamen in eine IP-Adresse auf; erster Schritt beim Laden einer Webseite.
            \item \textbf{TCP:} Baut eine zuverlässige Verbindung auf (SYN, SYN/ACK, ACK) und transportiert die Daten.
            \item \textbf{TLS:} Verschlüsselt die Kommunikation zwischen Browser und Server; Handshake legt Schlüssel fest.
            \item \textbf{HTTPS/HTTP:} Überträgt die eigentlichen Webinhalte (Request/Response); bei HTTPS vollständig verschlüsselt.
        \end{itemize}
    \end{myanswer}
\end{myexercise}
