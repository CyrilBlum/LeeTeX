...
\begin{mainBox}[title=Methodische Anleitung zur Durchführung der Prüfungsaufgaben]
    ...
    \begin{itemize}[topsep=2pt, itemsep=2pt]
        ...
        \item \textbf{Schritt 2:} Analogie aus dem Alltag finden (Hausadresse ↔ IP, Apartment-Nummer ↔ Port)
    ...
    \noindent \textit{Meine Analogie:} \underline{\hspace{9cm}}
    ...
    \noindent \textit{Häufigster Fehler und Lösung:} \underline{\hspace{7cm}}
    ...
    \noindent \textit{Mein wichtigster Fachbegriff:} \underline{\hspace{8cm}}
    ...
    \begin{itemize}[topsep=2pt, itemsep=2pt]
        ...
        \item \textbf{Schritt 3:} Code strukturiert schreiben $\rightarrow$ Funktionen: connect, listen, forward, handle\_error
        \item \textbf{Schritt 4:} Testen mit 2–3 Clients $\rightarrow$ Error Handling implementiert? Sockets geschlossen?
    \end{itemize}

    \noindent \textit{Meine Architektur-Skizze:} \\
    \vspace{5cm}
    ...
    \noindent \textit{Unsere Rollenverteilung:} 
    ...
    \begin{itemize}[topsep=2pt, itemsep=2pt]
        \item \textbf{Schritt 1:} Protokoll-Chronologie verstehen $\rightarrow$ Welcher Schritt passiert zuerst? (DNS $\rightarrow$ TCP $\rightarrow$ HTTP)
        \item \textbf{Schritt 2:} Daten-Datenschutz-Risiken benennen $\rightarrow$ Meta-Daten, Zugriff, Monopol-Stellung
        \item \textbf{Schritt 3:} Alternativen recherchieren $\rightarrow$ P2P, Föderierung, E2E-Verschlüsselung (z.B. Signal)
        \item \textbf{Schritt 4:} Konkrete Massnahmen formulieren $\rightarrow$ Datenminimierung, Logging-Strategie
    \end{itemize}

    \noindent \textit{Mein wichtigster Datenschutz-Gedanke:} \underline{\hspace{7cm}}
