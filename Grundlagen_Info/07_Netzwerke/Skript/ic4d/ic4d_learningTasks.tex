...
Ihre private IP-Adresse sollte in etwa so aussehen: \texttt{192.168.x.x} oder \texttt{10.x.x.x}.

Meine private IP-Adresse ist: \ipPlaceHolder

Notieren Sie sich auch noch ihre öffentliche IP-Adresse, welche Sie im Internet verwenden. Diese finden Sie z.B. auf der Webseite \url{https://www.whatismyip.com/}.
...
\begin{myexercise}[Chatten im lokalen Netzwerk]
    ...
    \textbf{Schritte:}
    \begin{enumerate}
        \item Ermitteln Sie die lokale IP-Adresse ihres Rechners und desjenigen ihrer Pultnachbarin (s. \cref{ex:meine-ip}). Bestimmen Sie, wer von Ihnen die Rolle des Servers und wer die Rolle des Clients übernimmt.
