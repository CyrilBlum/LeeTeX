...
\begin{myexercise}[Chatten im lokalen Netzwerk]
    ...
    \begin{myanswer}
        \lstinputlisting[caption={\texttt{chat\_localnet\_server.py}}]{Grundlagen_Info/07_Netzwerke/Code/chat_localnet_server.py}
        \lstinputlisting[caption={\texttt{chat\_localnet\_client.py}}]{Grundlagen_Info/07_Netzwerke/Code/chat_localnet_client.py}
    \end{myanswer}
\end{myexercise}
