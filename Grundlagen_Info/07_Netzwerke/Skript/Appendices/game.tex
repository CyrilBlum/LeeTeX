...
\begin{enumerate}
	...
	\item Jede Person schreibt eine kurze Nachricht (z.B. ``Hallo, wie geht's?'') und adressiert sie an eine andere Person, indem sie deren \gls{IP}-Adresse verwendet. Die maximale Nachrichtenlänge beträgt 10 Zeichen.
