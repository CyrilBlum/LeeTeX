...
\begin{myexercise}[Filius-Anwendung: Router \& Gateway]
	Schauen Sie sich das Filius-Video Nummer 3 an. Laden Sie danach die Datei ``\texttt{Filius-3.fls}'' von Moodle herunter und bearbeiten Sie die darin enthaltene Netzwerkkonfiguration:
	\begin{itemize}
...
\begin{myexercise}[Filius-Anwendung: Router \& Gateway]
	Schauen Sie sich das Filius-Video Nummer 4 an. Leider ist nach der Aufnahme des Videos einiges kaputtgegangen und der Rechner \texttt{192.168.0.12} kann den Rechner \texttt{68.33.1.11} nicht mehr anpingen. Laden Sie die Datei ``\texttt{Filius-4.fls}'' von Moodle herunter und beheben Sie die Netzwerkkonfiguration, so dass die beiden Rechner sich wieder erreichen können.
\end{myexercise}
