...
\begin{figure}[H]
	...
	\begin{tikzpicture}[>=Stealth, node distance=4cm and 8cm]
		...
		\draw[->, thick, red, dashed] (Alice.south) -- node[c] { Ich möchte mit dir sprechen, Bob, auf Port 21. Bist du offen?\\SYN=1, SEQ\# 10} ([yshift=-3cm]Bob.south);
		\draw[->, thick, red, dashed] ([yshift=-3cm]Bob.south) -- node[c] { Ok, lass uns reden Alice! Ich bin offen auf Port 21.\\SYN=1, ACK=1, ACK=11} ([yshift=-6cm]Alice.south);
