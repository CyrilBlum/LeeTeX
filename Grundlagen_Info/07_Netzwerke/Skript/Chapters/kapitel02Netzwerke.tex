...
\begin{myexercise}\label{ex:meine-ip}
	...
	\begin{itemize}
		...
		\item Windows, Programm ``cmd'': \\
		      \commandbox|ipconfig|
	\end{itemize}
	Ihre eigene globale IP können Sie beispielsweise über die Webseite \url{https://www.whatismyip.com/} herausfinden.
\end{myexercise}
