...
\begin{figure}[H]
	...
	\begin{tikzpicture}[>=Stealth, node distance=4cm and 8cm]
		...
		\draw[->, thick, \transportLayerColor, dashed] (Alice.south) -- node[c] { Ich möchte mit dir sprechen, Bob, auf Port 21. Bist du offen?\\SYN=0 (SEQ\# 10)} ([yshift=-3cm]Bob.south);
		\draw[->, thick, \transportLayerColor, dashed] ([yshift=-3cm]Bob.south) -- node[c] { Ok, lass uns reden Alice! Ich bin offen auf Port 21.\\SYN=0, ACK=1 (SEQ\# 10)} ([yshift=-6cm]Alice.south);
		\draw[->, thick, \transportLayerColor, dashed] ([yshift=-6cm]Alice.south) -- node[c] { Ok, danke Bob.\\ACK=1 (SEQ\#11)} ([yshift=-9cm]Bob.south);
...
\begin{myexercise}[Fragen zum Drei-Wege-Handschlag \cite{InfSchuleVerbindungsaufbau}]
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}[>=Stealth, node distance=4cm and 8cm]
			...
			% Draw the arrows and labels
			\draw[->, thick, \transportLayerColor, dashed] (Bob.south) -- node[c] { Treffen wir uns morgen um 20:00 im Kino?\\SYN=0 (SEQ\# 10)} ([yshift=-3cm]Alice.south);
...
\begin{myexercise}[Fragen zum Drei-Wege-Handschlag \cite{InfSchuleVerbindungsaufbau}]
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}[>=Stealth, node distance=4cm and 8cm]
			...
			% Draw the arrows and labels
			\draw[->, thick, \transportLayerColor, dashed] (Bob.south) -- node[c] { Treffen wir uns morgen um 20:00 im Kino?\\SYN=0 (SEQ\# 10)} ([yshift=-3cm]Alice.south);
			\draw[->, thick, \transportLayerColor, dashed] ([yshift=-3cm]Alice.south) -- node[c] {Ja, gerne.\\SYN=0, ACK=1 (SEQ\# 10)} ([yshift=-6cm]Bob.south);
