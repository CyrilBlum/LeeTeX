...
\subsection{Netzzugriff-Schicht}
...
\subsubsection{\texorpdfstring{\gls{ARP}}{ARP}}
...
\begin{myexercise}[Filius-Anwendung: \gls{ARP} beobachten, \gls{ICMP} / \texttt{ping} ausführen]
	Schauen Sie sich das Filius-Einstiegsvideo (Nummer 1) an und führen Sie alle Schritte ebenfalls in Filius aus.
\end{myexercise}
...
\subsection{Vermittlungsschicht / Internetschicht}
...
\begin{itemize}
	\item Physisch miteinander verbunden sind (\gls{WLAN}, Kabel, etc.)
...
\begin{myexercise}[Filius-Anwendung: Router \& Gateway]
	Schauen Sie sich das Filius-Video Nummer 2 an und führen Sie alle Schritte ebenfalls in Filius aus.
\end{myexercise}
...
\begin{figure}[H]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}p{4cm}}
		...
		\rowcolor{orange!20}\multicolumn{2}{c}{\textbf{\gls{TCP} Header}} \\ \midrule\midrule
		Source Port & Destination Port                                    \\ \midrule
		\multicolumn{2}{c}{Sequence \# (SEQ)}                             \\ \midrule
		\multicolumn{2}{c}{Acknowledgement \# (ACK)}                      \\ \midrule
		\multicolumn{2}{c}{Weitere \gls{TCP}-Header-Felder}               \\ \midrule
...
\subsubsection{\texorpdfstring{\gls{DNS}}{DNS}}
