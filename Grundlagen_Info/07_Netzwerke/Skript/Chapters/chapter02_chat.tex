...
\begin{mychallenge}[Relay-Server selber im LAN laufen lassen]
    In der Lösung zur Aufgabe \cref{sec:loesungen-chat} finden Sie einen funktionierenden Code für einen Relay-Server im \gls{LAN}. Im Unterricht wird die Lehrperson diesen laufen lassen, Sie können diesen jedoch auch herunterladen und mit zwei KlassenkameradInnen im eigenen Netzwerk testen.
\end{mychallenge}
...
\clearpage
\section{Lösungen der längeren Code-Aufgaben}\label{sec:loesungen-chat}
