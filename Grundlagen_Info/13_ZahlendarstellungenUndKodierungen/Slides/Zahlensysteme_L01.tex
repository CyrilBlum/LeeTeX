...
\begin{frame}[fragile]{Was sind \textit{Daten}?}
  \textbf{\enquote{Daten}} = Plural von \textit{Datum}
  \begin{itemize}[<+->]
...
\begin{frame}{Historischer Hintergrund}{Ishango-Knochen}
	...
	\begin{column}{0.5\textwidth}
		\begin{figure}[H]
			\centering
			\includegraphics[height=.7\pageheight]{Grundlagen_Info/13_ZahlendarstellungenUndKodierungen/Figures/ishango-bone}
			\end{figure}
		\end{column}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
...
\only<2->{\begin{center}
554 $\rightarrow$ Gibt es Vereinfachungsmöglichkeiten?
\end{center}}
\only<3->{
