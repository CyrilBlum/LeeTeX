...
\title{Freifach ``Applied Data Science'', Schuljahr 2025/2026}
\author{Cyril Wendl}
...
Auf GitHub: \textbf{Settings} → \textbf{SSH and GPG keys} → \textbf{New SSH key}.  
...
Erstellen Sie über das ``+'' oben rechts ein \textbf{New repository}, geben Sie einen Namen (z.\,B. \lstinline|mein-python-projekt|) und wählen Sie ``Public''.
