\begin{document}
\lhead[ \leftmark ]{Informatik, Interessenwoche \enquote{Web-Technologien}}
\rhead[Informatik]{Cyril Blum \& Thomas Graf, \today, Winterthur}

\lstset{language=HTML}
\section*{Auftrag}

Im Rahmen dieses Blockkurses erstellen Sie Ihre eigene Webseite über ein Thema rund um das Web. Dabei lernen Sie insbesondere die Themen HTML, CSS und JavaScript kennen. Wählen Sie sich dazu alleine oder in 2er- bis 3er-Gruppen ein für Sie spannendes Thema zum Thema Internet / Informatik aus (siehe Artikel-Auswahl auf Moodle für eine Themenübersicht).
