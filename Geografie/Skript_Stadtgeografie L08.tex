...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{Private/Images/Superblocks}
...
\subsection{Standorte für Superblocks bestimmen}
...
\begin{figure}[H]
\centering
\includegraphics[width=.25\linewidth, page=1]{"Private/Appendix/Karte Legende"}
...
\begin{figure}[H]
\centering
\includegraphics[width=.95\linewidth, page=1]{"Private/Appendix/Karte Luzern"}
\end{figure}
\begin{myanswer}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{"Private/Appendix/Karte Luzern Sol"}
...
\subsection{Vor- und Nachteile von Superblocks beurteilen}
...
\begin{figure}[H]
\centering
\includegraphics[width=.8\linewidth, page=1]{"Private/Appendix/Karte Sursee"}
\end{figure}
...
\begin{figure}[H]
\centering
\colorbox{white}{\includegraphics[width=.8\linewidth]{"Private/Appendix/2024-07-16 NZZ Superblocks"}}
\end{figure}
\end{mychallenge}
