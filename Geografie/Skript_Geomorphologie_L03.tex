...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{"Private/Images/Geomorphologie/Spalten Entstehung Leer"}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\linewidth]{Private/Images/Geomorphologie/Akkumulation Leer}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\linewidth]{Private/Images/Geomorphologie/Akkumulation}
\caption{Metamorphose von Schnee zu Eis \cite{allgemeineGeologie}}
...
\begin{figure}[H]
\centering
\includegraphics[width=.8\linewidth]{"Private/Images/Geomorphologie/Akkumulation und Ablation"}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{"Private/Images/Geomorphologie/Gleichgewichtslinie leer"}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{"Private/Images/Geomorphologie/Gleichgewichtslinie"}
\caption{Massenbilanz eines Gletschers \cite{gletscherOnline}}
