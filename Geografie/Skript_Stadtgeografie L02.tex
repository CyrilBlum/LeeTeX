...
\begin{figure}[H]
\centering
\includegraphics[width=.6\linewidth]{Private/Images/augustaRaurica}
...
\includegraphics[width=.2\linewidth]{Private/Images/grundrissMittelalter}
\begin{myexercise}
...
\includegraphics[width=.2\linewidth]{Private/Images/grundrissAbsolut}
\notiz{4}

\section{Die industrielle Stadt}
\includegraphics[width=.2\linewidth]{Private/Images/grundrissIndustrie}
\notiz{6}

\section{Die neue Stadt (``\textit{ville nouvelle}'')}
\includegraphics[width=.2\linewidth]{Private/Images/grundrissModern}
\notiz{6}
