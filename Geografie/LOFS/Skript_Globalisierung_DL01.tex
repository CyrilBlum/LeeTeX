...
\begin{enumerate}
\item Schätzen Sie ab, wie sich der Verkaufspreis einer Jeans zusammensetzt und ordnen Sie die prozentuale Verteilung des Preises den einzelnen AkteurInnen (Hersteller, Marke, Einzelhandel, Transport, etc.) auf \cref{fig:jeans-leer} zu.
\item Diskutieren Sie, ob die Verteilung fair ist? Welche AkteurInnen profitieren am meisten?
\end{enumerate}
\begin{figure}[H]
\centering
...
\end{itemize}
\notiz{8}
\textbf{Teil 2}: Speed-Dating – Austausch zu AkteurInnen und deren Rolle im Modell der fragmentierten Globalisierung

\begin{itemize}
\item Finden Sie eine zweite Person für einen Austausch. 
\item Erklären Sie sich gegenseitig, welche Erkenntnisse Sie aus den Videos und dem Modell der fragmentierten Globalisierung gewonnen haben. Welche der bisher gesehenen AkteurInnen würden Sie in die drei Kategorien von Scholz einordnen?
\end{itemize}
...
Überprüfen Sie danach Ihre Hypothesen, indem Sie je einen der folgenden Texten zu den Konzepten \textit{Effizienz}, \textit{Konsistenz} und \textit{Suffizienz} lesen.
...
\begin{myexercise}[Gruppen-Arbeit zu Nachhaltigkeits-Strategien]\label{ex:nachhaltigkeitskonzepte}
