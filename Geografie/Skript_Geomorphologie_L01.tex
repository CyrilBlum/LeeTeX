...
\tiny 3.2, 3.3 &\textbf{Lösungs-Verwitterung\newline (Hydrolyse)} & Lösen von Substanzen in Wasser, z.B. Steinsalz, Kalk, Gips. \newline Sonderformen: \textbf{Kohlensäureverwitterung} (s. \cref{fig:ksverw}), \textbf{Rauchgasverwitterung}. Aufbrechen chemischer Bindungen. & Hartes Wasser \\\midrule
...
\begin{figure}[H]
\centering
\includegraphics[width=.8\linewidth]{Private/Images/Karst}
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{Private/Images/ksVerw}
...
\begin{myexercise}
Lösen Sie das Quiz auf folgender Adresse: \qrcode{https://wendl.ch/quiz-geomorphologie/}
\end{myexercise}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{Private/Images/Geol_Karte_Schweiz}
