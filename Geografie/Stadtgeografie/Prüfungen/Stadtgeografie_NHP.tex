...
\begin{questions}
	...
	\question Auf folgendem Luftbild der Stadt Solothurn erkennen Sie drei eingefärbte Gebiete (orange, rot, blau). 
			\begin{figure}[H]
			\centering
			\includegraphics[width=\linewidth, page=1,trim={4.5cm 4.7cm 1cm 1cm},clip]{"Geografie/Stadtgeografie/Figures/Exam/Karte Solothurn.pdf"}
			\end{figure}
	...
	\fillwithlines{4cm}
	\begin{solution}
	Es handelt sich hierbei um einen Graben, auf dessen Grund sich früher die Zitadelle von Solothurn befand (siehe eckige Formen im Park). Als diese nicht mehr benötigt wurde, wurde das ehemalige Festungs-Gebiet begrünt.
	\end{solution}
	\droptotalpoints
	\vfill
	\clearpage
	...
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.2\linewidth]{Geografie/Stadtgeografie/Figures/segregationLeer}
	...
	\begin{enumerate}
	    ...
	    \item Es kann eventuell zu weiteren Gentrifizierungs-Wellen kommen, bis hin zu einer möglichen \enquote{Hyper-Gentrifizierung}.
	\end{enumerate}
	\end{solution}
	...
	\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{Geografie/Stadtgeografie/Figures/Exam/Umnutzung_Gentrifikation}
	\caption{}
	...
	\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{Geografie/Stadtgeografie/Figures/Exam/Mexico-Ciudad}
	\end{figure}
	\fillwithlines{15cm}
	\begin{solution}
			\begin{figure}[H]
			\centering
			\includegraphics[width=0.7\linewidth]{Geografie/Stadtgeografie/Figures/Exam/Mexico-Ciudad Sol Annot}
			\end{figure}
	...
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{Geografie/Stadtgeografie/Figures/Exam/Edge City}
	\end{figure}
	\begin{parts}
	...
	\fillwithlines{3cm}
	\begin{solution}
	Eine Edge City wächst häufig im Umland einer grösseren Stadt, also in sogenannten \enquote{Schlafstädten} wo die Anwohnerinnen zunächst nur wohnen. Später kommen Einrichtungen hinzu, welche einen ähnlichen Umfang an Grunddaseinsfunktionen ermöglichen wie in der nahe gelegenen Haupt-Stadt.
	\end{solution}
