...
\section{\enquote{Nachhaltige} Stadtplanung im 20. Jahrhundert}
...
\begin{myexercise}
	...
	\begin{enumerate}
		...
		\item Inwiefern kann das Modell als \enquote{nachhaltig} bezeichnet werden?
...
\begin{textBox}[title=Stadt der kurzen Wege]
	...
	\begin{figure}[H]
		...
		\caption{Modell der Entwicklung der räumlichen Muster der Daseinsgrundfunktionen bis zu einer \enquote{Stadt der kurzen Wege} \cite{westermann}}
...
\begin{textBox}[title=Paris]
	\begin{figure}[H]
		\centering
		\colorbox{white}{\includegraphics[width=.8\linewidth]{"Geografie/Stadtgeografie/NZZ-Artikel/Seite_8_NZZ_-_Neue_Zürcher_Zeitung_2024-08-30.pdf"}}
...
\begin{textBox}[title=Singapur]
	\begin{figure}[H]
		\centering
		\colorbox{white}{\includegraphics[width=.8\linewidth]{"Geografie/Stadtgeografie/NZZ-Artikel/Seite_15_NZZ_-_Neue_Zürcher_Zeitung_2023-08-26.pdf"}}
...
\begin{textBox}[title=Dubai]
	\begin{figure}[H]
		\centering
		\colorbox{white}{\includegraphics[width=.8\linewidth, page=2]{"Geografie/Stadtgeografie/NZZ-Artikel/Seiten_48_49_NZZ_-_Neue_Zürcher_Zeitung_2023-06-24.pdf"}}
...
\begin{textBox}[title=Schweiz]
	\begin{figure}[H]
		\centering
		\colorbox{white}{\includegraphics[width=.8\linewidth, page=1]{"Geografie/Stadtgeografie/NZZ-Artikel/Seiten_10_11_NZZ_-_Neue_Zürcher_Zeitung_2022-05-09.pdf"}}

	\end{figure}
	\begin{figure}[H]
		\centering
		\colorbox{white}{\includegraphics[width=.8\linewidth, page=2]{"Geografie/Stadtgeografie/NZZ-Artikel/Seiten_10_11_NZZ_-_Neue_Zürcher_Zeitung_2022-05-09.pdf"}}
	\end{figure}
\end{textBox}
