...
Bestimmen Sie auf folgender Karte der Stadt Luzern einen möglichen Standort für einen Superblock. Mehrere Lösungen sind möglich! Berücksichtigen Sie dabei Bevölkerungsdichte und das Verkehrsaufkommen (siehe Legende auf \cref{fig:legende}).
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\linewidth]{"Geografie/Stadtgeografie/Appendix/Karte Luzern Sol"}
...
\begin{todolist}
\item Ich kann benennen und grafisch darstellen, welche städteplanerischen Massnahmen mit dem Konzept \enquote{Superblocks} verbunden sind.
...
\item Ich kann basierend auf verschiedenen Perspektiven zum Thema \enquote{Superblocks} mein eigenes Urteil bilden.
\end{todolist}