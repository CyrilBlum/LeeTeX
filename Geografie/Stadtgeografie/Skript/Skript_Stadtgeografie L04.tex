...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Wunsch nach Wohnen \enquote{im Grünen}, Nähe zu Naherholungsgebieten
        \item ...
    \end{itemize}
\end{itemize}
...
\item Kreative / Pioniere, \item Gentrifier, \item Gentrified (untere soziale Schichten), \item \enquote{Andere}
\end{enumerate*}
\begin{figure}[H]
\centering
