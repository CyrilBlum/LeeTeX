...
\begin{myExBox}[title=Persönliche Beantwortung der Fragestellungen]
  ...
  \begin{myExBox}[title=Inputs vom Atelier]
    ...
    \begin{itemize}
      \item Aufgaben vom Typ ``komplexe Aufgaben'' sind in der Informatik möglicherweise schwer umsetzbar, da es, insbesondere beim Programmieren, häufig mehrere richtige Lösungswege sowie Resultate gibt und es insgesamt eher um das Verständnis des Konzepts als um das Resultat geht.
      \item Bezüglich der Rahmenbedingungen des Fallbeispiels wurde allgemein festgehalten, dass diese schwierig waren, und mehrere Ansätze zur potentiellen Linderung der erschwerten Lern- und Lehr-Situation wurden diskutiert. Insgesamt scheint es wichtig, die ``Limiten'' der Lernfähigkeit zu akzeptieren. Möglicherweise wäre eine Wiederholung der Inhalte der vergangenen Lektionen oder eine gemeinsame Diskussion der Prüfung sinnvoller gewesen.
