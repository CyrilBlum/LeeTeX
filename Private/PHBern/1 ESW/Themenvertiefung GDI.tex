...
\end{enumerate*}, wobei die drei ``Gedächtnis-Typen'' alle unterschiedliche Kapazitäten und Informations-Zerfallsraten haben. Im Folgenden wird auf verschiedene Inferenztypen eingegangen, die für das Abspeichern neuer Inhalte hinderlich sein können.
\subsubsection*{Anwendungen auf eigenen Unterricht}
