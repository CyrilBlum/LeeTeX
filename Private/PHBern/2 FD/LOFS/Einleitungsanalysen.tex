...
\subsection{Akteur:innen und wirtschaftliche Einflussfaktoren der Globalisierung}
Die wirtschaftliche Globalisierung wird nicht nur durch Unternehmen oder Konsumierende gesteuert, sondern durch eine Vielzahl von Akteur:innen mit unterschiedlichen Interessen. Neben der Wirtschaft (z.B. Unternehmen, Märkte, Standortförderungsorganisationen) spielen auch politische Akteur:innen (Staaten, internationale Organisationen, Handelsabkommen) sowie gesellschaftliche Faktoren (z.B. Arbeitsbedingungen, nachhaltige Entwicklung, soziale Bewegungen) eine zentrale Rolle.

Um die Ursachen und Auswirkungen wirtschaftlicher Veränderungen besser analysieren zu können, wird in der wirtschaftsgeografischen Betrachtung zwischen exogenen und endogenen Globalisierungstreibern unterschieden. Diese Unterscheidung hilft dabei, Einflussfaktoren systematisch einzuordnen und ihre Wirkung auf unterschiedliche geographische Dimensionen wie Gesellschaft, Politik und Wirtschaft zu analysieren.

Der Schwerpunkt dieser Doppellektion liegt auf den wirtschaftlichen Akteur:innen der Globalisierung, während politische Rahmenbedingungen nur am Rande behandelt werden.Anhand der Konzepte \textbf{Global Cities, Global Players sowie Ausländischer Direktinvestitionen (ADI)}, insbesondere \textbf{Greenfield- und Brownfield-Investitionen}, wird aufgezeigt, wie wirtschaftliche Macht global verteilt ist und welche Mechanismen die wirtschaftliche Globalisierung prägen. Dabei wird auch erkennbar, welche Regionen, Unternehmen und Akteur:innen über Entscheidungs- und Steuerungshoheit verfügen und welche primär ausführenden Funktionen übernehmen.

Die in der ersten Doppellektion erstellten Produkt-Lieferketten werden erneut aufgegriffen und weiter analysiert, um die wirtschaftlichen Ursachen und Dynamiken zu verstehen, die diese Strukturen formen und beeinflussen.
...
Da auch der Protektionismus zahlreiche Nachteile mit sich bringt, setzen sich die Schüler:innen in der dritten Doppellektion mit alternativen Ansätzen auseinander, um globale Lieferketten gesellschafts- und umweltverträglicher zu gestalten. Dabei werden verschiedene Konzepte einer „Global Green Economy“ diskutiert, um Massnahmen zur nachhaltigen Gestaltung globaler Wertschöpfungsketten in den Dimensionen Gesellschaft, Wirtschaft und Umwelt zu entwickeln.

\subsection{Globalisierung vs. Protektionismus -- Gewinner:innen und Verlierer:innen}
In der vierten Doppellektion wird der Protektionismus als Gegenentwurf zur Globalisierung thematisiert. Die Schüler:innen analysieren dessen kurz- und langfristige Folgen auf Mikro- und Makroebene und vergleichen protektionistische Massnahmen mit einer globalisierungsfreundlichen Wirtschaftspolitik und erkennen, dass beide Systeme Gewinner:innen und Verlierer:innen produzieren. Durch die Auseinandersetzung mit diesen Gegenmodellen und das vertiefte Verständnis von Chancen und Risiken beider Ansätze sollen die Schüler:innen eine differenzierte Meinung zur Globalisierung und zum Protektionismus entwickeln.

Die Unterrichtseinheit verfolgt das Ziel, den Schüler:innen eine differenzierte Perspektive auf die Globalisierung zu vermitteln. Durch die eigenständige Analyse globaler Lieferketten, wirtschaftlicher Akteur:innen und politischer Gegenmodelle sollen sie erkennen, dass die Globalisierung weder ausschliesslich positiv noch ausschliesslich negativ ist, sondern eine Vielzahl von wirtschaftlichen, gesellschaftlichen und ökologischen Faktoren umfasst. Indem sie sich in unterschiedliche Rollen und Perspektiven begeben, verstehen die Schüler:innen, dass verschiedene Akteur:innen unterschiedlich von der Globalisierung profitieren -- oder benachteiligt werden -- und dass wirtschaftspolitische Massnahmen stets Gewinner:innen und Verlierer:innen erzeugen.

\section{Didaktische Analyse}
\subsection{Gesellschaftsrelevanz}
Wir sind alle Konsument:innen von Gütern. Daher ist es essentiell, dass wir uns mit der Frage beschäftigen, wo, wie und unter welchen Bedingungen diese Produkte hergestellt, verteilt und konsumiert werden. Die Globalisierung prägt nahezu alle Lebensbereiche, von der Produktion und Verteilung von Waren bis hin zur politischen und kulturellen Auswirkungen. Die lokale, regionale und internationale Verlagerung von Produktionsstätten, globalen Handelsabkommen und transnationalen Unternehmen beeinflussen Wirtschaftsstrukturen und Arbeitsmärkte weltweit. In einer Zeit, in der Nachhaltige Entwicklung und faire Lieferketten zunehmend diskutiert werden, ist es essenziell für die Schüler:innen, die Mechanismen der Globalisierung und ihre Auswirkungen zu verstehen. Themen wie Fast Fashion, Elektroschrott, CO$_2$-Emissionen durch globale Transporte führen zu Debatten, in denen informierte Bürger:innen kritische Konsumentscheidungen treffen müssen.
...
\end{quote}
Durch interaktive Methoden wie Concept-Maps, Fallstudien und Debatten können Schüler:innen ihre analytischen Fähigkeiten und Urteilsfähigkeit schulen.
