...
\chapter{Einführung zu Globalisierung und globalen Lieferketten}

Die Globalisierung beschreibt die zunehmende wirtschaftliche, kulturelle, gesellschaftliche und politische Verflechtung von Staaten und Regionen. Durch technologische Fortschritte im Transport- und Kommunikationsbereich hat sich die weltweite Vernetzung in den letzten Jahrzehnten massiv beschleunigt. Besonders deutlich wird dies in globalen Lieferketten, bei denen die Produktion eines einzelnen Produkts über mehrere Länder verteilt ist, wie beispielsweise Jeans (siehe \cref{fig:jeans}).
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{Private/PHBern/2 FD/LOFS/Figures/jeans}
    \caption{Globale Lieferkette am Beispiel einer Jeans \cite{jeans}}
    \label{fig:jeans}
\end{figure}
...
\begin{myexercise}[Hypothesenbildung: Warum sind Lieferketten (z.B. von Jeans) global?]\label{ex:globaleLieferketten}
...
\begin{myexercise}[Die Lieferkette einer Jeans \cite{umweltBildung}]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{Private/PHBern/2 FD/LOFS/Figures/map-empty}
        \caption{Leere Weltkarte für Jeans-Lieferkette \cite{umweltBildung}}
    \end{figure}
    \begin{myanswer}
        \begin{figure}[H]
            \centering
            \includegraphics[width=\linewidth]{Private/PHBern/2 FD/LOFS/Figures/map-sol}
            \caption{Weltkarte für Jeans-Lieferkette \cite{umweltBildung}}
        \end{figure}
...
\begin{mychallenge}[Verkaufspreis einer Jeans \cite{umweltBildung}]
    \begin{enumerate}
        \item Schätzen Sie ab, wie sich der Verkaufspreis einer Jeans zusammensetzt und ordnen Sie die prozentuale Verteilung des Preises den einzelnen Akteur:innen (Hersteller, Marke, Einzelhandel, Transport, etc.) auf \cref{fig:jeans-leer} zu.
        \item Diskutieren Sie, ob die Verteilung fair ist? Welche Akteur:innen profitieren am meisten?
    \end{enumerate}
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\linewidth]{Private/PHBern/2 FD/LOFS/Figures/jeans-leer}
    ...
    \begin{myanswer}
        \begin{figure}[H]
            \centering
            \includegraphics[width=.4\linewidth]{Private/PHBern/2 FD/LOFS/Figures/jeans-sol}
...
\textbf{Globalisierung} ist die zunehmende weltweite Vernetzung in Wirtschaft, Politik, Kultur, Gesellschaft und Kommunikation. Sie ermöglicht den schnellen Austausch von Gütern, Informationen und Kapital über nationale Grenzen hinweg und führt zu einer stärkeren gegenseitigen Abhängigkeit von Staaten, Unternehmen und Individuen.
...
\begin{myexercise}
    \begin{enumerate}
        ...
        \item Erstellen Sie auf einem Flipchart eine umfassende Lieferkette für Ihr Produkt. Material (Dossiers, anklickbare Links, etc.) für ihre Recherche finden Sie untenan.
              ...
              \end{enumerate}
        \item Färben Sie mögliche Auswirkungen oder Prägungen einzelner Akteure mit den Farben des Skalen-Konzept (siehe \cref{fig:scales}) ein.
    \end{enumerate}
...
\chapter{Akteur:innen und wirtschaftliche Einflussfaktoren der Globalisierung}

Die wirtschaftliche Globalisierung wird nicht nur durch Unternehmen oder Konsumierende gesteuert, sondern durch eine Vielzahl von Akteur:innen mit unterschiedlichen Interessen. Neben der Wirtschaft (z. B. Unternehmen, Märkte, Standortförderungsorganisationen) spielen auch politische Akteure (Staaten, internationale Organisationen, Handelsabkommen) und gesellschaftliche Faktoren (z. B. Arbeitsbedingungen, Nachhaltigkeit, soziale Bewegungen) eine zentrale Rolle.

Die Konjunkturtheorie \cite{keynes1936general} hilft dabei, die Ursachen und Folgen wirtschaftlicher Entwicklungen besser zu verstehen. In diesem Zusammenhang wird zwischen endogenen und exogenen Globalisierungstreibern unterschieden. Diese Unterscheidung ermöglicht es, wirtschaftliche Veränderungen zu analysieren
...
\begin{myexercise}
    Für die folgenden Globalisierungstreiber sollen Sie die möglichen Auswirkungen auf die Bereiche Gesellschaft, Politik und Wirtschaft notieren. Überlegen Sie bei jedem Begriff, welcher Bereich am stärksten betroffen ist und markieren Sie diesen entsprechend.

    \begin{table}[H]
        \centering
        \begin{tabular}{p{4cm}|c|c|c}
            \textbf{Begriff}                        & \textbf{Gesellschaftlich} & \textbf{Politisch} & \textbf{Wirtschaftlich} \\\midrule\midrule
            Digitalisierung                         &                           &                    &                         \\[0.5cm]\midrule
            Veränderung des\newline Transportwesens &                           &                    &                         \\[0.5cm]\midrule
            Bilaterales\newline Handelsabkommen     &                           &                    &                         \\[0.5cm]\midrule
            Zölle                                   &                           &                    &                         \\[0.5cm]\midrule
            Regionale Kriege                        &                           &                    &                         \\[0.5cm]
        \end{tabular}
    \end{table}
    \begin{myanswer}
        \begin{table}[H]
            ...
            \begin{tabular}{p{2.5cm}|p{3.5cm}|p{3.5cm}|p{3.5cm}}
                \textbf{Begriff}                & \textbf{Gesellschaftlich}                                                             & \textbf{Politisch}                                                                                 & \textbf{Wirtschaftlich}                                                                                          \\\midrule\midrule
                Digitalisierung                 & Veränderung des Konsumverhaltens, neue Arbeitsformen (Homeoffice, Gig-Economy)        & Regulierungsfragen (z.B. Datenschutz, Plattformregulierung)                                      & Neue Geschäftsmodelle, Automatisierung, Effizienzsteigerung in Produktion und Handel \textbf{(stärkste Wirkung)} \\\midrule
                Veränderung des Transportwesens & Mobilität steigt, Konsum von globalen Produkten wird Alltag                           & Infrastrukturpolitik, internationale Verkehrsabkommen                                              & Globale Lieferketten, Standortwahl, Kostenreduktion im Handel \textbf{(stärkste Wirkung)}                        \\\midrule
                Bilaterales Handelsabkommen     & Verfügbarkeit ausländischer Produkte, Preisveränderungen                              & Gestaltung durch Staaten, Einfluss auf nationale Gesetze und Standards \textbf{(stärkste Wirkung)} & Öffnung neuer Märkte, Wettbewerb, Spezialisierung                                                                \\\midrule
                Zölle                           & Veränderung der Konsumpreise, nationale Produktpräferenzen                            & Instrument der Handelspolitik, Machtmittel zwischen Staaten \textbf{(stärkste Wirkung)}            & Verteuerung von Importen, Schutz der Binnenwirtschaft                                                            \\\midrule
                Regionale Kriege                & Fluchtbewegungen, soziale Unsicherheit, Versorgungskrisen \textbf{(stärkste Wirkung)} & Instabilität, Machtverschiebungen, internationale Sanktionen                                       & Unterbrechung globaler Lieferketten, Investitionsrückgang                                                        \\
            \end{tabular}
            \caption{Mögliche Auswirkungen der Globalisierungstreiber auf Gesellschaft, Politik und Wirtschaft}
        \end{table}
    \end{myanswer}
\end{myexercise}
...
\begin{myexercise}[Fragmentierte Entwicklung]\label{ex:frag}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[trim={1cm 3cm 1cm 7cm},clip,width=\linewidth]{Private/PHBern/2 FD/LOFS/Assets/Fragmentierte}
...
\begin{myexercise}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{Private/PHBern/2 FD/LOFS/Figures/frag}
...
\begin{myexercise}[ADI]
    ...
    \textbf{Teil 1}: Notieren Sie sich die Definitionen der erwähnten Begriffen in eigenen Worten. Fassen Sie untenan zusammen, inwiefern diese Begriffe mit dem Modell der fragmentierten Globalisierung zusammenhängen.
    \begin{itemize}
        \item \gls{ADI}
    ...
    \end{itemize}
    \notiz{8}
    \textbf{Teil 2}: Speed-Dating – Austausch zu Akteur:innen und deren Rolle im Modell der fragmentierten Globalisierung

    \begin{itemize}
        \item Finden Sie eine zweite Person für einen Austausch.
        \item Erklären Sie sich gegenseitig, welche Erkenntnisse Sie aus den Videos und dem Modell der fragmentierten Globalisierung gewonnen haben. Welche der bisher gesehenen Akteur:innen würden Sie in die drei Kategorien von Scholz einordnen?
    \end{itemize}
...
\begin{mychallenge}
    Schauen Sie sich folgende Webseite zu Fotografien von besonders \enquote{heterogenen}, also gesellschaftlich ungleichen Orten an:
...
\chapter{Gewinner:innen und Verlierer:innen der Globalisierung -- Protektionismus als Alternative?}

Als Antwort auf die Herausforderungen der globalen Weltwirtschaft ist in den letzten Jahrzehnten vielerorts der \textbf{Protektionismus} erstarkt, wie in verschiedenen medialen Berichten ersichtlich wird (siehe \cref{fig:nzz-protektionismus-headline}).

\begin{figure}[H]
    \centering
    \includegraphics[width=.8\linewidth]{Private/PHBern/2 FD/LOFS/Figures/NZZ-Protektionismus-Headline}
...
\begin{myexercise}[Brainstorming-Aufgab zu Dimensionen der Globalisierung]
    Notieren Sie Vor- und Nachteile der \textbf{Globalisierung} hinsichtlich der Dimensionen \textit{Umwelt}, \textit{Gesellschaft} und \textit{Wirtschaft}.
    \begin{table}[H]
        \centering
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{c|p{.25\textwidth}|p{.25\textwidth}|p{.25\textwidth}}
                ...
                Nachteile
                 ...
                 & Ungleichheit, Unterdrückung / Marginalisierung lokaler Kulturen, prekäre Arbeitsbedingungen
...
\begin{myexercise}[Youtube-Video zum Thema Protektionismus]
    Notieren Sie sich mithilfe des Youtube-Videos (anklickbarer QR-Code), was mit folgenden Begriffen gemeint ist:
    ...
    \begin{myanswer}
        \begin{table}[H]
            ...
            \begin{tabular}{l|p{10cm}}
                ...
                Weltwirtschaftskrise & Ein extremes Szenario, das unter anderem dann eintreten kann, wenn zu viele Länder protektionistische Massnahmen ergreifen, was den internationalen Handel stark reduziert und wirtschaftliche Instabilität verursacht (viele andere Gründe existieren hierfür: Inflation, Verschuldung etc.). \\
            \end{tabular}
        \end{table}
    \end{myanswer}
\end{myexercise}

\begin{myexercise}[Thesen zu Protektionismus im Kontext der US-amerikanischen Handelskriege]
    Stellen Sie die Hauptargumente aus dem folgenden NZZ-Artikel zusammen, welche für oder gegen Protektionismus sprechen.
    \begin{figure}[H]
        \centering
        \colorbox{white}{\includegraphics[width=.8\linewidth]{Private/PHBern/2 FD/LOFS/Assets/Seite_14_NZZ_-_Neue_Zürcher_Zeitung_2018-06-09}}
...
\begin{mychallenge}[Vertiefung zu den Folgen der Globalisierung]
    Analysieren Sie weitere Folgen der Globalisierung anhand des SRF-Videos (anklickbarer QR-Code):
...
\begin{myexercise}[Schweizer Textilbranche und Zölle]
    Notieren Sie sich mithilfe des SRF-Audios (anklickbarer QR-Code), weshalb die Schweizer Textilbranche für einen Abbau von Zöllen ist:
    ...
    \begin{myanswer}
        \begin{itemize}
            ...
            \item Textilien werden nicht mehr von Anfang bis Ende am selben Ort hergestellt, man ist also international abhängig und Teil eines komplexen internationalen Geflechts.
        \end{itemize}
    \end{myanswer}
\end{myexercise}
...
\begin{mychallenge}[NZZ-Artikel zu Protektionismus in den USA]
    \begin{figure}[H]
        \centering
        \colorbox{white}{\includegraphics[width=.9\linewidth]{Private/PHBern/2 FD/LOFS/Assets/Seite_17_NZZ_-_Neue_Zürcher_Zeitung_2024-10-10}}
    \end{figure}
\end{mychallenge}
...
\begin{myexercise}[Gruppen-Puzzle zu Nachhaltigkeits-Strategien]
    \textbf{Leitfrage}: Wie können innerhalb globaler Produktions- und Handelsnetzwerke weniger Ressourcen verbraucht und der Abfall sowie die Emissionen reduziert werden?

    Dikutieren Sie diese Leitfrage zunächst zu dritt in Ihrer Gruppe. Überlegen Sie sich, welche Massnahmen Sie ergreifen würden, um die Nachhaltigkeit innerhalb globaler Produktions- und Handelsnetzwerke zu erhöhen.

    Überprüfen Sie danach Ihre Hypothesen, indem Sie je einen der folgenden Texten zu den Strategien \textit{Effizienz}, \textit{Konsistenz} und \textit{Suffizienz} lesen.

    Fassen Sie ihre Strategien danach anhand von \textbf{drei Schlüsselbegriffen} zusammen und suchen Sie sich \textbf{drei zu Strategie passende Bilder} von der Vorlage aus (siehe \cref{fig:beispielbildernachhaltigkeit}).

    Setzten Sie sich nach dem Lesen der Strategien in Expert:innengruppen (eine Gruppe pro Nachhaltigkeits-Prinzip) zusammen und einigen Sie sich auf 3 Schlüsselbegriffe und 3 Bilder. Finden Sie zudem ein konkretes Beispiel (Lieferkette, Massnahme, etc.), um Ihre Nachhaltigkeits-Strategie anschaulich darzustellen.
    ...
    \begin{textBox}[title = Suffizienz -- anders konsumieren für ein gutes Leben für alle \cite{suffizienz}]
        ...
        Suffizienz setzt also nicht auf der Produktionsseite an, sondern bei Konsummustern. Daher geraten auch kulturelle und soziale Aspekte unserer Lebensweise in den Blick.
    \end{textBox}
    ...
    \begin{figure}[H]
        \centering
        \colorbox{white}{\includegraphics[width=0.45\linewidth, page=1]{Private/PHBern/2 FD/LOFS/Figures/Beispielbilder_Nachhaltigkeit}
            \includegraphics[width=0.45\linewidth, page=2]{Private/PHBern/2 FD/LOFS/Figures/Beispielbilder_Nachhaltigkeit}}
        \caption{Bilder zu Nachhaltigkeits-Positionen Suffizienz, Konsistenz und Effizienz \cite{strategienNachhaltigkeit}}
...
\begin{myexercise}[Gruppen-Arbeit zu Nachhaltigkeits-Strategien]\label{ex:nachhaltigkeit-pos}

    Dieser Auftrag besteht aus mehreren Teilen:

    \begin{enumerate}
        \item Bilden Sie Vierergruppen. Schauen Sie sich zunächst \textit{individuell} jeweils eines der folgenden Videos (Quelle: \textcite{globalGreenEconomy}) an und notieren Sie sich in 3 Schlüsselbegriffen, worum es geht. Notieren Sie sich ebenfalls, welches der Nachhaltigkeits-Strategien Effizienz, Suffizienz und Konsistenz Sie in den jeweiligen Positionen wiedererkennen können?
              \begin{table}[H]
                  \centering
                  \begin{tabular}{c|c}
                      \textbf{Position}                      & \textbf{Link (anklickbar)}                                                                                  \\
                      \midrule\midrule
                      ...
                      Degrowth                               & \qrcode[height=1.5cm]{https://vimeo.com/121263974}                                                          \\
                  \end{tabular}
              \end{table}
        \item Vervollständigen Sie nun gemeinsam als Gruppe folgende Tabelle. Setzen Sie bei den letzten drei Spalten lediglich Häkchen oder Kreuze.
              \begin{table}[H]
                  ...
                  \begin{tabular}{ c | p{3.5cm} | p{2cm} | p{2cm} | p{2cm} }
                      \textbf{Position}   & \textbf{Schlüsselbegriffe} & \textbf{Effizienz} & \textbf{Suffizienz} & \textbf{Konsistenz} \\
                      \midrule
                      Kreislaufwirtschaft &                            &                    &                     &                     \\[50pt]\midrule
                      GWÖ                 &                            &                    &                     &                     \\[50pt]\midrule
                      Degrowth            &                            &                    &                     &                     \\[50pt]
                  \end{tabular}
                  \caption{Schlüsselbegriffe und Nachhaltigkeitsstrategien der Positionen}
              \end{table}
    ...
    \begin{myanswer}
        \begin{table}[H]
            ...
            \begin{tabular}{ c | p{3.5cm} | c | c | c }
                ...
                Degrowth            & Postwachstum, Wachstumszwänge hinterfragen, alternative Gesellschaftsmodelle &                    & \checkmark          & \checkmark          \\
            \end{tabular}
            \caption{Schlüsselbegriffe und Nachhaltigkeitsstrategien der Positionen}
            \label{tab:nachhaltigkeit-pos}
        \end{table}


    \end{myanswer}
\end{myexercise}
\begin{myexercise}[Anwendung der Nachhaltigkeits-Positionen auf eigenes Produkt]
    Setzen Sie sich in Ihren ursprünglichen Produkte-Gruppen zusammen und bestimmen Sie \textit{eines} der Nachhaltigkeitspositionen aus \cref{ex:nachhaltigkeit-pos}, welches besonders geeignet wäre, um die Nachhaltigkeit Ihres globalen Produktes zu verbessern.
\end{myexercise}