...
\lhead[ \leftmark ]{PHBern, Fachdidaktik Informatik}
...
% \newcommand{\thetopic}{Semester-Programm \enquote{Einführung Programmieren}}
...
\begin{todolist}
    ...
    \item Die SuS können den Modulo-Operator (\lstinline|%|) korrekt verwenden, beispielsweise um alle geraden Zahlen in einer Schleife auszugeben  (siehe DL 1 für einfache Schleifen).
