...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{Private/PHBern/LOFS/Figures/jeans}
...
\begin{myexercise}[Die Lieferkette einer Jeans \cite{umweltBildung}]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{Private/PHBern/LOFS/Figures/map-empty}
        \caption{Leere Weltkarte für Jeans-Lieferkette \cite{umweltBildung}}
    \end{figure}
    \begin{myanswer}
        \begin{figure}[H]
            \centering
            \includegraphics[width=\linewidth]{Private/PHBern/LOFS/Figures/map-sol}
...
\begin{mychallenge}[Verkaufspreis einer Jeans \cite{umweltBildung}]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\linewidth]{Private/PHBern/LOFS/Figures/jeans-leer}
    ...
    \begin{myanswer}
        \begin{figure}[H]
            \centering
            \includegraphics[width=.4\linewidth]{Private/PHBern/LOFS/Figures/jeans-sol}
...
\begin{myexercise}[Fragmentierte Entwicklung]\label{ex:frag}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[trim={1cm 3cm 1cm 7cm},clip,width=\linewidth]{Private/PHBern/LOFS/Assets/Fragmentierte}
...
\begin{myexercise}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{Private/PHBern/LOFS/Figures/frag}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\linewidth]{Private/PHBern/LOFS/Figures/NZZ-Protektionismus-Headline}
...
\begin{myexercise}[Thesen zu Protektionismus im Kontext der US-amerikanischen Handelskriege]
    ...
    \begin{figure}[H]
        \centering
        \colorbox{white}{\includegraphics[width=.8\linewidth]{Private/PHBern/LOFS/Assets/Seite_14_NZZ_-_Neue_Zürcher_Zeitung_2018-06-09}}
...
\begin{mychallenge}[NZZ-Artikel zu Protektionismus in den USA]
    \begin{figure}[H]
        \centering
        \colorbox{white}{\includegraphics[width=.9\linewidth]{Private/PHBern/LOFS/Assets/Seite_17_NZZ_-_Neue_Zürcher_Zeitung_2024-10-10}}
    \end{figure}
\end{mychallenge}
...
\begin{myexercise}[Gruppen-Puzzle zu Nachhaltigkeits-Strategien]
    ...
    \begin{figure}[H]
        \centering
        \colorbox{white}{\includegraphics[width=0.45\linewidth, page=1]{Private/PHBern/LOFS/Figures/Beispielbilder_Nachhaltigkeit}
            \includegraphics[width=0.45\linewidth, page=2]{Private/PHBern/LOFS/Figures/Beispielbilder_Nachhaltigkeit}}
