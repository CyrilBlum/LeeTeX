...
Zugleich verhandelt die Lehrperson auch regelmässig mit Gleichgestellten Kolleg*innen der Fachschaft. Dabei kann es beispielsweise um die Anschaffung neuer Unterrichtsmaterialien, die Verteilung von Wochenlektionen, die Erarbeitung von Richtlinien oder um die Planung von Projektwochen gehen.

Im Unterschied zu Verhandlungen mit der Schulleitung oder mit SuS gibt es in diesem Fall kein vorbestimmtes Hierarchie Gefälle. Eine gewisse Hierarchie unter Gleichgestellten wird meist durch Erfahrung oder soziale Faktoren bestimmt. Daher ist es umso wichtiger, sich bei solchen Verhandlungen auf Interessen und nicht auf Positionen zu fokussieren. Es sollten nicht die erfahrensten Lehrpersonen der Fachschaft alles bestimmen können, sondern die Interessen und Bedürfnisse aller Lehrpersonen gleich gewichtet werden. Die Entwicklung von Optionen zum beidseitigen Vorteil sollte im Fokus stehen.

Zwei weitere Punkte der Harvard Theorie sind die Trennung von Person und Problem und das Bestehen auf objektiven Kriterien zur Lösungsfindung. Das sind meiner Meinung nach Grundsätze, die zu jeder gesunden Diskussionskultur dazugehören. Wir schlagen jedem Kollegium vor gelegentlich verschiedene Bedürfnisse zur Diskussionskultur festzulegen. Diese dürfen über die im Harvard-Konzept gelisteten Punkte hinaus gehen und bspw. mit ``einander zuhören und nicht dazwischenreden'' erweitert werden.
...
Im zweiten Schritt rücken die Interessen in den Fokus. Die Lehrperson möchte faire Bedingungen schaffen und den Lehrplan einhalten. Die SuS hingegen brauchen mehr Zeit wegen Prüfungen oder ausserschulischer Verpflichtungen. Anstatt auf ihrer jeweiligen Position zu beharren, arbeiten beide Seiten daran, die wahren Beweggründe zu verstehen und eine Lösung zu finden, die diesen gerecht wird.

Im dritten Schritt werden kreative Lösungen entwickelt. Möglichkeiten wie eine kurze Fristverlängerung für alle oder die Abgabe eines Entwurfs zum ursprünglichen Termin mit späterer Überarbeitung werden gemeinsam diskutiert. Diese Ansätze öffnen neue Wege und führen zu innovativen Lösungen.

Schliesslich werden im vierten Schritt objektive Kriterien herangezogen. Prüfungstermine der SuS und der Lehrplan der Lehrperson dienen als faktische Grundlage für die Entscheidung. SuS, die mehrere Prüfungen in derselben Woche haben, können die Projektarbeit mit einer kurzen Begründung später Abgeben, während für alle anderen der Abgabetermin gleichbleibt. Durch diesen Ansatz finden beide Seiten eine faire und respektvolle Lösung, die auf gegenseitigem Verständnis und klaren Kriterien beruht. Die Verhandlung endet mit einer Einigung, die beide Parteien zufriedenstellt.
