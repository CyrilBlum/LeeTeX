...
\begin{frame}{Problem: Bitrot}
    \begin{center}
        \includegraphics[width=\textwidth]{GrundlagenInfo/05_DatenIntegritaet/Figures/bitrot.png}
    \end{center}
\end{frame}

\begin{frame}{Mögliche Lösung: NAS mit RAID}
    \begin{center}
        \includegraphics[width=.9\textwidth]{GrundlagenInfo/05_DatenIntegritaet/Figures/NAS.png}
    \end{center}
    \begin{itemize}
...
\begin{frame}{RAID 0}
    \begin{center}
        \includegraphics[width=.25\textwidth]{GrundlagenInfo/05_DatenIntegritaet/Figures/RAID_0.pdf}
    \end{center}
    \begin{itemize}
...
\begin{frame}{RAID 1}
    \begin{center}
        \includegraphics[width=.25\textwidth]{GrundlagenInfo/05_DatenIntegritaet/Figures/RAID_1.pdf}
    \end{center}
    \begin{itemize}
...
\begin{frame}{RAID 5}
    \begin{center}
        \includegraphics[width=.5\textwidth]{GrundlagenInfo/05_DatenIntegritaet/Figures/RAID_5.pdf}
    \end{center}
    \begin{itemize}
...
\begin{frame}{RAID 6}
    \begin{center}
        \includegraphics[width=.5\textwidth]{GrundlagenInfo/05_DatenIntegritaet/Figures/RAID_6.pdf}
    \end{center}
    \begin{itemize}
