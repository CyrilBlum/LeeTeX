...
Beide Codierungen sind \textbf{präfixfrei}: Kein Codewort ist Anfangsstück (Präfix) eines anderen Codeworts. Allerdings verwenden wir für die ``effiziente'' Kodierung weniger Speicherplatz.

\begin{myexercise}
Berechnen Sie, wie viele Bits Speicherplatz die effiziente und die naive Kodierung benötigen, für den oben gezeigten Text.
\begin{myanswer}
\begin{enumerate}
\item ``Naive'' Kodierung:...
\item ``Effiziente'' Kodierung:...
\end{enumerate}
\end{myanswer}
\end{myexercise}
