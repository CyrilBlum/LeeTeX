...
\fill[green!50, rounded corners] (llDOut#1) -- ++(0,{#4/2},0) -- ++(0,0,{#4/2})node[pos=0.8,rotate=45, below, align=center](out#1){\textcolor{black}{\texttt{out#1}}} -- ++(0,{-#4/2},0);
...
\node[fill=green!50, rounded corners](outVal1) at (4,-.6,3){36};
\draw[thick,->] (out1) -- (outVal1);
\end{tikzpicture}
\caption{Illustration einer Funktion}
...
\end{tikzpicture}
\caption{Illustration eines Codes, bei dem sich mehrere Funktionen ergänzen}
