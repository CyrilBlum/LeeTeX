...
\node[draw=OrangeRed, fill=Lavender, rounded corners, minimum width=1cm, minimum height=1cm] at (4, 0) {20};
\node[draw=OrangeRed, fill=Lavender, rounded corners, minimum width=1cm, minimum height=1cm] at (5, 0) {10};
