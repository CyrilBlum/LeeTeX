...
\begin{tikzpicture}[node distance=2cm, scale=.6, transform shape, on grid, ->]
    ...
    \node (printif) [code, below left=2cm and 5cm of dec1] {\lstinline|print("Definitive Promotion")|};
    \node (printelse) [code, below right=2cm and 5cm of dec1] {\lstinline|print("Provisorische  Promotion")|};
