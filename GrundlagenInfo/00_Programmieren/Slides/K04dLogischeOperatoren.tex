...
\titlegraphic{\vspace{-.7cm}\includegraphics[width=\textwidth]{"GrundlagenInfo/06_Daten/Figures/title-emojis"}}
...
\begin{frame}{Aufgaben}
    ...
    \begin{itemize}
        ...
        \item \aufgabebox{5.13-5.14} in VS Codium
        \item \challengebox{5.16 - 5.18} in VS Codium
    \end{itemize}
\end{frame}
...
\begin{frame}{Sicherung}
    \begin{itemize}[<+->]
        ...
        \item \faCheckSquare{} \lstinline|if|, \lstinline|elif| und \lstinline|else| erlauben es, verschiedene Bedingungen zu prüfen
