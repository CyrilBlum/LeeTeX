...
\begin{frame}{Auftrag}
    \begin{itemize}
        \item Skript neu herunterladen
        \item \readbox{Lesen Sie Beispiel 5.4 und 5.5}
        \item \aufgabebox{Aufgaben 5.14-5.17}
        \item \challengebox{Aufgaben 5.18, 5.19}
    \end{itemize}
\end{frame}
