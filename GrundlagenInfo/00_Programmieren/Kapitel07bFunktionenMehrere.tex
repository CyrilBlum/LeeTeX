...
\begin{frame}
    ...
    \emoji{cook} Kapitel 7: \textbf{Funktionen und \tjinline{return}}: Mehrere Funktionen
\end{frame}
...
\begin{itemize}[<+->]
	...
	\item \emoji{cook} ...die wie ein \textbf{Kochrezept} funktionieren:
	\begin{itemize}
