...
``redo'' &\keys{\ctrl +\shift + Z}& \keys{\cmd + \shift + Z}\\\midrule
Cursor bewegen &\keys{\arrowkeyright}, ...& \keys{\arrowkeyright}, ...\\\midrule
Cursor bewegen (Wörter) &\keys{\AltGr+\arrowkeyright}, ...& \keys{\Alt+\arrowkeyright}, ...\\\midrule
Einrücken & \keys{\tab}& \keys{\tab}\\\midrule
Ausrücken & \keys{\shift + \tab}& \keys{\shift + \tab}
\end{tabular}
\end{table}
\end{frame}


\begin{frame}[fragile]{Lektion 01: \lstinline[style=TigerJython]|repeat|}
