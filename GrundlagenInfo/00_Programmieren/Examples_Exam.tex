...
Cursor bewegen (Wörter) &\keys{\ctrl+\arrowkeyright}, \keys{\ctrl+\arrowkeyleft} & \keys{\Alt+\arrowkeyright}, \keys{\Alt+\arrowkeyleft} \\\midrule
...
Browser: Neuen Tab öffnen & \keys{\ctrl + T} & \keys{\cmd + T} \keys{\cmd} + zahl\\\midrule
