...
\begin{figure}[H]
\centering
\includegraphics[width=.6\linewidth]{GrundlagenInfo/00_Programmieren/Figures/Glattalbahn_vbg}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{GrundlagenInfo/00_Programmieren/Figures/GTB_Karte_mit_Legende_Web_v02}
\end{figure}
