...
star()
\end{lstlisting}
\lstinline[style=TigerJython]|setPenColor(...)|: 
\begin{itemize}
\item Vordefinierte Farbe auf Englisch, z.B. \lstinline[style=TigerJython]|setPenColor("green")|, \textit{mit} Anführungszeichen
...
\end{lstlisting}
\begin{itemize}
\item \lstinline[style=TigerJython]|clear(...)|: Hintergrund auf bestimmte Farbe setzen (Name oder RGB-Code)
\end{itemize}
\end{frame}

\begin{frame}[fragile]{Flächen ausfüllen mit \lstinline[style=TigerJython]|fillPath()|}
\begin{lstlisting}[style=TigerJython]
from gturtle import *
makeTurtle()
