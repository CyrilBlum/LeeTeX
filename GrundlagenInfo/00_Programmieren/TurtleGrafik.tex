...
\begin{frame}[fragile]{Sterne zeichnen \faStar}
	\begin{lstlisting}[numbers=none,style=TigerJython]
from gturtle import *
makeTurtle()
...
setPenColor(0,155,85)        
star()
\end{lstlisting}
\lstinline[numbers=none,style=TigerJython]|setPenColor(...)|: 
\begin{itemize}
\item Vordefinierte Farbe auf Englisch, z.B. \lstinline[numbers=none,style=TigerJython]|setPenColor("green")|, \textit{mit} Anführungszeichen
\item \textcolor{red}{R}\textcolor{green}{G}\textcolor{blue}{B}-Code, z.B. \texttt{setPenColor(\textcolor{red}{0},\textcolor{green}{155},\textcolor{blue}{85})}, \textit{ohne} Anführungszeichen
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{\lstinline[style=TigerJython]|clear(farbe)|}
...
\end{lstlisting}
\begin{itemize}
\item \lstinline[numbers=none,style=TigerJython]|clear(...)|: Hintergrund auf bestimmte Farbe setzen (Name oder RGB-Code)
\end{itemize}
\end{frame}

\begin{frame}[fragile]{Flächen ausfüllen mit \lstinline[numbers=none,style=TigerJython]|fillPath()|}
\begin{lstlisting}[numbers=none,style=TigerJython]
from gturtle import *
makeTurtle()
...
clear("blue") # blauer Hintergrund
setFillColor(255, 255, 0) # gelber Stern
startPath()
star()
fillPath()
\end{lstlisting}
...
\begin{lstlisting}[numbers=none,style=TigerJython, basicstyle=\ttfamily\scriptsize]
from gturtle import *
import random
makeTurtle()
...
\item Zeichnen Sie das Wappen vom Kanton Zürich (quadratisch). \includegraphics[width=0.1\linewidth]{GrundlagenInfo/00_Programmieren/Figures/Flag_of_Canton_of_Zürich}\definecolor{zhblue}{RGB}{0,112,180} 
 \textcolor{zhblue}{(Farbe ``Züri-Blau'': 0, 112, 180)}
\item Sie ein horizontal dreigeteiltes Wappen (wie etwa das von Frankreich \emoji{flag-france} oder Italien \emoji{flag-italy}).
