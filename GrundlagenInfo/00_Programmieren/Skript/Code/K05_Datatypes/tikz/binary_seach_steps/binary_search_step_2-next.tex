...
\node at (8,0) [rounded corners, minimum width=1cm, minimum height=1cm, draw=blue, thick] {15};
...
\node[above] at (8, 0.5) {\lstinline|mitte|};
\node[above] at (10, 0.5) {\lstinline|rechts|};
\draw[->,red] (0,.5) -- (6,.5);
\draw[decorate,decoration={brace,mirror,amplitude=10pt}] (6,-.5) -- (7,-.5) node[midway, below=5pt] {\emoji{robot}};
\end{tikzpicture}
