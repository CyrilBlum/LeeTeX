...
\lstinputlisting{GrundlagenInfo/00_Programmieren/Skript/Code/K05_Datatypes/summe.py}
\end{myexample}
...
\lstinputlisting{GrundlagenInfo/00_Programmieren/Skript/Code/K05_Datatypes/summe_for_zahl_in.py}
\end{myexample}
...
\begin{myexercise}
    ...
    \begin{myanswer}
\lstinputlisting{GrundlagenInfo/00_Programmieren/Skript/Code/K05_Datatypes/vergroessere_um_fuenf.py}
    \end{myanswer}
\end{myexercise}
...
\lstinputlisting{GrundlagenInfo/00_Programmieren/Skript/Code/K05_Datatypes/findmin.py}
\end{myexample}
...
\begin{myexercise}
    ...
    \begin{myanswer}
        \lstinputlisting{GrundlagenInfo/00_Programmieren/Skript/Code/K05_Datatypes/findmin_index.py}
    \end{myanswer}
\end{myexercise}
...
\begin{myexercise}
    ...
    \begin{myanswer}
        \lstinputlisting{GrundlagenInfo/00_Programmieren/Skript/Code/K05_Datatypes/findminmax_index.py}
    \end{myanswer}
\end{myexercise}
...
\begin{myexercise}
    ...
    \begin{myanswer}
        \lstinputlisting{GrundlagenInfo/00_Programmieren/Skript/Code/K05_Datatypes/count_ten.py}
    \end{myanswer}
\end{myexercise}
...
\lstinputlisting[numbers=left]{GrundlagenInfo/00_Programmieren/Skript/Code/K05_Datatypes/binary_search.py}
...
\begin{myexercise}
    ...
    \begin{myanswer}
        \lstinputlisting{GrundlagenInfo/00_Programmieren/Skript/Code/K05_Datatypes/binary_search_bool.py}
    \end{myanswer}
\end{myexercise}
