...
print("Die Summe der Liste ist:", summe) # gibt 14 aus
\end{lstlisting}
\end{myexample}
...
gesamtpreis = skalarprodukt(m, p)
print("Gesamtpreis:", gesamtpreis)  # gibt 17.1 aus
\end{lstlisting}
    \end{myanswer}
\end{myexercise}
