...
\begin{mysubmission}[Boxenstopp \emoji{fuelpump}]
...
\begin{enumerate}
\item  \lstinline|def fahrzeit_ohne_stopps(strecke_km, geschwindigkeit_kmh)|: Berechnet die reine Fahrzeit \textbf{in Sekunden} und gibt diese per \lstinline|return| zurück.
...
\textbf{Tipp 1}: Schreiben Sie den Code zuerst in VSCode und testen sie ihn erst nachher auf Moodle.
