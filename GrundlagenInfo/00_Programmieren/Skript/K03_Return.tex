...
\begin{enumerate}
\item  \lstinline|def fahrzeit_ohne_stopps(strecke_km, geschwindigkeit_kmh)|: Berechnet die reine Fahrzeit in Sekunden und gibt diese per \lstinline|return| zurück.
