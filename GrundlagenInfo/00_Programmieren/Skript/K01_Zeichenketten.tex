...
\begin{myexercise}
Entwickeln Sie eine Funktion \lstinline|def vigenere(text, key)|, das über die zwei Parameter \lstinline|text| und \lstinline|key| einen Geheimtext sowie einen Schlüssel entgegennimmt. Das Programm soll den Geheimtext mit der Vigenère-Chiffre und mit dem Schlüssel entschlüsseln.
\end{myexercise}
