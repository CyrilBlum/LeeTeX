...
\end{myexample}
\begin{mysubmission}
Schreiben Sie eine Python-Funktion \lstinline|def schaltjahr(jahr)|, welche berechnet, ob das aktuelle Jahr \lstinline|jahr| ein Schaltjahr ist. 2024 ist ein Schaltjahr, 2028 ebenso, sowie auch 2032, 2036, 2040 etc. (alle 4 Jahre). Um zu überprüfen, ob eine Zahl durch 4 teilbar ist, können Sie den Modulo-Operator (\% verwenden).
\begin{myanswer}
