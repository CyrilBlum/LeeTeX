...
\begin{enumerate}
	\item Öffnen Sie ein neues Terminal-Fenster, indem Sie zunächst die Spotlight-Suche mit \keys{\cmd+\space} (\keys{\cmd} +  Leertaste) öffnen. In der Spotlight-Suche müssen Sie nun den Suchbegriff \texttt{Terminal} eingeben und schliesslich die Suchanfrage mit Drücken der Taste \keys{\return} (ENTER-Taste) ausführen.
