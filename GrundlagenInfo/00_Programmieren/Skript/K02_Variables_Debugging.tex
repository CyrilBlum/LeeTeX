...
\begin{mychallenge}
	...
	\begin{myanswer}
		\lstinputlisting[language=Python,caption=\texttt{banana.py},label=listing:banane,numbers=none]{GrundlagenInfo/00_Programmieren/Skript/Code/K02_Variables/banana.py}
	\end{myanswer}
\end{mychallenge}
...
\begin{mychallenge}\label{ex:sToY}
	...
	\lstinline|"123456789 Sekunden sind 3 Jahre, 333 Tage, 21 Stunden, 33 Minuten, 9 Sekunden!"|
