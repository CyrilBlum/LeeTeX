...
\begin{myexercise}\label{ex:name}
	Schreiben Sie ein Programm, das Sie nach Ihrem Namen fragt. Verwenden Sie dazu die Funktion \lstinline|name = input(...)|. Danach soll Sie das Programm neun Mal begrüssen, indem es auf 3 Zeilen je dreimal den Text ``\texttt{Hallo [Ihr Name]}'' druckt.
	\begin{myanswer}
		\begin{lstlisting}
