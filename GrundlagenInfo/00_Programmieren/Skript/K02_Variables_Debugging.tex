...
\begin{table}[H]
	...
	\begin{tabular}{c|p{6cm}}
		\textbf{Befehl}        & \textbf{Bedeutung}                                                                                                \\\midrule
...
\begin{mysubmission}\label{ex:herz}
	...
	\begin{myanswer}
		\lstinputlisting[language=Python,caption=\texttt{herz.py},label=listing:herz,numbers=none]{GrundlagenInfo/00_Programmieren/Skript/Code/K02_Variables/herz.py}
	\end{myanswer}
\end{mysubmission}
