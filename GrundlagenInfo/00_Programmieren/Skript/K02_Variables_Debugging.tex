\chapter{Variablen, Datentypen \& Debugging}\label{ch:K01Variables}
...
\lstinputlisting[language=Python,caption=\texttt{mit\_variable.py},label=listing:mitVariable]{GrundlagenInfo/00_Programmieren/Skript/Code/K02_Variables/mit_variable.py}
