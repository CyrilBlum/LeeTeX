...
Viel besser ist es, wenn wir der Seitenlänge des Quadrats einen Namen geben. Genau dies haben wir in \cref{listing:mitVariable} getan: Wir haben der Länge den Namen \pythoninline{L} gegeben.
...
Der Ausdruck \pythoninline{L} ist ein Beispiel einer sogenannten \textbf{Variable}.
\end{myexample}
...
\begin{mysummary}[Variablennamen]
	...
	\begin{enumerate}
		...
		\item Die Variablennamen müssen in einem Wort geschrieben werden. Falls ein Name aus zwei oder mehr Worten gewählt wird, sollte die Variable durch ein \textit{Underscore} (\_) getrennt werden.
