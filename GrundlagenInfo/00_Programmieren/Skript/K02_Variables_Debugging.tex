...
\begin{myoverview}[Benennung von Variablen]
	...
	\begin{enumerate}
		...
		\item Der Name sollte ein \textbf{sinnvoller} und \textbf{beschreibend} (deskriptiv) sein. Wenn Sie beispielsweise die Höhe eines Hauses in einer Variable speichern, ist es sinnvoll, diese \lstinline|h| oder \lstinline|hoehe| zu nennen und nicht etwa \lstinline|x|.
...
\end{itemize}
Für mehr Details zur Division mit Rest siehe \cref{sec:DivisionMitRest} in \cref{ch:Details}.
\end{mydefinition}
