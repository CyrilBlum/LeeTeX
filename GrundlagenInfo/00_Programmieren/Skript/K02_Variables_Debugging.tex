...
\begin{myexercise}\label{ex:spirale-increment}
	...
	\lstinputlisting[language=Python,caption=\texttt{spirale.py},label=listing:spirale_fill]{GrundlagenInfo/00_Programmieren/Skript/Code/K02_Variables/spirale_fill.py}
