...
\begin{myanswer}
	\lstinputlisting[language=Python,caption=\texttt{banana.py},label=listing:herz,numbers=none]{GrundlagenInfo/00_Programmieren/Skript/Code/K02_Variables/banana.py}
\end{myanswer}
\end{mychallenge}
