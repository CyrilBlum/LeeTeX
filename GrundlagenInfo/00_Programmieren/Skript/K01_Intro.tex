...
Dabei wird \pythoninline{for _ in range(15):} der \textit{Schleifenkopf}\index{Schleife!Kopf einer}, die vier Zeilen (6 -- 9) werden \textit{Schleifenkörper}\index{Schleife!Körper einer} genannt. Der Schleifenkörper ist (in Python) daran erkennbar, dass er relativ zu dem Schleifenkopf nach rechts eingerückt (Englisch: \textit{indented}) ist. Diese Einrückung erreichen wir in VSCodium durch das einfache Drucken der Tabulator-Taste (\keys{\tab}).
