...
\lstinputlisting[language=Python, numbers=left]{GrundlagenInfo/00_Programmieren/Skript/Code/K01_Intro/treppe_naiv.py}
...
\begin{myoverview}[Zusammenfassung nützlicher \texttt{turtle}-Befehle]
\begin{table}[H]
\centering
\begin{tabular}{lll}
\midrule
...
\lstinline|t.end_fill()| & \lstinline|t.end_fill()| & Ende des Füllbereichs (füllt gezeichnete Fläche) \\
...
\lstinline|t.speed(x)| & \lstinline|t.speed(x)| & setzt die Zeichen-Geschwindigkeit (\lstinline|0| = schnellste) \\
...
\lstinline|t.tracer(False)| & \lstinline|t.tracer(False)| & zeigt direkt das Resultat (ohne Animation) \\
\midrule
\end{tabular}
\end{table}
\end{myoverview}
