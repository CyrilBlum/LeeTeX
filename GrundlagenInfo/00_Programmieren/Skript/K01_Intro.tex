...
In Python lassen sich einfache Rechenoperationen ähnlich wie bei einem Taschenrechner angeben. Dabei hält sich auch Python an die üblichen Konventionen wie \enquote{Punkt vor Strich}. Symbole für die arithmetische Operationen sind in \cref{tab:arithm-op} zusammengefasst.
