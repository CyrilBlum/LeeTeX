...
\begin{enumerate}
	...
	\item Geben Sie folgende Code-Zeile ein und führen Sie diese aus (indem Sie mit der \keys{\return}-Taste bestätigen):
        ...
        \end{lstlisting}
\end{enumerate}
\textcolor{Red}{Folgen Sie den Instruktionen, welche \texttt{brew} Ihnen im Terminal gibt!}
...
\begin{center}
	\texttt{Hello, World!}
\end{center}
auf der Konsole (Englisch: \texttt{terminal}), also im unteren Fenster, auszugeben\footnote{\url{https://de.wikipedia.org/wiki/Hallo-Welt-Programm}}.
