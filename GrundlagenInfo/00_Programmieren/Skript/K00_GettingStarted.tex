...
Öffnen Sie das Programm \texttt{PowerShell} (Sie können mit dem \keys{\faWindows}-Taste danach suchen) \textcolor{Red}{\textbf{als Administrator}}. Bei uns sieht die Situation aus wie in \cref{fig:PowerShell}.
\begin{figure}[H]
	\centering
