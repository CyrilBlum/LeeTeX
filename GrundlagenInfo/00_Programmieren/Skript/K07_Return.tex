...
\begin{myexercise}
Packen Sie Ihre Lösung aus \cref{ex:myexercise:Haus} in eine Funktion mit dem Namen \lstinline|def haus():|. Testen Sie zunächst, ob die  Funktion wirklich das gewünschte Resultat liefert (ein Haus) indem Sie die Funktion aufrufen. Schreiben Sie dann eine zweite Funktion \lstinline|def haeuserreihe():|, welche eine Häuserreihe aus 5 Häusern zeichnet, indem \lstinline|haus()| fünfmal aufgerufen wird.
