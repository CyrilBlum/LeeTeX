...
\section{Umrechnung von Basis $a$ zu Basis $b$ in Python}
Es sei
\begin{align*}
...
\begin{align*}
	x = x'_mx'_{m-1}\ldots x'_2x'_1x'_0 = x'_nb^n + x'_{n-1}b^{n-1} + \ldots + x'_2b^2 + x'_1b^1 + x'_0b^0
\end{align*}
...
\clearpage
\lstinputlisting[language=Python,caption=\texttt{base\_a\_to\_base\_b.py},label=listing:base_a_to_base_b]{GrundlagenInfo/00_Programmieren/Skript/Code/K03_Functions/base_a_to_base_b.py}
