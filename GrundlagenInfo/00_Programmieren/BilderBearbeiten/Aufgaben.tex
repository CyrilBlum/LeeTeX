...
\begin{enumerate}
	\item Erstellen Sie auf Ihrem eigenen Rechner einen neuen Ordner \emoji{file-folder} mit dem Namen
	      \begin{center}
		      {\tt BilderBearbeiten}.
	      \end{center}
	\item Laden Sie die Datei {\tt daten.zip} von Moodle herunter, und zwar so, dass die Datei {\tt daten.zip} in dem neu angelegten Ordner {\tt BilderBearbeiten} abgespeichert ist.
	\item Die Datei {\tt daten.zip} ist komprimiert und muss nun zuerst entpackt werden. Entpacken geht ganz einfach so:
	      \begin{description}
