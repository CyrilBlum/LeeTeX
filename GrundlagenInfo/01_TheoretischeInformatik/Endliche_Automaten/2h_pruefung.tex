...
% name of the class
\newcommand{\myclass}{Klasse 2h}
% set date
\newcommand{\mydate}{13. Januar 2025}
...
\begin{questions}
	...
	Es sei $\Sigma = \lrc{0, 1, 7, 4}$ ein Alphabet und $n$ eine gegebene natürliche Zahl. Bestimmen Sie die Anzahl der verschiedenen Wörter der Länge $n$ über $\Sigma$, welche das Teilwort $4$ enthalten.
	\begin{solution}
