...
\begin{align}\label{eq:division_mit_rest}
	a = bq + r
\end{align}
und $0\leq r < b$.
...
\begin{myexcursion}\label{myexcursion:finite_n}
...
\end{lstlisting}
	\begin{myanswer}
		\lstinputlisting[language=Python,caption=\texttt{sieb.py},label=listing:sieb]{GrundlagenInfo/01_TheoretischeInformatik/Randomisierte_Algorithmen/Skript/Code/sieb.py}
	\end{myanswer}
\end{myexercise}
...
\begin{myexercise}[Implementation von Verbesserung 1]\label{myexercise:implementVerbesserung1}
	...
	\begin{myanswer}
		\lstinputlisting[language=Python,caption=\texttt{sieb\_verbesserung\_1.py},label=listing:sieb_verbesserung_1]{GrundlagenInfo/01_TheoretischeInformatik/Randomisierte_Algorithmen/Skript/Code/sieb_verbesserung_1.py}
	\end{myanswer}
\end{myexercise}
...
\begin{mychallenge}[Implementation von Verbesserung 2]\label{myexercise:implementVerbesserung2}
	...
	\begin{myanswer}
		\lstinputlisting[language=Python,caption=\texttt{sieb\_verbesserungen\_1\_und\_2.py},label=listing:sieb_verbesserungen_1_und_2]{GrundlagenInfo/01_TheoretischeInformatik/Randomisierte_Algorithmen/Skript/Code/sieb_verbesserungen_1_und_2.py}
	\end{myanswer}
\end{mychallenge}
...
\begin{aenum}
	...
	\end{align*}
	Mithilfe von \cref{eq:division_mit_rest} (Division mit Rest), können wir auf eindeutige Weise schreiben:
	\begin{align*}
