...
\lstinputlisting[language=Python,caption=\texttt{protokoll.py},label=listing:protokoll]{GrundlagenInfo/01_TheoretischeInformatik/Randomisierte_Algorithmen/Skript/Code/protokoll.py}
