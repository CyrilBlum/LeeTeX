...
\tib{Basisgrössen}\index{Basisgrössen} verwendet. \enquote{Basisgrössen} bedeuten in diesem Kontext für Symbole, die gewisse Mengen, bzw. Zahlen repräsentieren, und dies unabhängig vom Objekt, das gezählt wird. eine Die Römer verwendeten die sieben verschiedenen Basisgrössen:
\begin{center}
