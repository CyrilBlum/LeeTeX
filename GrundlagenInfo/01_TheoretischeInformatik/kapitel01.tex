...
\begin{mychallenge}
	Es sei $n>0$ eine natürliche Zahl. Es sei $z$ die grösste $n$-stellige Binärzahl? Finden Sie eine möglichst einfache Darstellung von $z$.
	\begin{myanswer}
		Die grösste $n$-stellige Binärzahl $z$ ist gegeben durch
		\begin{align*}
			z := \underbrace{1\ldots 11_2}_{n-\text{Stellen}} = 1\codt 2^0 + 1\cdot 2^1 + 1\cdot 2^2 + \ldots + 1\cdot 2^{n-1}.
		\end{align*}
		...
		\begin{align*}
			z+1 = 0\cdot 2^0 + 0\cdot 2^1 + \ldots + 0\cdot 2^{n-1} + 1\cdot 2^n = 2^n.
		\end{align*}
