\begin{frame}
    ...
    \textbf{Lektion 3} \emoji{computer}: \textbf{Wie Zahlen im Computer gespeichert werden}
\end{frame}



\begin{frame}{Stellenwertdarstellung \& $\alpha$-adische Zahlensysteme}
\begin{itemize}
...
\begin{itemize}[<+->]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[keepaspectratio, width=0.75\paperwidth, height=\paperheight]{GrundlagenInfo/DataScience/01_Zahlensysteme/Figures/4-ex132.png}
    \end{figure}
\end{itemize}
\end{frame}
