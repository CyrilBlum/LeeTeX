...
% \end{center}
% \begin{example}\label{example:roman}
...
%
% \begin{example}\label{example:not_unique}
...
\begin{myexercise}[]\label{myexercise:001}
  ...
  \end{myanswer}
\end{myexercise}
Siehe zudem \cref{myexercise:001}.
...
\begin{mysubmission}\label{mysubmission:005}
  wuhuuu 
\end{mysubmission}
Siehe zudem \cref{mysubmission:005}.
\begin{table}[H]
  \centering
  \begin{tabular}{c|l}
...
\begin{mychallenge}\label{mychallenge:1}
  super hard 
\end{mychallenge}
Siehe \cref{mychallenge:1}

\begin{myexample}\label{myexample:first}
okkiii  
\end{myexample}
siehe \cref{myexample:first}
