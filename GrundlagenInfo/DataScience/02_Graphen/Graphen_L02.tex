...
\begin{frame}{Wiederholung letztes Mal: Knoten und Kanten}
    Knoten und Kanten \\[.5cm]
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[keepaspectratio, width=.7\linewidth]{GrundlagenInfo/DataScience/02_Graphen/Figures/4-graph.png}
        \end{figure}
        \end{minipage}
...
\begin{frame}{Wiederholung letztes Mal: Vollständige Graphen}
    ...
    \end{itemize}
            \begin{figure}[H]
            \centering
            \includegraphics[keepaspectratio, width=.3\linewidth]{GrundlagenInfo/DataScience/02_Graphen/Figures/4-graph.png}
        \end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[keepaspectratio, width=.5\paperwidth]{GrundlagenInfo/DataScience/02_Graphen/Figures/graphen-bin.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[keepaspectratio, width=.4\paperwidth]{GrundlagenInfo/DataScience/02_Graphen/Figures/graphen-gerichtet.png}
\end{figure}
\textbf{Nachbarschaftsmatrix} (= Tabelle) des Graphen:
\begin{table}[H]
\begin{tabular}{c||c|c|c|c|c|c}
        & Anna & Beatrice & Ivan & James & Peter & Ulla \\ \midrule
Anna     & 0 & 1 & 0 & 1 & 1 & 0 \\ \hline
Beatrice & 1 & 0 & 1 & 1 & 0 & 1 \\ \hline
Ivan     & 0 & 0 & 0 & 1 & 0 & 1 \\ \hline
James    & 0 & 0 & 0 & 0 & 0 & 0 \\ \hline
Peter    & 1 & 1 & 0 & 1 & 0 & 1 \\ \hline
Ulla     & 0 & 1 & 0 & 1 & 1 & 0 \\
\end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[keepaspectratio, width=.8\linewidth]{GrundlagenInfo/DataScience/02_Graphen/Figures/graphen-baeume.pdf}
\end{figure}
}
...
\begin{frame}{\emoji{deciduous-tree} Gerichtete Bäume}
    \begin{figure}[H]
    \centering
    \includegraphics[keepaspectratio, width=\linewidth]{GrundlagenInfo/DataScience/02_Graphen/Figures/binary-tree.pdf}
\end{figure}
\begin{itemize}[<+->]
