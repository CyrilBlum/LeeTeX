...
\begin{frame}[fragile]{Wiederholung letztes Mal: Angriff auf Vigenère}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			\scriptsize
			\item<2-5> 2 Gruppen: \texttt{\colorstring[brown,red]{MUZ KJL QPA WJU MHY IIL LCZ AUP MRL ZHL SVC 
							MTZ BCU LGU PCI MPD QGT IPC QIL VGY MGU BUJ 
							PNB MUZ MNA PGY HNP KJL OTH BWS IVP WPK IHB}}
			\item<3-5> 3 Gruppen: \texttt{\colorstring[brown,red,green]{MUZ KJL QPA WJU MHY IIL LCZ AUP MRL ZHL SVC 
			MTZ BCU LGU PCI MPD QGT IPC QIL VGY MGU BUJ
			PNB MUZ MNA PGY HNP KJL OTH BWS IVP WPK IHB}}
			\item<4-5> 4 Gruppen: \texttt{\colorstring[brown,red,green,yellow]{MUZ KJL QPA WJU MHY IILLCZ AUP MRL ZHL SVC MTZ BCU LGU PCI MPD QGT IPC QIL VGY MGU BUJ PNB MUZ MNA PGY HNP KJL OTH BWS IVP WPK IHB}}
			\item<5> ...
		\end{itemize}
	...
	\only<6>{		
		\texttt{\colorstring[brown,red,green]{MUZ KJL QPA WJU MHY IIL LCZ AUP MRL ZHL SVC 
		MTZ BCU LGU PCI MPD QGT IPC QIL VGY MGU BUJ 
		PNB MUZ MNA PGY HNP KJL OTH BWS IVP WPK IHB}}
		
		$\rightarrow$ Häufigster Buchstaben pro Gruppe: \textcolor{brown}{M}, \textcolor{red}{G}, \textcolor{green}{L}
