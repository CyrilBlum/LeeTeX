...
\begin{frame}[fragile]{\gls{ERM}: Übungen}
  ...
  \begin{itemize}
	...
	\item  TODO bessere Übungen hinzufügen...
  \end{itemize}
\end{frame}
...
\end{table}
\begin{center}
\textbf{Frage}: Weshalb hat (fast) jede Tabelle einen Primärschlüssel (=ID)?
\end{center}
\end{frame}
...
\end{table}
\begin{center}
\textbf{Frage}: Weshalb könnten Fremdschlüssel benötigt werden?
\end{center}
\end{frame}
...
\end{column}
\end{columns}
\textbf{Frage}: Wie können wir Kolonne ``Abteilung'' zur Tabelle ``Angestellte'' hinzufügen?
\end{frame}
...
\begin{frame}[fragile]{Auftrag}
  Skript (Moodle)
  \begin{itemize}
    \item \aufgabebox{Aufgabe 2.55}
    \item \aufgabebox{Aufgabe 2.57}
    \item \abgabebox{Abgabe 2.58}
    \item \challengebox{Aufgabe(n) 2.61}
    \item Aufgaben und Abgaben in Kapitel 2.4
  \end{itemize}
\end{frame}
