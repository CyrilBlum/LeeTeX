...
\begin{aufgabe}{a1}
\begin{itemize}
\item \emoji{up-arrow} \textcolor{red}{\textbf{Abgabe}}: Geben Sie das grösste Mitglied in jeder Stadt aus
...
\item \textcolor{red}{\textbf{Abgabe}} Geben Sie die Stadtnamen aus, wo die meisten Mitglieder mit einem ``a'' im Namen wohnen (nur die ersten drei Zeilen).
\begin{lstlisting}[style=sql]
SELECT city, COUNT(*) 
FROM users 
WHERE name LIKE "%a%" 
...
\subsection{Daten einfügen: \lstinline[style=sql]|INSERT INTO|}

Mit \lstinline[style=sql]|INSERT INTO| können neue Zeilen in eine bestehende Tabelle eingefügt werden.
