...
\begin{enumerate}
	...
	\end{itemize}
	\item \textcolor{RoyalBlue}{AdministratorIn}: Die neuen Accounts der \textcolor{ForestGreen}{BenutzerInenn} muss dann von Ihnen als \textcolor{RoyalBlue}{AdministratorIn} aktiviert werden, indem Sie den User suchen, auf ``Bearbeiten'' und dann ganz unten auf ``Account ist freigeschaltet'' klicken.  
	\item \textcolor{RoyalBlue}{AdministratorIn} und \textcolor{ForestGreen}{BenutzerIn}: Posten Sie nun Bilder in den sozialen Netzwerken Ihrer Kollegen, vergeben Sie Likes, folgen Sie anderen und kommentieren Sie fleissig in den anderen Netzwerken, damit wir die nächsten Aufgaben durchführen können. Dazu müssen Sie zuerst den Namen Ihres Hubs in den Zusammenarbeitsbereich reinschreiben. Jeder muss zumindestens 1 Like, 1 Foto und 1 Kommentar eines Users in seinem eigenen sozialen Netzwerk haben. Sie können auch nach anderen UserInnen suchen.
\end{enumerate}
