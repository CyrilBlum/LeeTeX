...
Die Tabelle \texttt{users} wurde beispielsweise mit folgendem Befehl erstellt:
...
\begin{itemize}
	\item \lstinline[style=sql]|NOT NULL|: Feld darf nicht leer sein.
...
\begin{aufgabe}{}
Erstellen Sie einen neuen Eintrag für eine Person mit folgenden Eigenschaften:... 
\end{aufgabe}
...
...
\subsection{Daten löschen: \lstinline[style=sql]|DROP|}
...
