...
\begin{enumerate}
	...
	\end{figure}
	\item \textcolor{RoyalBlue}{AdministratorIn}: Geben Sie folgende Angaben ein (s. Bild unten):
	\begin{itemize}
	...
	\end{figure}	
	\item Sobald ich als Lehrperson die Accounts aktiviert habe, können Ihre Kollegen als \textcolor{ForestGreen}{BenutzerInnen} Ihrem sozialen Netzwerk betreten, indem sie folgende URL eingeben: \url{https://namedesnetzwerks.instahub.org} (im Beispiel oben wäre das \url{https://purpurrot21.instahub.org}) und können dort einen Account erstellen, bzw. sich anmelden.
	\begin{itemize}
