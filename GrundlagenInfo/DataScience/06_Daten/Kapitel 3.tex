...
Wie wir sehen, wurden Informationen aus beiden Tabellen zusammengeführt, indem alle möglichen Kombinationen beider Tabellen erstellt wurden. Die beiden gleichnamigen Kolonnen erhalten zusätzlich einen Präfix (vorausgehenden Text) mit dem Namen der Ursprungstabelle, um diese voneinander abzugrenzen. 
\end{myexample}
...
\begin{myremark}
Statt zwei Tabellen können auch drei oder mehr Tabellen nach den oben erklärten Prinzipien miteinander verbunden werden.
\end{myremark}
