...
\end{lstlisting}
\end{myantwort}
\item Geben Sie jede Benutzerrolle nur einmal aus.
\begin{myantwort}
\begin{lstlisting}[style=sql]
...
\begin{itemize}
\item \abgabebox{Aufgabe 2.28 $\rightarrow$ Abgabe (Moodle, L02)}\\
\textbf{Tipps:}
\begin{itemize}
\item Berechnen Sie zuerst die Anzahl Einwohner pro Stadt
\item Beschränken Sie danach ihren Befehl auf Benutzer, die ein ``n'' im Namen haben
\end{itemize}
\item \abgabebox{Aufgabe 2.30 $\rightarrow$ Abgabe (Moodle, L02)}
\item \readbox{2.2.11}
\item \aufgabebox{Lösen Sie Aufgabe 2.31}
\item \challengebox{Aufgaben 2.32, 2.33}
\end{itemize}
\end{frame}
