...
\begin{mycaution}
  Wie Sie anhand von \cref{myexample:in} und \cref{myexample:between} sehen, spielt es in SQL eine Rolle, ob  wir Zahlen oder
  Text filtern: Wenn nach einem Text gefiltert wird, muss dieser in Anführungszeichen stehen (wie z.B.
  \lstinline[style=sql]|"Berlin"| in \cref{myexample:in}). Bei Zahlen ist dies nicht nötig (s. z.B. die Zahl
  \lstinline[style=sql]|172| in \cref{myexample:between}).
\end{mycaution}
