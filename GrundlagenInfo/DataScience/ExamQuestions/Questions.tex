...
\foreach \stadt/\bspnummer/\bspname/\filestadt/\fgwdth/\tikzStadt/\solB/\solC/\solD in {Winterthur/6/Wülflingen/Winterthur/.75/\tikzWinti/{Ja, es gibt einen Euler'schen Weg, beispielsweise 1-6-5-1-2-3-7-1-4-6. Es gibt viele Hamilton'sche Kreise, beispielsweise 7-3-2-1-4-6-5-1.}/{Der Grad des Grafen ist 5.}/\matrixWinti, Bern/I/Innere Stadt/Bern/.95/\tikzBern/{Ja, der Graph enthält den Euler'schen Weg IV-I-V-IV-III-I-II-III-VI-II-V. Der Graph enthält viele Hamilton'sche Wege, beispielsweise VI-II-III-I-V-IV.}/{Der Grad des Grafen ist 4.}/\matrixBern}{
\question{\textbf{Stadtteile von \stadt}}\\
Sie betrachten folgende Karte der Stadtteile von \stadt.\\
\begin{figure}[H]
	\centering
	\includegraphics[width=\fgwdth\textwidth]{GrundlagenInfo/DataScience/ExamQuestions/Figures/Karte_\filestadt_Stadtkreise}
\end{figure}
\begin{parts}
\part[2] Zeichnen Sie die Karte als Graphen, wobei jeder Stadtteil ein Knoten sein soll und zwischen zwei Knoten jeweils eine Kante besteht, sofern es die zwei Stadtteile aneinandergrenzen. Als Namen der Knoten können Sie einfach die Kreis-Zahl eintragen (also z.B. ``\bspnummer'' für \bspname).
\begin{solution}
\begin{figure}[H]
\centering
\tikzStadt
\end{figure}
\end{solution}
\part[2] Gibt es  auf diesem Graphen einen Euler'schen Weg? Gibt es einen Hamilton'schen Kries?
\begin{solution}
\solB
\end{solution}
