...
\begin{frame}[fragile]
  \begin{itemize}
    \item Alice generiert ein Paar von Schlüsseln: einen öffentlichen Schlüsel und einen privaten Schlüssel (Geheimnis), welche miteinander in einem Zusammenhang stehen.
