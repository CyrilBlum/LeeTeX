...
\begin{frame}[label=repetition2]
	...
	\begin{figure}[H]
		...
		\raisebox{-0.5\height}{\resizebox{.35\linewidth}{!}{\Ceasar[2]}}
...
\begin{frame}[label=keyFixed]{Angriff auf Vigenère: Bekannte Schlüssellänge}
	...
	\begin{figure}[H]
	        \centering
	        \raisebox{-0.5\height}{\includegraphics[width=.45\textwidth]{GrundlagenInfo/DataScience/03_Kryptologie/Figures/friedmann1-geheimtext.png}}
	        \raisebox{-0.5\height}{$\rightarrow$}
	        \raisebox{-0.5\height}{\includegraphics[width=.45\textwidth]{GrundlagenInfo/DataScience/03_Kryptologie/Figures/friedmann1-klartext.png}}
	\end{figure}}
\end{frame}
...
\begin{frame}{Friedmann'sche Charakteristik: Beispiel}
