...
%\begin{table}[H]
	\begin{longtable}{@{}l|p{5.3cm}||p{10cm}|p{10cm}@{}}
		...
		& Datenschutz                           & Was sind anonymisierte Daten? Welche Informationen können gemäss Buch selbst aus anonymisierten Daten herausgelesen werden?                                                                                                                                                                                                                                             & Recherchieren Sie, was das Internet über Sie weiss. Suchen Sie insbesondere nach "Data Breaches in Switzerland". Präsentieren Sie die Ergebnisse der Klasse                                                                                                            \\\cmidrule(l){2-4} 
		& Mikromanipulatio \& Psychologie       & Was ist Mikro-Manipulation? Wie werden wir im Alltag durch Daten (mikro-)manipuliert?                                                                                                                                                                                                                                                                                   & Finden Sie 5 Lebensbereiche, in denen Sie manipuliert werden.                                                                                                                                                                                                          \\\cmidrule(l){2-4} 
		& Politische Einflussnahme              & Was sagt das Buch dazu, inwiefern Daten politische Prozesse beeinflussen können?                                                                                                                                                                                                                                                                                        & Recherchieren und Präsentieren Sie die Rolle von Cambridge Analytics im Trump-Wahlkampf.                                                                                                                                                                               \\\cmidrule(l){2-4} 
		& Bewertungen \& Bürger-Rating          & Fassen Sie Ihre Erkenntnisse sowie die Aussagen aus dem Buch zum Thema Bewertungen zusammen.                                                                                                                                                                                                                                                                            & Recherchieren Sie, was der Sesame Score ist. Wie hat sich die Chinesische Bürger-Bewertung seit 2019 (Erscheinungsdatum des Buches) verändert?                                                                                                                         \\\midrule\midrule
		...
		\multirow{2}{*}{Kunst}        & Fake Kunst \& Manipulation            & Erläutern Sie das Thema "social proof" anhand der im Buch aufgeführten Beispiele für Streaming-Dienste.                                                                                                                                                                                                                                                                 & Finden Sie 2 weitere Beispiele für social proof mit Bezug zur Informatik. Dabei kann es sich auch um Beispiele aus der Finanzwelt handeln (z.B. Bitcoin \& Social Proof, Game Stop Hype \& Social Proof etc.).                                                         \\\cmidrule(l){2-4} 
...
\newpage
\section{Auftrag}
Lesen Sie im Buch ``Hello World'' die folgenden Kapitel: 
...
Machen Sie sich Notizen zu jedem Kapitel (worum geht es? Was ist Ihnen geblieben? Was versehen Sie / nicht? etc.). 
...
Die Gruppenarbeit (Punkt 1), die Zusammenfassung (Punkt 2b) sowie das Peer Review (Punkt 2c) zählen gemeinsam als \textit{eine schriftliche Note} (Beitrag jeweils ein Drittel). Die Präsentation macht die mündliche Note des Semesters aus und zählt wie eine \textit{halbe schriftliche Prüfung}.
...
\end{itemize}
Halten Sie schriftlich fest, was Sie diskutiert haben.
...
\begin{itemize}
	...
	\item (1 Pt) Mindestens eine \textbf{Illustration} (Bild, Diagramm, Grafik, usw.)
...
Sie führen einen Vortrag einzeln zu Ihrem Unter-Thema Ihrer Wahl durch (s. Abschnitt \ref{sec:themen}). Als Begleitmaterial zum Vortrag erstellen Sie eine Präsentation sowie eine Zusammenfassung, welche Sie vorgängig abgeben.
...
\begin{itemize}
	\item Dauer der Präsentation: \textbf{10-15 Minuten}
...
Im Anschluss an den Vortrag findet eine Diskussionsrunde (ca. 20 Minuten) statt. Jede/r SchülerIn der Gruppe (s. nächster Abschnitt) tut sich mit ca. sechs ZuhörerInnen zusammen und leitet die Gruppe. Dabei werden offene Fragen des Publikums beantwortet. Ausserdem werden kontroverse Fragen, welche die Gruppe vorbereitet hat, in Bezug auf das Unter-Thema diskutiert.

Die Ergebnisse der Diskussion werden von der Gruppenleitung protokolliert und im Anschluss an die Diskussion kurz zusammengefasst.
