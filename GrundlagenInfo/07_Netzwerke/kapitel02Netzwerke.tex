...
Die Kommunikation über das Internet verläuft in unterschiedlichen Teilschritten. Man spricht von dem \textit{Schichtenmodell}. Als Analogie zum Schichtenmodell sei folgende Situation gegeben, in der die Chefs zweier unterschiedlicher Firmen miteinander kommunizieren wollen (siehe \cref{fig:schichtenmodell_analogie}):
\begin{enumerate}
