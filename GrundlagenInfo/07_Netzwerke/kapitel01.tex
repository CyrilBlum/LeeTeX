...
\rowcolor{orange!20}\multicolumn{2}{c}{\textbf{Nutzdaten}} \\ \midrule
...
\begin{mysubmission}
Erledigen Sie Aufgaben 2.1 - 2.3 im Filius-Workshop: \href{https://informatik.mygymer.ch/base/?page=network/2-filius/1-peer/}{Link} (Credits: Gymnasium Kirchenfeld)
...
\end{tabular}
\end{table}
Um herauszufinden, welche IP-Adresse zum selben Netzwerk gehören, darf man die ursprüngliche IP-Adresse so verändern, dass alle stellen, an denen binär in der Subnetzmaske eine Null steht, eine Eins sein dürfen. Dies bedeutet, dass alle IP-Adressen, welche mit \texttt{159.233.1.[...]} anfangen zu diesem Netzwerk dazugehören.
\end{myexample}
...
\begin{mysubmission}
Erledigen Sie Aufgaben 2.4 - 2.6 im Filius-Workshop: \href{https://informatik.mygymer.ch/base/?page=network/2-filius/4-client-server/}{Link}. Laden Sie Ihre Lösungen als \texttt{.fls}-Dateien auf Moodle hoch.
\end{mysubmission}
...
Lösen Sie Aufgaben 2.7-2.9 auf folgendem \href{https://informatik.mygymer.ch/base/?page=network/2-filius/7-web/}{Link}. Laden Sie Ihre Lösungen als \texttt{.fls}-Dateien auf Moodle hoch.
\end{mysubmission}

\begin{mysubmission}[DNS-Server]
Lösen Sie Aufgaben 2.10-2.12 auf folgendem \href{https://informatik.mygymer.ch/base/?page=network/2-filius/A-dns/}{Link}. Laden Sie Ihre Lösungen als \texttt{.fls}-Dateien auf Moodle hoch.
\end{mysubmission}
...
Lösen Sie Aufgabe 2.13 auf folgendem \href{https://informatik.mygymer.ch/base/?page=network/2-filius/D-problems/}{Link}. Laden Sie Ihre Lösungen als \texttt{.fls}-Dateien auf Moodle hoch.
\end{mysubmission}
