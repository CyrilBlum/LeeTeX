...
\begin{mysubmission}
Erledigen Sie Aufträge 2.1 - 2.3 im Filius-Workshop: \href{https://informatik.mygymer.ch/base/?page=network/2-filius/1-peer/}{Link} (Credits: Gymnasium Kirchenfeld)
...
\begin{mysubmission}
Lösen Sie die Aufgaben 2.10-2.12 auf folgendem \href{https://informatik.mygymer.ch/base/?page=network/2-filius/A-dns/}{Link}. Laden Sie Ihre Lösungen als \texttt{.fls}-Dateien auf Moodle hoch.
\end{mysubmission}

\subsubsection{nslookup}
Mit dem Befehl \texttt{nslookup} kann nachgeschaut werden, welche IP-Adresse zu einer bestimmten Webseite gehört. 
...
\section{Netzwerk-Modellierung mit Filius}
