...
\end{myanswer}
\end{myexercise}
Wie wir in Übung ... gesehen haben, gibt es zu wenige Adressen bei IPv4. Daher wird IPv4 graduell durch einen neuen Standard abgelöst, \textbf{IPv6}, in welchem jede Adresse über 128 Bytes verfügt, womit fast unendlich viele Geräte addressiert werden können.
