...
\end{itemize}
\begin{myexercise}
Finden Sie Ihre eigene IP-Adresse heraus\\
\textbf{Tipp}: Verwenden Sie den Befehl \texttt{ipconfig} im Terminal / cmd
\end{myexercise}
\end{frame}


\begin{frame}[fragile]{Aufträge (Skript) \emoji{computer}}
\begin{myexercise}
Installieren Sie Filius. MacOS: \qrcode[height=1cm]{https://moodle.ksimlee.ch/pluginfile.php/58667/mod_resource/content/1/Anleitung%20Filius.pdf} Windows: \qrcode[height=1cm]{https://informatik.mygymer.ch/base/?page=network/2-filius/windows/}
\end{myexercise}
\begin{mysubmission}
Aufträge 2.1 - 2.3 (\textbf{Abgabe auf Moodle}): \qrcode[height=1cm]{https://informatik.mygymer.ch/base/?page=network/2-filius/1-peer/}

\end{mysubmission}
\begin{mychallenge}
Lösen Sie die Port-Aufgaben auf folgendem Link: \qrcode[height=1cm]{https://www.inf-schule.de/rechnernetze/anwendung/socketprogrammierung/Anfragen_an_einen_Server_Stellen}.
\end{mychallenge}
\end{frame}
...
\item Router
\begin{itemize}
\item \aufgabebox{1.14 (Link lesen)}
\item \abgabebox{1.15 (Filius, Abgabe auf Moodle)}
\end{itemize}
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Subnetze \& Netzmasken}{DNS}
