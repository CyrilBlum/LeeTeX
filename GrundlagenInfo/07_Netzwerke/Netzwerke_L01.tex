...
\begin{frame}[fragile]{Auftrag}{IP-Adressen}
Skript (Moodle):
\begin{itemize}
\item \abgabebox{Aufgabe 1.6}
\item \aufgabebox{Aufgaben 1.7-1.9}
\item \abgabebox{Aufgabe 1.10}
\item \challengebox{Aufgabe 1.11}
\end{itemize}
\end{frame}
...
\item Router
\begin{itemize}
\item \aufgabebox{Aufgabe 1.15 (Link lesen)}
\item \abgabebox{Aufgabe 1.16 (mit Filius, Abgabe auf Moodle)}
\end{itemize}
\end{itemize}
\end{frame}
