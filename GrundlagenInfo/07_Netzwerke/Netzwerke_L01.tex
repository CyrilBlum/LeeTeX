...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{GrundlagenInfo/07_Netzwerke/Figures/subnets}
\end{figure}
\end{frame}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.38\linewidth]{GrundlagenInfo/07_Netzwerke/Figures/salt}
\includegraphics[width=0.2\linewidth]{GrundlagenInfo/07_Netzwerke/Figures/sunrise}
\includegraphics[width=0.2\linewidth]{GrundlagenInfo/07_Netzwerke/Figures/swisscom}
\end{figure}
\end{frame}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.38\linewidth]{GrundlagenInfo/07_Netzwerke/Figures/salt-back}
\includegraphics[width=0.2\linewidth]{GrundlagenInfo/07_Netzwerke/Figures/sunrise-back}
\includegraphics[width=0.2\linewidth]{GrundlagenInfo/07_Netzwerke/Figures/swisscom-back}
\end{figure}
\end{frame}
...
\begin{itemize}
\item \aufgabebox{Aufgaben 2.15, 2.16}
\item \abgabebox{Aufgaben 2.17, 2.18}
\item \challengebox{Aufgabe 2.19}
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Fehler-Behebung}{Aufträge (Skript)}
\begin{itemize}
\item \aufgabebox{Aufgabe 2.20}
\item \challengebox{Aufgabe 2.21}
\end{itemize}
\end{frame}
