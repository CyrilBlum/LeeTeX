...
\item Umrechner dezimal $\rightarrow$ binär: \qrcode[height=1cm]{https://www.rapidtables.com/convert/number/decimal-to-binary.html}
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Subnetze \& Netzmasken}{Weitere Übungen}
\begin{myexercise}
\footnotesize
...
\end{table}
\begin{center}
\vspace{-.5cm}Überprüfen: \qrcode[height=1cm]{https://oinf.ch/interactive/ips-und-netzmaske/}\vspace{-.2cm}
\end{center}
\end{myexercise}
\end{frame}
