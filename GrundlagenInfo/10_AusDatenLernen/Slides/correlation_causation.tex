...
\begin{frame}{Durchschnittsnote und Kaffee}
    \begin{center}
        ``Die Durchschnittsnote in der Klasse steigt über das Schuljahr hinweg. Im gleichen Zeitraum haben die Lehrpersonen ihren Kaffeekonsum gesteigert.''
    \end{center}
    \begin{enumerate}
...
\begin{frame}{Hunde und Übergewicht}
    \begin{center}
        ``Eine Studie hat gezeigt, dass HunderbesitzerInnen weniger Risiko haben, übergewichtig zu werden.''
    \end{center}
    \begin{enumerate}
        \item Koinzidenz
        \item Zyklische Beeinflussung
