...
\begin{frame}[fragile]{Auftrag: Zu zweit}
    \begin{itemize}
        \item Auf Abschnitt ``\textbf{Data Science}'' auf Moodle gehen (zuoberst, nach ``Allgemeine Informationen'')
        \item Excel-Datei ``\texttt{korrelation.xlsx}'' herunterladen und öffnen
        \item Arbeitsblatt ``\texttt{Beispiel}'' genau anschauen $\rightarrow$ bereits gemacht, nichts ändern!
        \item Arbeitsblätter ``\texttt{Aufgabe 1}'' und ``\texttt{Aufgabe 2}'' lösen
        \item Schnelle: Arbeitsblatt ``\texttt{Challenge}'' lösen
    \end{itemize}
...
\begin{frame}{Berufserfahrung und Einladungswahrscheinlichkeit}
    \begin{columns}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=\linewidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/berufserfahrung_vs_einladung"}
        \end{figure}
        \column{0.3\textwidth}
