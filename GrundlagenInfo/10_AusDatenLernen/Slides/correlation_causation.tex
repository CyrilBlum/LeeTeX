...
\begin{frame}{Maschinelles Lernen}
    \begin{figure}[H]
        \only<1->{\centering\includegraphics[width=0.26\pagewidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/intro_chatGPT.jpeg"}}
        \only<2->{\centering\includegraphics[width=0.26\pagewidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/intro_spam.jpg"}}
        \only<3->{\centering\includegraphics[width=0.26\pagewidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/intro_YT.jpg"}}
...
\begin{frame}{Durchschnittsnote und Kaffee}
    \begin{center}
        ``Die Durchschnittsnote in der Klasse steigt über das Schuljahr hinweg. Im gleichen Zeitraum wird immer mehr Kaffee im Lehrerzimmer konsumiert.''
    \end{center}
    \begin{enumerate}
...
\begin{frame}{Avocados und Maturaprüfungen}
    \begin{center}
        ``In den letzten zehn Jahren hat der Konsum von Avocados in der Schweiz zugenommen. Im gleichen Jahrzehnt ist die Zahl bestandener Maturaprüfungen gestiegen.''
    \end{center}
    \begin{enumerate}
        \item \only<1>{Koinzidenz}\only<2>{\textbf{Koinzidenz}}
        \item Zyklische Beeinflussung
...
\begin{frame}{Sport und Prüfungsergebnisse}
    \begin{center}
        ``Die Messung der Schlafdaten von SportlerInnen hat ergeben, dass Menschen, die viel Sport treiben, bessere Prüfungsergebnisse erzielen.''
    \end{center}
    \begin{enumerate}
        \item Koinzidenz
        \item Zyklische Beeinflussung
...
\begin{frame}{Stress und Noten}
    \begin{center}
        ``Eine Untersuchung von 1000 SchülerInnnen hat gezeigt, dass SchülerInnen, welche gestresster sind, schlechtere Noten erzielen.''
    \end{center}
    \begin{enumerate}
        \item Koinzidenz
...
\begin{frame}{Korrelations-Beispiele}
    \begin{figure}[H]
        \centering
        \only<1>{\includegraphics[width=.75\pagewidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/socialmedia_vs_zufriedenheit.pdf"}}
        \only<2>{\includegraphics[width=.75\pagewidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/haarlange_vs_notenschnitt.pdf"}}
        \only<3>{\includegraphics[width=.75\pagewidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/buecher_vs_schuhgroesse.pdf"}}
    \end{figure}
...
\begin{frame}{Korrelations-Beispiel: Abweichung vom Mittelwert}
    ...
    \begin{onlyenv}<2->
        ...
        \end{figure}
    \end{onlyenv}
    \only<1>{\textbf{1. Schritt:} Durchschnitt berechnen ($\overline{x}$ und $\overline{y}$)}
    \only<2>{\textbf{2. Schritt:} Neue Werte $x'=x-\overline{x}$ und $y'=y-\overline{y}$ berechnen}
    \only<3->{\textbf{3. Schritt:} \(
