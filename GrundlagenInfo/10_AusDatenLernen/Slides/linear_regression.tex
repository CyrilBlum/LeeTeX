...
\newcommand{\lernzieleRegression}[1]{
    \begin{itemize}[<+->]
        ...
        \item[#1] Ich kann die \textbf{Qualität einer Regression} anhand von Fehlermaßen beurteilen.
...
\begin{frame}{Qualität der Gerade}
    \begin{columns}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=\textwidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/schlafdauer_vs_note_2p_reg_pred.pdf"}
        \end{figure}
        \column{0.3\textwidth}
        \begin{table}
            \scriptsize
