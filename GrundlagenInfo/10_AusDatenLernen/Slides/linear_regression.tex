...
\begin{frame}{Zahlen vorhersagen mit Regression}{Unabhängige und abhängige Variablen}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\pagewidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/schlafdauer_vs_note.pdf"}
    \end{figure}
    \begin{itemize}[<+->]
        \item Unabhängige Variable: Schlafdauer
        \item Abhängige Variable: Note
        \item Ziel: Vorhersage der Note anhand der Schlafdauer
        \item Beispiel: 7.3 Stunden Schlaf $\rightarrow$ Note 5.2
    \end{itemize}
\end{frame}
...
\begin{frame}{Lineare Funktion}
    \begin{columns}
        ...
        \only<1>{
            \begin{figure}[H]
            \centering
            \includegraphics[width=\textwidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/schlafdauer_vs_note.pdf"}
        \end{figure}
        }
        \only<2>{
            \begin{figure}[H]
                \centering
                \includegraphics[width=\textwidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/schlafdauer_vs_note_2p_reg.pdf"}
            \end{figure}
        }
    \end{columns}
\end{frame}
...
\begin{frame}
    \begin{table}
        ...
        \begin{tabular}{rrrrr}
            \toprule
            Punkt   & Schlafdauer & Note & Vorhersage & Unterschied \\
            \midrule
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\pagewidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/schlafdauer_vs_note_2p_reg_pred.pdf"}
    \end{figure}
    Fehler:
...
\begin{frame}
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\pagewidth]{"GrundlagenInfo/10_AusDatenLernen/Figures/schlafdauer_vs_note_ols.pdf"}
    \end{figure}
\end{frame}
