...
if __name__ == "__main__":
    ...
    generiere_korrelationsdaten("haarlaenge_vs_note", n=14, seed=1).to_csv("GrundlagenInfo/10_AusDatenLernen/Data/haarlaenge_vs_note.csv", index=False)
    generiere_korrelationsdaten("schlafdauer_vs_note", n=25, seed=1).to_csv("GrundlagenInfo/10_AusDatenLernen/Data/schlafdauer_vs_note.csv", index=False)
