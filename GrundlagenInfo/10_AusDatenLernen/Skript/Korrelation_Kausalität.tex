...
\cref{fig:Korrelationen} zeigt zwei Beispiele für Datenreihen (Variablen). Die linke Grafik zeigt eine Datenreihe die Verteilung der Noten sowie der Haarlänge in einer weiblichen Schulklasse. Die rechte Grafik zeigt eine Datenreihe der Nutzung von Social Media und der Zufriedenheit der BenutzerInnen.
...
\begin{myexercise}
    ...
    \begin{enumerate}
        ...
        \item Die Messung der Schlafdaten von Sportlern hat ergeben, dass Menschen, die viel Sport treiben, bessere Prüfungsergebnisse erzielen.
...
Wie wir in \cref{ex:z-excel2} gesehen haben, ist die Zahl \(Z\) von der Grösseneinheit abhängig. Das bedeutet, dass wir den Korrelationskoeffizienten nicht direkt vergleichen können, wenn die Variablen unterschiedliche Grösseneinheiten haben. Um dies zu lösen, verwenden wir den \textbf{Korrelationskoeffizienten \(r\)}, welcher die Zahl \(Z\) normiert, indem er ihn durch die Wurzel der Summe der quadrierten Abweichungen der beiden Variablen teilt:
\begin{equation}
    \begin{aligned}
