...
\begin{myexercise}[App-Nutzung]
    Ein Schüler nutzt auf seinem Smartphone entweder Instagram (I) oder TikTok (T). Nach jeder Nutzung entscheidet er sich mit einer Wahrscheinlichkeit von $0.8$ wieder für Instagram und mit $0.2$ für TikTok, wenn er gerade Instagram genutzt hat. Nach einer TikTok-Nutzung entscheidet er sich mit $0.3$ für Instagram und mit $0.7$ für TikTok. Die Übergangsmatrix lautet:
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{c c|c|c}
                                                      &   & \multicolumn{2}{c}{\textbf{Nach}}         \\
                                                      &   & I                                 & T     \\\midrule\midrule
            \multirow{2}{*}{\rotatebox{90}{\textbf{Von}}} & I & 0.8                             & 0.2 \\\cmidrule{2-4}
                                                      & T & 0.3                             & 0.7 \\
        \end{tabular}
    \end{table}

    Wie gross ist die Wahrscheinlichkeit, dass der Schüler nach zwei Nutzungen bei Instagram landet, wenn er mit TikTok startet? Berechnen Sie die Lösung mit Hilfe von Matrizen.
    ...
    \begin{myanswer}
        ...
        Die Wahrscheinlichkeit, dass der Schüler nach zwei Nutzungen bei Instagram landet, beträgt also $0.45$.
    \end{myanswer}
\end{myexercise}
