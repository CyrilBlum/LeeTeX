...
\begin{mysubmission}
  Bearbeiten Sie auf Moodle die ``Übungen 1 (Einfache Selektion)'' und geben Sie am Schluss ab.
\end{mysubmission}
...
\begin{center}
  \begin{figure}[ht!]
    \includegraphics[width = 0.6 \textwidth]{GrundlagenInfo/06_Daten/Figures/redundanz.png}
  \end{figure}
...
TODO: Moodle-MC-Aufgaben zur Art der Verknüpfung
...
TODO: Aufgaben mit Abfragen über mehrere Tabellen
