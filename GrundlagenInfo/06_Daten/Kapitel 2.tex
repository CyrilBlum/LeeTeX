...
\begin{table}[H]
  ...
  \begin{tabular}{c|l}
    ...
    \lstinline[style=sql]|BETWEEN x AND y|        & ein Wert zwischen (inklusive) \texttt{x} und \texttt{y} \\
...
\url{https://sql-tutorial.de/home/uebungen.php?lektion=1} (keine Abgabe notwendig / möglich)
    \item Geben Sie danach auf Moodle die Abgabe unter ``Übungen 1 (Einfache Selektion)'' ab.
  \end{itemize}
\end{mysubmission}
