...
\begin{tcolorboxTemplate}[title=Einfache Selektion: \texorpdfstring{\lstinline|SELECT|}{SELECT},colbacktitle=white, coltitle=black]
...
\begin{tcolorboxTemplate}[title=Duplikate entfernen: \texorpdfstring{\lstinline|SELECT DISTINCT|}{SELECT DISTINCT},colbacktitle=white, coltitle=black]
Auswahle einer oder mehrere Kolonnen:
\begin{lstlisting}
...
\begin{tcolorboxTemplate}[title=Filter: \texorpdfstring{\lstinline|WHERE|}{WHERE},colbacktitle=white, coltitle=black]
Auswahle einer oder mehrere Kolonnen:
\begin{lstlisting}
...
Mit folgendem Befehl erhalten wir alle Städte alphabetisch sortieren:
\begin{lstlisting}
SELECT DISTINCT city 
FROM users 
ORDER BY city DESC
...
Falls \lstinline|Kolonne_ID| in beiden Tabellen:
\begin{lstlisting}
