...
\begin{myexercise}
	Schreiben Sie die SQL-Befehle, um \cref{table:angestellte2} und \cref{table:abteilungen} zu erstellen. Sie müssen dabei lediglich eine leere Tabelle mit den korrekten Tabellentypen erstellen, Daten müssen Sie noch keine einfügen.
	\begin{myanswer}
		\begin{lstlisting}
...
\subsection{Tabellen verändern: \texorpdfstring{\lstinline|ALTER table|}{ALTER table}}
Mit dem Befehl \lstinline|ALTER table| können Tabellen und deren Attribute nachträglich, d.h. nach der Erstellung der Tabelle, verändert werden.
...
\subsection{Daten einfügen: \texorpdfstring{\lstinline|INSERT|}{INSERT}}

Mit \lstinline|INSERT| können neue Zeilen in eine bestehende Tabelle eingefügt werden.

Die Syntax von \lstinline|INSERT| sieht wie folgt aus:
