...
\begin{frame}[fragile]{Mehrere Tabellen miteinander verbinden}{``Naive'' Tabellenverbindung (geht nicht!)}
\begin{lstlisting}
SELECT *
...
\begin{frame}[fragile]{Mehrere Tabellen miteinander verbinden}{Möglichkeit 2a: Verwendung von \lstinline[style=sql]|JOIN| (mit \lstinline[style=sql]|ON|)}
\begin{lstlisting}
SELECT *
...
\begin{frame}[fragile]{Mehrere Tabellen miteinander verbinden}{Möglichkeit 2b: Verwendung von \lstinline[style=sql]|JOIN|  (mit \lstinline[style=sql]|USING|) \\\textit{$\rightarrow$ nur wenn Kolonnenname gleich in beiden Tabellen! Ansonsten \lstinline[style=sql]|ON| verwenden}}
\begin{lstlisting}
SELECT *
FROM Angestellte JOIN Abteilung
USING (aID)
