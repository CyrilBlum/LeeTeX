...
\centering
\includegraphics[width=\linewidth]{"GrundlagenInfo/06_Daten/Figures/schema MM"}
\end{figure}}
\begin{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\linewidth]{GrundlagenInfo/06_Daten/Figures/Migros}
\includegraphics[width=0.22\linewidth]{GrundlagenInfo/06_Daten/Figures/Coop}
\end{figure}
