...
\begin{frame}{Inhalte}
  \begin{itemize}
    ...
    \item Erstellung eigener Tabellen
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Lehrmittel: Cheat Sheet}
	\begin{figure}[H]
		\centering
		\includegraphics[width=.8\textwidth]{GrundlagenInfo/06_Daten/Figures/Cheatsheet}
	\end{figure}
...
\begin{frame}[fragile]{Lehrmittel: Skript}
	...
	\centering
		\begin{column}{.4\linewidth}
			\begin{figure}[H]
				\centering
				\includegraphics[width=\columnwidth]{GrundlagenInfo/06_Daten/Figures/titlepage}
			\end{figure}
		\end{column}
