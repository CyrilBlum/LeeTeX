...
\begin{frame}[fragile]{VIGINERE in Python}
...
def viginere(text, schluessel, richtung="verschluesslung"):
    text_verschoben = ""
    k = 0
    for buchstabe in text:
        k %= len(schluessel)
...
Wie kann man die Schlüssellänge herausfinden, falls diese unbekannt ist?$\rightarrow$ \textbf{Idee:}
	...
	\item<1> Die Häufigkeit der Buchstaben in einem Viginère-Geheimtext ist wegen der \textit{polyalphabetischen} Verschlüsselung relativ \textit{gleichmässig}...
		\begin{figure}[H]
				\centering
