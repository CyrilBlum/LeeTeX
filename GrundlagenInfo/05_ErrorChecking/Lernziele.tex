\chapter{Lernziele \enquote{Error Checking}}
\begin{todolist}
\item Ich kann die Prüfziffern eines EAN-Codes berechnen bei gegebener Formel.
\item Ich kann bestimmen, ob ein gegebener EAN-Code korrekt ist.
...
\item Ich kann RAID-0-, RAID-1-, RAID-5- und RAID-6-Konfigurationen schematisch illustrieren und deren Nutzen erklären, indem ich die Begriffe \textit{striping}, \textit{mirroring} und \textit{Paritätsbits} verwende.
\item Ich kann für eine vorgegebene Anzahl Festplatten sowie Anforderungen an Redundanz und Schreibgeschwindigkeit bestimmen, welche der vier RAID-Konfigurationen am besten geeignet ist.
