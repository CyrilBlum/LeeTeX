...
\begin{frame}[fragile]{Was sind \textit{Daten}?}
    \begin{itemize}[<+->]
      \item \textbf{``Daten''} = Plural von \textit{Datum}
...
\begin{frame}{Wo(zu) braucht es Datenbanken?}
  \begin{columns}
    ...
    \begin{column}{0.6\textwidth}
      \begin{figure}[H]
        \centering
        \includegraphics[height=4cm]{GrundlagenInfo/06_Datenbanken/Figures/db-ex1}
        \includegraphics[height=4cm]{GrundlagenInfo/06_Datenbanken/Figures/db-ex4}
        \includegraphics[width=.85\columnwidth]{GrundlagenInfo/06_Datenbanken/Figures/db-ex2}
        \includegraphics[width=.85\columnwidth]{GrundlagenInfo/06_Datenbanken/Figures/db-ex3}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[fragile]{Lehrmittel: Cheat Sheet}
	\begin{figure}[H]
		\centering
		\includegraphics[width=.8\textwidth]{GrundlagenInfo/06_Datenbanken/Figures/Cheatsheet}
	\end{figure}
...
\begin{frame}[fragile]{Lehrmittel: Skript}
	...
	\centering
		\begin{column}{.4\linewidth}
			\begin{figure}[H]
				\centering
				\includegraphics[width=\columnwidth]{GrundlagenInfo/06_Datenbanken/Figures/titlepage}
			\end{figure}
		\end{column}
