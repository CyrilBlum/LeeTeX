...
\centering
\includegraphics[width=\linewidth]{"GrundlagenInfo/06_Datenbanken/Figures/schema MM"}
\end{figure}}
\begin{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\linewidth]{GrundlagenInfo/06_Datenbanken/Figures/Migros}
\includegraphics[width=0.22\linewidth]{GrundlagenInfo/06_Datenbanken/Figures/Coop}
\end{figure}
...
%  \begin{figure}[H]
%    \centering
%    \includegraphics[width=\linewidth]{GrundlagenInfo/06_Datenbanken/Figures/er_nordwind_komplett}
