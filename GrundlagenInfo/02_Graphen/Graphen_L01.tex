...
\begin{itemize}
 ...
 \begin{figure}
     \centering
 \includegraphics[keepaspectratio, width=0.18 \paperwidth]{GrundlagenInfo/02_Graphen/Figures/4-graph.png}
 \end{figure}
...
\begin{frame}{Färbung von Graphen}
    \begin{itemize}[<+->]
        ...
        \begin{figure}
            \centering
            \includegraphics[keepaspectratio, width=0.6 \paperwidth]{GrundlagenInfo/02_Graphen/Figures/4-graph-farbe.png}
        \end{figure}
...
\begin{frame}{Planare Darstellung von Graphen}
    \begin{itemize}[<+->]
        ...
        \begin{figure}
            \centering
            \includegraphics[keepaspectratio, width=0.2 \paperwidth]{GrundlagenInfo/02_Graphen/Figures/4-graph-planar.png}
        \end{figure}
    \end{itemize}
\end{frame}
