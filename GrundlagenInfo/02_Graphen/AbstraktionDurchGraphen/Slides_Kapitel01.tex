...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{GrundlagenInfo/02_Graphen/AbstraktionDurchGraphen/Figures/vonHandCrop.pdf}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{GrundlagenInfo/02_Graphen/AbstraktionDurchGraphen/Figures/GraphAufStadtplan.pdf}
\end{figure}
\end{frame}
