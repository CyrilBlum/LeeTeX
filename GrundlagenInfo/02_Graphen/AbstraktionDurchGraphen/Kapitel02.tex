...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{GrundlagenInfo/02_Graphen/AbstraktionDurchGraphen/Figures/Edsger_Wybe_Dijkstra.jpg}
    \caption*{Edsger Wybe Dijkstra}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{GrundlagenInfo/02_Graphen/AbstraktionDurchGraphen/Figures/DScrop.pdf}
