\chapter{Kürzeste Wege und Dijkstra}\label{ch:Lektion}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{GrundlagenInfo/DataScience/02_Graphen/AbstraktionDurchGraphen/Figures/Edsger_Wybe_Dijkstra.jpg}
...
\node (t) [state, below right=of v1,align=center]         {$t$};
% 
% \draw[gray!30, line width=5pt]
%         (s1) to                     (s2)
%         (s1) to [bend right=15]     (s6);
...
\begin{antwort}{aufgabe:203}
Das Kantengewicht könnte die Abnahme des Akkuladestands über eine Strecke (Kante) hinweg sein. Auf einer Talfahrt kann das Elektroauto seinen Akku laden und die Abnahme des Akkustandes ist auf diesem Abschnitt deshalb negativ. (negative Abnahme $=$ Zunahme)
\end{antwort}


\begin{antwort}{aufgabe:204}
