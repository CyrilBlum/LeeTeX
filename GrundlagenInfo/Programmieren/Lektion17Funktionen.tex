...
\begin{lstlisting}[style=TigerJython, basicstyle=\ttfamily\footnotesize, escapeinside={(*@}{@*)}]
from gturtle import *
makeTurtle()
hideTurtle()
...
\begin{figure}[H]
	\centering
    \includegraphics[keepaspectratio, width=\textwidth]{GrundlagenInfo/Programmieren/Figures/spirale.png}
\end{figure}
...
\begin{lstlisting}[style=TigerJython, escapeinside={(*@}{@*)}, basicstyle=\footnotesize\ttfamily]
