...
\only<5->{
\draw[thick,->,rounded corners] (out1) -- ++(0,-1.5,0) -- ++(1.55,0,0)node[below]{\lstinline[language=Python,style=TigerJython,basicstyle=\ttfamily\tiny]{return out1}} -- ++(1.55,0,0) -- (in31);}
