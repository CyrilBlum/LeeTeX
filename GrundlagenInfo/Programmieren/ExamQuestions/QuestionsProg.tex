...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		child[concept color=orange] { node[concept] {Insel 2} };
	\end{tikzpicture}
\end{figure}
Als ob das noch nicht merkwürdig genug wäre, finden Sie auch noch dutzende Schatzkisten verstreut über die Inseln. Währenddem alle Kisten auf Inseln 1 und 2 verschlossen sind, finden  
