\begin{frame}
    ...
    Lektion 07 \emoji{floppy-disk}: \textbf{Speicherinhalte ändern}
\end{frame}
...
\begin{minipage}[c]{.2\pagewidth}
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,]{GrundlagenInfo/Programmieren/Figures/prog-7-spirale.png}
    \end{figure}
    \begin{table}[H]
    \centering
    \hfill
...
\begin{itemize}
    \item 3.17
    \item Lesen Sie die Lösung von 3.20
    \item 3.21, 3.23-3.30
    \begin{itemize}
        \item 3.24 $\rightarrow$ Abgabe auf Moodle
        \item 3.30 $\rightarrow$ Abgabe auf Moodle
        \item 3.28: Challenge
    \end{itemize}
